...
namespace wf
{
    ...
    BToKstarDileptonFactory::make(const std::string & name, const Parameters & parameters, const ObservableOptions & options)
    {
        ...
        {
            // Large Recoil
            std::make_pair("dBR/ds@LargeRecoil", new ConcreteObservableFactory<BToKstarDilepton<LargeRecoil>, 1>(
                        ConcreteObservableData<BToKstarDilepton<LargeRecoil>, 1>("dBR/ds",
                            std::tr1::mem_fn(&BToKstarDilepton<LargeRecoil>::differential_branching_ratio),
                            "s"))),
            std::make_pair("A_FB(s)@LargeRecoil", new ConcreteObservableFactory<BToKstarDilepton<LargeRecoil>, 1>(
                        ConcreteObservableData<BToKstarDilepton<LargeRecoil>, 1>("dA_FB/ds",
                            std::tr1::mem_fn(&BToKstarDilepton<LargeRecoil>::differential_forward_backward_asymmetry),
                            "s"))),
            std::make_pair("F_L(s)@LargeRecoil", new ConcreteObservableFactory<BToKstarDilepton<LargeRecoil>, 1>(
