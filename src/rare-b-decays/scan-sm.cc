...
main(int argc, char * argv[])
{
    try
    {
        ...
        std::list<Bin> data = {
            // [BaBar2006] data
            Bin{10.24, 19.21, -0.38, -0.72, -1.08, "A_FB@LowRecoil", ""},
            Bin{10.24, 19.21, 0.21e-7, 0.37e-6, 0.55e-6, "BR@LowRecoil", ""},

            // [Belle2009] data
            Bin{14.18, 16.00, -0.96, -0.70, -0.38, "A_FB@LowRecoil", ""},
            Bin{16.00, 19.21, -0.81, -0.66, -0.46, "A_FB@LowRecoil", ""},
            Bin{14.18, 16.00, 0.71e-7, 1.05e-7, 1.42e-7, "BR@LowRecoil", ""},
            Bin{16.00, 19.21, 1.64e-7, 2.04e-7, 2.47e-7, "BR@LowRecoil", ""},

            // [CDF2010] data
            Bin{14.18, 16.00, -0.67, -0.42, -0.17, "A_FB@LowRecoil", ""},
            Bin{16.00, 19.21, -0.96, -0.70, -0.35, "A_FB@LowRecoil", ""},
            Bin{14.18, 16.00, 1.02e-7, 1.51e-7, 2.00e-7, "BR@LowRecoil", ""},
            Bin{16.00, 19.21, 0.86e-7, 1.35e-7, 1.84e-7, "BR@LowRecoil", ""},
        };
