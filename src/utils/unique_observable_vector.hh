...
#ifndef EOS_GUARD_SRC_UTILS_UNIQUE_OBSERVABLE_VECTOR_HH
#define EOS_GUARD_SRC_UTILS_UNIQUE_OBSERVABLE_VECTOR_HH 1
...
namespace eos
{
         ...
         */
        class UniqueObservableVector :
            public PrivateImplementationPattern<UniqueObservableVector>
        {
            public:
                ///@name Basic Functions
                ///@{
                /// Constructor.
                UniqueObservableVector();
