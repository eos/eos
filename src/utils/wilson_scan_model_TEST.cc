    ...
    public:
        ...
        virtual void run() const
        {
            /* Test passing of SM parameters via polar parametrisations */
            {
                ...
                TEST_CHECK_NEARLY_EQUAL(-0.32300000, real(wc.c1()),  eps);
                TEST_CHECK_NEARLY_EQUAL(+1.00931000, real(wc.c2()),  eps);
                TEST_CHECK_NEARLY_EQUAL(-0.00522869, real(wc.c3()),  eps);
                TEST_CHECK_NEARLY_EQUAL(-0.08794730, real(wc.c4()),  eps);
                TEST_CHECK_NEARLY_EQUAL(+0.00037476, real(wc.c5()),  eps);
                TEST_CHECK_NEARLY_EQUAL(+0.00105859, real(wc.c6()),  eps);
                TEST_CHECK_NEARLY_EQUAL(-0.33100000, real(wc.c7()),  eps);
                TEST_CHECK_NEARLY_EQUAL(-0.18100000, real(wc.c8()),  eps);
                TEST_CHECK_NEARLY_EQUAL(+4.27000000, real(wc.c9()),  eps);
                TEST_CHECK_NEARLY_EQUAL(-4.17000000, real(wc.c10()), eps);
