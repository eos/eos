...
struct CommandLine :
    cli::DefaultHandler
{
    virtual std::string app_name() const { return "eos-list-signal-pdfs"; }
...
struct Filter
{
    ...
    bool operator() (const std::pair<const QualifiedName, SignalPDFEntryPtr> & arg)
    {
...
struct Printer
{
    void print(const SignalPDFEntryPtr & rhs)
    {
        cout << rhs->name() << endl;
