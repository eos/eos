...
''',
    ...
    parser_sample_nested.add_argument('-e', '--min-effective-sample-size',
        help = 'The minimum effective sample size (ESS). Samples will be added until the estimated ESS reaches this value, even if the termination condition is reached earlier. If 0 (default), dynesty\'s default ESS target is used.',
        dest = 'min_ess', action = 'store', type = int, default = 0
    )
