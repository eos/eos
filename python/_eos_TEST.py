...
BINDINGS_XFAILS_UNDOCUMENTED = {
    ...
    'ObservableGroup':                            _TODO,
    'ObservableSection':                          _TODO,
    'OptionSpecification':                        _TODO,
    'ParameterGroup':                             _TODO,
    'ParameterSection':                           _TODO,
    'ParameterUser':                              _TODO,
    'ReferenceName':                              _TODO,
    'ReferenceUser':                              _TODO,
    ...
    ('ObservableGroup', 'description'):           _TODO,
    ('ObservableGroup', 'name'):                  _TODO,
    ('ObservableSection', 'description'):         _TODO,
    ('ObservableSection', 'name'):                _TODO,
    ('ParameterGroup', 'description'):            _TODO,
    ('ParameterGroup', 'name'):                   _TODO,
    ('ParameterSection', 'description'):          _TODO,
    ('ParameterSection', 'name'):                 _TODO,
    ('ParameterUser', 'used_parameter_ids'):      _TODO,
    ('ReferenceUser', 'references'):              _TODO,
    ('SignalPDFGroup', 'description'):            _TODO,
    ('SignalPDFGroup', 'name'):                   _TODO,
    ('SignalPDFSection', 'description'):          _TODO,
    ('SignalPDFSection', 'name'):                 _TODO,
