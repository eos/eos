...
BINDINGS_FACTORIES = {
    ...
    '_ParametersGeneration':    lambda: _PARAMETERS.generation,
...
BINDINGS_TESTS = {
    ...
    ('_ParametersGeneration', '__eq__'):         lambda g: g == g,
    ('_ParametersGeneration', '__ne__'):         lambda g: g != g,
