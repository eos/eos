...
namespace eos
{
    ...
    Parameters::Defaults()
    {
        return Parameters(new Implementation<Parameters>({
            ...
            Parameter::Template{"Abs{c7}",                                       +0.0,            +0.32741917,     +1.0           },
            Parameter::Template{"Arg{c7}",                                       +0.0,            +M_PI,           +2.0 * M_PI    },
            Parameter::Template{"Re{c7}",                                        -1.0,            -0.32741917,     +1.0           },
            Parameter::Template{"Im{c7}",                                        -1.0,            +0.0,            +1.0           },
            Parameter::Template{"c8",                                            -0.17707354,     -0.17707354,     -0.17707354    },
            Parameter::Template{"Abs{c9}",                                       +0.0,            +4.27584794,    +15.0           },
            Parameter::Template{"Arg{c9}",                                       +0.0,            +0.0,            +2.0 * M_PI    },
            Parameter::Template{"Re{c9}",                                       -15.0,            +4.27584794,    +15.0           },
            Parameter::Template{"Im{c9}",                                       -15.0,            +0.0,           +15.0           },
            Parameter::Template{"Abs{c10}",                                      +0.0,            +4.15077942,    +15.0           },
            Parameter::Template{"Arg{c10}",                                      +0.0,            +M_PI,           +2.0 * M_PI    },
            Parameter::Template{"Re{c10}",                                      -15.0,            -4.15077942,    +15.0           },
