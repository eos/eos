...
namespace eos
{
    void compute_polynomial_coefficients(const ObservablePtr & observable, const std::vector<QualifiedName> & coefficients, double & constant, double * linear, double * bilinear);
