...
namespace eos
{
    class DToPseudoscalarLeptonLepton::AmplitudeGenerator : public ParameterUser
    {
        public:
            ...
            static const std::map<std::tuple<QuarkFlavor, std::string>, std::tuple<std::string, std::string, std::string, double>> process_map;

            std::function<double(const double &)>                                 m_Q_msbar;
            std::function<complex<double>()>                                      v_cQ;
            std::function<complex<double>()>                                      v_uQ;
    ...
    struct DToPseudoscalarLeptonLepton::DipoleFormFactors
    {
            complex<double> calT;
    };
