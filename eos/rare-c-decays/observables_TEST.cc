...
class RareCDecaysObservablesTest : public TestCase
{
    public:
        RareCDecaysObservablesTest() :
            TestCase("rare_c_decays_observables_test")
        {
        }
        ...
        run() const
        {
            /* Test that every observable in this section can be constructed */
            {
                ...
                for (const auto & group : make_rare_c_decays_section())
                {
...
} rare_c_decays_observables_test;
