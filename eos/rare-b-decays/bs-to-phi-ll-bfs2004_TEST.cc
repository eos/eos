    ...
    {
        {
            ...
            TEST_CHECK_RELATIVE_ERROR_C(amps.a_long_left,  complex<double>(-1.23979e-10,3.92745e-15)  , eps);
            TEST_CHECK_RELATIVE_ERROR_C(amps.a_long_right, complex<double>(7.05843e-12,3.92745e-15)   , eps);
