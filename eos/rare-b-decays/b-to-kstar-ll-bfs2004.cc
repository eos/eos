...
namespace eos
{
    ...
    BToKstarDileptonAmplitudes<tag::BFS2004>::BToKstarDileptonAmplitudes(const Parameters & p, const Options & o) :
        ...
        use_nlo(opt_use_nlo.value())
    {
        ...
        {
            qcdf_dilepton_massless_case = std::bind(&QCDFIntegralCalculator<BToKstarDilepton, tag::Mixed>::dilepton_massless_case, _1, _2, _3, _4, _5, _6, _7, _8);
            qcdf_dilepton_charm_case    = std::bind(&QCDFIntegralCalculator<BToKstarDilepton, tag::Mixed>::dilepton_charm_case, _1, _2, _3, _4, _5, _6, _7, _8, _9);
            qcdf_dilepton_bottom_case   = std::bind(&QCDFIntegralCalculator<BToKstarDilepton, tag::Mixed>::dilepton_bottom_case, _1, _2, _3, _4, _5, _6, _7, _8, _9);
        }
        else if ("numerical" == qcdf_integrals)
        {
            qcdf_dilepton_massless_case = std::bind(&QCDFIntegralCalculator<BToKstarDilepton, tag::Numerical>::dilepton_massless_case, _1, _2, _3, _4, _5, _6, _7, _8);
            qcdf_dilepton_charm_case    = std::bind(&QCDFIntegralCalculator<BToKstarDilepton, tag::Numerical>::dilepton_charm_case, _1, _2, _3, _4, _5, _6, _7, _8, _9);
            qcdf_dilepton_bottom_case   = std::bind(&QCDFIntegralCalculator<BToKstarDilepton, tag::Numerical>::dilepton_bottom_case, _1, _2, _3, _4, _5, _6, _7, _8, _9);
        }
        else if ("analytical" == qcdf_integrals)
        {
            qcdf_dilepton_massless_case = std::bind(&QCDFIntegralCalculator<BToKstarDilepton, tag::Analytical>::dilepton_massless_case, _1, _2, _3, _4, _5, _6, _7, _8);
            qcdf_dilepton_charm_case    = std::bind(&QCDFIntegralCalculator<BToKstarDilepton, tag::Analytical>::dilepton_charm_case, _1, _2, _3, _4, _5, _6, _7, _8, _9);
            qcdf_dilepton_bottom_case   = std::bind(&QCDFIntegralCalculator<BToKstarDilepton, tag::Analytical>::dilepton_bottom_case, _1, _2, _3, _4, _5, _6, _7, _8, _9);
        }
        else
        {
    ...
    const std::vector<OptionSpecification> BToKstarDileptonAmplitudes<tag::BFS2004>::options{
    ...
    BToKstarDileptonAmplitudes<tag::BFS2004>::dipole_form_factors(const double & q2, const WilsonCoefficients<BToS> & wc) const
    {
        ...
        QCDFIntegrals<BToKstarDilepton> qcdf_0     = this->qcdf_dilepton_massless_case(q2, m_B, m_Kstar, mu, a_1_perp, a_2_perp, a_1_par, a_2_par);
        QCDFIntegrals<BToKstarDilepton> qcdf_c     = this->qcdf_dilepton_charm_case(q2, m_c_pole, m_B, m_Kstar, mu, a_1_perp, a_2_perp, a_1_par, a_2_par);
        QCDFIntegrals<BToKstarDilepton> qcdf_b     = this->qcdf_dilepton_bottom_case(q2, m_b_PS, m_B, m_Kstar, mu, a_1_perp, a_2_perp, a_1_par, a_2_par);
        ...
        complex<double> Y_top = Y_top_c * CharmLoops::h(mu, q2, m_c_pole) + Y_top_b * CharmLoops::h(mu, q2, m_b_PS) + Y_top_0 * CharmLoops::h(mu, q2) + Y_top_;
        ...
        complex<double> C0_top_perp_left   = (c7eff - wc.c7prime()) + q2 / (2.0 * m_b_PS * m_B) * Y_top;
        complex<double> C0_top_perp_right  = (c7eff + wc.c7prime()) + q2 / (2.0 * m_b_PS * m_B) * Y_top;
        ...
        complex<double> C1nf_top_perp =
                (-1.0 / QCD::casimir_f)
                * ((wc.c2() - wc.c1() / 6.0) * memoise(CharmLoops::F27_massive, mu(), q2, m_b_PS, m_c_pole) + c8eff * CharmLoops::F87_massless(mu, q2, m_b_PS)
                   + (q2 / (2.0 * m_b_PS * m_B))
                             * (wc.c1() * memoise(CharmLoops::F19_massive, mu(), q2, m_b_PS, m_c_pole) + wc.c2() * memoise(CharmLoops::F29_massive, mu(), q2, m_b_PS, m_c_pole)
                                + c8eff * CharmLoops::F89_massless(q2, m_b_PS)));

        /* perpendicular, up sector */
        // cf. [BFS:2004A], comment before Eq. (43), p. 24
        complex<double> C0_up_perp   = q2 / (2.0 * m_b_PS * m_B) * Y_up;
        ...
        complex<double> C_perp_left  = C0_top_perp_left + lambda_hat_u * C0_up_perp + a_mu * (C1f_top_perp_left + C1nf_top_perp + lambda_hat_u * C1nf_up_perp);
        complex<double> C_perp_right = C0_top_perp_right + lambda_hat_u * C0_up_perp + a_mu * (C1f_top_perp_right + C1nf_top_perp + lambda_hat_u * C1nf_up_perp);
        complex<double> C_par        = C0_top_par + lambda_hat_u * C0_up_par + a_mu * (C1f_top_par + C1nf_top_par + lambda_hat_u * C1nf_up_par);
        ...
        complex<double> T1nf_top_perp_p      = (-4.0 * e_d * c8eff * qcdf_0.j0_perp
                                           + m_B / (2.0 * m_b_PS)
                                                     * (e_u * (-wc.c1() / 6.0 + wc.c2() + 6.0 * wc.c6()) * qcdf_c.jtilde1_perp
                                                        + e_d
                                                                  * (wc.c3() - wc.c4() / 6.0 + 16.0 * wc.c5() + 10.0 / 3.0 * wc.c6()
                                                                     - (4.0 * m_b_PS / m_B) * (wc.c3() - wc.c4() / 6.0 + 4.0 * wc.c5() - 2.0 / 3.0 * wc.c6()))
                                                                  * qcdf_b.jtilde1_perp
                                                        + e_d * (wc.c3() - wc.c4() / 6.0 + 16.0 * wc.c5() - 8.0 / 3.0 * wc.c6()) * qcdf_0.jtilde1_perp))
                                          * lambda_B_p_inv;
        ...
        complex<double> T1nf_top_par_p = m_B / m_b_PS
                                         * (e_u * (-wc.c1() / 6.0 + wc.c2() + 6.0 * wc.c6()) * qcdf_c.jtilde2_parallel
                                            ...
                                            + e_d * (wc.c3() - wc.c4() / 6.0 + 16.0 * wc.c5() - 8.0 / 3.0 * wc.c6()) * qcdf_0.jtilde2_parallel)
                                         * lambda_B_p_inv;
        // cf. [BFS:2001A], Eq. (26), pp. 7-8
        complex<double> T1nf_top_par_m = e_q
                                         * (8.0 * c8eff * qcdf_0.j0_parallel
                                            + 6.0 * m_B / m_b_PS
                                                      * ((-wc.c1() / 6.0 + wc.c2() + wc.c4() + 10.0 * wc.c6()) * qcdf_c.j4_parallel
                                                         ...
                                                         - 8.0 / 27.0 * (-7.5 * wc.c4() + 12.0 * wc.c5() - 32.0 * wc.c6())))
                                         * lambda_B_m_inv;
        ...
        // cf. [BFS:2004A], Eq. (51)
        complex<double> Delta_T_ann_top_perp =
                e_q * M_PI * M_PI * f_B / 3.0 / m_b_PS / m_B
                * (-4.0 * f_Kstar_perp * (wc.c3() + 4.0 / 3.0 * (wc.c4() + 3.0 * wc.c5() + 4.0 * wc.c6())) * qcdf_0.j0_perp
                   + 2.0 * f_Kstar_par * (wc.c3() + 4.0 / 3.0 * (wc.c4() + 12.0 * wc.c5() + 16.0 * wc.c6())) * (m_Kstar / (1.0 - q2 / (m_B * m_B)) * lambda_B_p_inv));
        complex<double> Delta_T_ann_up_perp =
                -e_q * 2.0 * M_PI * M_PI * f_B * f_Kstar_par / 3.0 / m_b_PS / m_B * (m_Kstar / (1.0 - q2 / (m_B * m_B)) * lambda_B_p_inv) * 3.0 * delta_qu * wc.c2();
        ...
        complex<double> Delta_T_hsa_top_perp = e_q * a_mu_f * (M_PI * M_PI * f_B / (3.0 * m_b_PS * m_B)) * (
                ...
                - (4.0 * m_Kstar * f_Kstar_par / (1.0 - q2 / (m_B * m_B)) * lambda_B_p_inv) * (3.0 / 4.0) * (
        ...
        // clang-format on
        complex<double> Delta_T_hsa_up_perp =
                e_q * a_mu_f * (M_PI * M_PI * f_B / (3.0 * m_b_PS * m_B))
                * (+8.0 * f_Kstar_perp * (3.0 / 4.0) * (wc.c2() - wc.c1() / 6.0) * (qcdf_c.j5_perp - qcdf_0.j5_perp)
                   - (4.0 * m_Kstar * f_Kstar_par / (1.0 - q2 / (m_B * m_B)) * lambda_B_p_inv) * (3.0 / 4.0) * (wc.c2() - wc.c1() / 6.0) * (qcdf_c.j6_perp - qcdf_0.j6_perp));
        ...
        result.calT_perp_left  = xi_perp(q2) * C_perp_left + power_of<2>(M_PI) / 3.0 * (f_B * f_Kstar_perp) / m_B * T_perp_left + Delta_T_perp;
        result.calT_perp_right = xi_perp(q2) * C_perp_right + power_of<2>(M_PI) / 3.0 * (f_B * f_Kstar_perp) / m_B * T_perp_right + Delta_T_perp;
        result.calT_parallel   = xi_par(q2) * C_par + power_of<2>(M_PI) / 3.0 * (f_B * f_Kstar_par * m_Kstar) / (m_B * energy) * T_par;

        return result;
    }

    double
    BToKstarDileptonAmplitudes<tag::BFS2004>::xi_perp(const double & q2) const
    {
        const double factor = m_B() / (m_B() + m_Kstar());
        double       result = uncertainty_xi_perp * factor * form_factors->v(q2);

        return result;
    }

    double
    BToKstarDileptonAmplitudes<tag::BFS2004>::xi_par(const double & q2) const
    {
        const double factor1 = (m_B() + m_Kstar()) / (2.0 * energy(q2));
        const double factor2 = (1.0 - m_Kstar() / m_B());
        double       result  = uncertainty_xi_par * (factor1 * form_factors->a_1(q2) - factor2 * form_factors->a_2(q2));

        return result;
    }

    double
    BToKstarDileptonAmplitudes<tag::BFS2004>::norm(const double & q2) const
    {
        double lambda_t2 = std::norm(model->ckm_tb() * conj(model->ckm_ts()));

        return g_fermi() * alpha_e()
               * std::sqrt(1.0 / 3.0 / 1024 / power_of<5>(M_PI) / m_B() * lambda_t2 * s_hat(q2) * std::sqrt(lambda(q2)) * beta_l(q2)); // cf. [BHP:2008A], Eq. (C.6), p. 21
    }
    ...
    BToKstarDileptonAmplitudes<tag::BFS2004>::amplitudes(const double & q2) const
    {
        ...
        const double shat = s_hat(q2), mbhat = m_b_PS() / m_B, mKhat2 = power_of<2>(m_Kstar() / m_B()), m_K2 = power_of<2>(m_Kstar()), m_B2 = power_of<2>(m_B()),
                     m2_diff = m_B2 - m_K2, norm_s = this->norm(q2), sqrt_lam = std::sqrt(lambda(q2)), sqrt_s = std::sqrt(q2);

        auto dff = dipole_form_factors(q2, wc);

        const complex<double> wilson_minus_right = (wc.c9() - wc.c9prime()) + (wc.c10() - wc.c10prime()), wilson_minus_left = (wc.c9() - wc.c9prime()) - (wc.c10() - wc.c10prime()),
                              wilson_plus_right = (wc.c9() + wc.c9prime()) + (wc.c10() + wc.c10prime()), wilson_plus_left = (wc.c9() + wc.c9prime()) - (wc.c10() + wc.c10prime());

        // longitudinal amplitude
        const double prefactor_long = -norm_s / (2.0 * m_Kstar() * std::sqrt(q2));

        const complex<double> a = (m2_diff - q2) * 2.0 * energy(q2) * xi_perp(q2) - lambda(q2) * m_B() / m2_diff * (xi_perp(q2) - xi_par(q2)),
                              b = 2.0 * m_b_PS()
                                  * (((m_B2 + 3.0 * m_K2 - q2) * 2.0 * energy(q2) / m_B() - lambda(q2) / m2_diff) * dff.calT_perp_left - lambda(q2) / m2_diff * dff.calT_parallel);
        ...
        result.a_perp_right = prefactor_perp * (wilson_plus_right * xi_perp(q2) + uncertainty_perp() * (2.0 * mbhat / shat) * dff.calT_perp_right);
        result.a_perp_left  = prefactor_perp * (wilson_plus_left * xi_perp(q2) + uncertainty_perp() * (2.0 * mbhat / shat) * dff.calT_perp_right);
        ...
        result.a_para_right =
                prefactor_par
                * (wilson_minus_right * xi_perp(q2) * 2.0 * energy(q2) / m2_diff + uncertainty_para() * 4.0 * m_b_PS() * energy(q2) / q2 / m_B() * dff.calT_perp_left);
        result.a_para_left =
                prefactor_par * (wilson_minus_left * xi_perp(q2) * 2.0 * energy(q2) / m2_diff + uncertainty_para() * 4.0 * m_b_PS() * energy(q2) / q2 / m_B() * dff.calT_perp_left);

        // timelike amplitude
        result.a_time = norm_s * sqrt_lam / sqrt_s * (2.0 * (wc.c10() - wc.c10prime()) + q2 / m_l / (m_b_MSbar + m_s_MSbar) * (wc.cP() - wc.cPprime())) * form_factors->a_0(q2);

        // scalar amplitude
        result.a_scal = -2.0 * norm_s * sqrt_lam * (wc.cS() - wc.cSprime()) / (m_b_MSbar + m_s_MSbar) * form_factors->a_0(q2);

        // tensor amplitudes [BHvD:2012A]  eqs. (B18 - B20)
        // no form factor relations used
        const double ff_T1 = form_factors->t_1(q2), ff_T2 = form_factors->t_2(q2), ff_T3 = form_factors->t_3(q2),

                     kin_tensor_1 = norm_s / m_Kstar() * ((m_B2 + 3.0 * m_K2 - q2) * ff_T2 - lambda(q2) / m2_diff * ff_T3), kin_tensor_2 = 2.0 * norm_s * sqrt_lam / sqrt_s * ff_T1,
    ...
    double
    BToKstarDileptonAmplitudes<tag::BFS2004>::real_C9_perp(const double & q2) const
    {
        WilsonCoefficients<BToS> wc = model->wilson_coefficients_b_to_s(mu(), lepton_flavor, cp_conjugate);

        const double shat = s_hat(q2), mbhat = m_b_PS() / m_B;

        auto dff = dipole_form_factors(q2, wc);

        return real(wc.c9() + uncertainty_perp() * (2.0 * mbhat / shat) * dff.calT_perp_right / xi_perp(q2));
    }

    double
    BToKstarDileptonAmplitudes<tag::BFS2004>::imag_C9_perp(const double & q2) const
    {
        WilsonCoefficients<BToS> wc = model->wilson_coefficients_b_to_s(mu(), lepton_flavor, cp_conjugate);
        ...
        return imag(wc.c9() + uncertainty_perp() * (2.0 * mbhat / shat) * dff.calT_perp_right / xi_perp(q2));
    }

    double
    BToKstarDileptonAmplitudes<tag::BFS2004>::real_C9_para(const double & q2) const
    {
        WilsonCoefficients<BToS> wc = model->wilson_coefficients_b_to_s(mu(), lepton_flavor, cp_conjugate);

        auto dff = dipole_form_factors(q2, wc);

        return real(wc.c9() - uncertainty_para() * 2.0 * m_b_PS() / m_B() * dff.calT_parallel / xi_par(q2));
    }

    double
    BToKstarDileptonAmplitudes<tag::BFS2004>::imag_C9_para(const double & q2) const
    {
        WilsonCoefficients<BToS> wc = model->wilson_coefficients_b_to_s(mu(), lepton_flavor, cp_conjugate);

        auto dff = dipole_form_factors(q2, wc);

        return imag(wc.c9() - uncertainty_para() * 2.0 * m_b_PS() / m_B() * dff.calT_parallel / xi_par(q2));
    }
} // namespace eos
