...
namespace eos
{
    ...
    BToKDileptonAmplitudes<tag::GvDV2020>::BToKDileptonAmplitudes(const Parameters & p, const Options & o) :
    ...
    const std::vector<OptionSpecification> BToKDileptonAmplitudes<tag::GvDV2020>::options{
