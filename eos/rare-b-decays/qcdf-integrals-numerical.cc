...
namespace eos
{
    ...
    QCDFIntegralCalculator<BToKstarDilepton, tag::Numerical>::photon_massless_case(const double & /*m_B*/, const double & /*m_V*/, const double & /*mu*/,
                                                                                   const double & /*a_1_perp*/, const double & /*a_2_perp*/, const double & /*a_1_para*/,
                                                                                   const double & /*a_2_para*/)
    {
    ...
    template <>
    QCDFIntegrals<BToKstarDilepton>
    QCDFIntegralCalculator<BToKstarDilepton, tag::Numerical>::photon_charm_case(const double & /*m_c*/, const double & /*m_B*/, const double & /*m_V*/, const double & /*mu*/,
                                                                                const double & /*a_1_perp*/, const double & /*a_2_perp*/, const double & /*a_1_para*/,
                                                                                const double & /*a_2_para*/)
    {
    ...
    template <>
    QCDFIntegrals<BToKstarDilepton>
    QCDFIntegralCalculator<BToKstarDilepton, tag::Numerical>::photon_bottom_case(const double & /*m_b*/, const double & /*m_B*/, const double & /*m_V*/, const double & /*mu*/,
                                                                                 const double & /*a_1_perp*/, const double & /*a_2_perp*/, const double & /*a_1_para*/,
                                                                                 const double & /*a_2_para*/)
    {
    ...
    template <>
    QCDFIntegrals<BToKstarDilepton>
    QCDFIntegralCalculator<BToKstarDilepton, tag::Numerical>::dilepton_massless_case(const double & s, const double & m_B, const double & m_V, const double & mu,
                                                                                     const double & a_1_perp, const double & a_2_perp, const double & a_1_para,
                                                                                     const double & a_2_para)
    {
    ...
    template <>
    QCDFIntegrals<BToKstarDilepton>
    QCDFIntegralCalculator<BToKstarDilepton, tag::Numerical>::dilepton_charm_case(const double & s, const double & m_c, const double & m_B, const double & m_V, const double & mu,
                                                                                  const double & a_1_perp, const double & a_2_perp, const double & a_1_para,
                                                                                  const double & a_2_para)
    {
        QCDFIntegrals<BToKstarDilepton> results;
    ...
    template <>
    QCDFIntegrals<BToKstarDilepton>
    QCDFIntegralCalculator<BToKstarDilepton, tag::Numerical>::dilepton_bottom_case(const double & s, const double & m_b, const double & m_B, const double & m_V, const double & mu,
                                                                                   const double & a_1_perp, const double & a_2_perp, const double & a_1_para,
                                                                                   const double & a_2_para)
    {
        QCDFIntegrals<BToKstarDilepton> results;
