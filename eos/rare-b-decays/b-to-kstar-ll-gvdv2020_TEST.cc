...
class BToKstarDileptonGvDV2020Test : public TestCase
{
    public:
...
class BToKstarDileptonJavierTest : public TestCase
{
    public:
...
class BToKstarDileptonJavierGRvDV2022Test : public TestCase
{
    public:
        ...
        run() const
        {
            ...
            TEST_CHECK_RELATIVE_ERROR(Observable::make("B->K^*ll::dBR/ds", p, k, oo)->evaluate(), 0.669443e-07, eps);
            TEST_CHECK_RELATIVE_ERROR(Observable::make("B->K^*ll::F_L(q2)", p, k, oo)->evaluate(), 0.542507, eps);
            TEST_CHECK_RELATIVE_ERROR(Observable::make("B->K^*ll::A_FB(q2)", p, k, oo)->evaluate(), -0.167357, eps);

            TEST_CHECK_RELATIVE_ERROR(Observable::make("B->K^*ll::P'_4(q2)", p, k, oo)->evaluate(), 0.920583, eps);
            TEST_CHECK_RELATIVE_ERROR(Observable::make("B->K^*ll::P'_5(q2)", p, k, oo)->evaluate(), -0.831674, eps);
            TEST_CHECK_RELATIVE_ERROR(Observable::make("B->K^*ll::P'_6(q2)", p, k, oo)->evaluate(), -0.00743048, eps);

            TEST_CHECK_RELATIVE_ERROR(Observable::make("B->K^*ll::S_3(q2)", p, k, oo)->evaluate(), -0.00919817, eps);
            TEST_CHECK_RELATIVE_ERROR(Observable::make("B->K^*ll::S_4(q2)", p, k, oo)->evaluate(), 0.214768, eps);
            TEST_CHECK_RELATIVE_ERROR(Observable::make("B->K^*ll::S_5(q2)", p, k, oo)->evaluate(), -0.388051, eps);
            TEST_CHECK_RELATIVE_ERROR(Observable::make("B->K^*ll::S_7(q2)", p, k, oo)->evaluate(), 0.00346699, eps);
            TEST_CHECK_RELATIVE_ERROR(Observable::make("B->K^*ll::S_8(q2)", p, k, oo)->evaluate(), -0.00179773, eps);
            TEST_CHECK_RELATIVE_ERROR(Observable::make("B->K^*ll::S_9(q2)", p, k, oo)->evaluate(), -0.0000595069, eps);
        }
