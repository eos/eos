...
namespace eos
{
    ...
    namespace lambdab_to_lambda_dilepton
    {
        ...
        struct AngularObservables
        {
                ...
                AngularObservables(const Amplitudes & a)
                {
                    ...
                    _k[0] = (norm(a.a_perp_1_R) + norm(a.a_para_1_R) + norm(a.a_perp_1_L) + norm(a.a_para_1_L) + 2.0 * norm(a.a_perp_0_R) + 2.0 * norm(a.a_para_0_R)
                             + 2.0 * norm(a.a_perp_0_L) + 2.0 * norm(a.a_para_0_L))
                            / 4.0;

                    _k[1] = (norm(a.a_perp_1_R) + norm(a.a_para_1_R) + norm(a.a_perp_1_L) + norm(a.a_para_1_L)) / 2.0;

                    _k[2] = -std::real(a.a_perp_1_R * std::conj(a.a_para_1_R) - a.a_perp_1_L * std::conj(a.a_para_1_L));

                    _k[3] = std::real(a.a_perp_1_R * std::conj(a.a_para_1_R) + a.a_perp_1_L * std::conj(a.a_para_1_L) + 2.0 * a.a_perp_0_R * std::conj(a.a_para_0_R)
                                      + 2.0 * a.a_perp_0_L * std::conj(a.a_para_0_L))
                            * a.alpha / 2.0;

                    _k[4] = std::real(a.a_perp_1_R * std::conj(a.a_para_1_R) + a.a_perp_1_L * std::conj(a.a_para_1_L)) * a.alpha;

                    _k[5] = -(norm(a.a_perp_1_R) + norm(a.a_para_1_R) - norm(a.a_perp_1_L) - norm(a.a_para_1_L)) * a.alpha / 2.0;

                    _k[6] = -std::real(a.a_para_1_R * std::conj(a.a_perp_0_R) - a.a_perp_1_R * std::conj(a.a_para_0_R) + a.a_para_1_L * std::conj(a.a_perp_0_L)
                                       - a.a_perp_1_L * std::conj(a.a_para_0_L))
                            * a.alpha / sqrt(2.0);

                    _k[7] = -std::real(a.a_para_1_R * std::conj(a.a_para_0_R) - a.a_perp_1_R * std::conj(a.a_perp_0_R) - a.a_para_1_L * std::conj(a.a_para_0_L)
                                       + a.a_perp_1_L * std::conj(a.a_perp_0_L))
                            * a.alpha / sqrt(2.0);

                    _k[8] = std::imag(a.a_perp_1_R * std::conj(a.a_perp_0_R) - a.a_para_1_R * std::conj(a.a_para_0_R) + a.a_perp_1_L * std::conj(a.a_perp_0_L)
                                      - a.a_para_1_L * std::conj(a.a_para_0_L))
                            * a.alpha / sqrt(2.0);

                    _k[9] = std::imag(a.a_perp_1_R * std::conj(a.a_para_0_R) - a.a_para_1_R * std::conj(a.a_perp_0_R) - a.a_perp_1_L * std::conj(a.a_para_0_L)
                                      + a.a_para_1_L * std::conj(a.a_perp_0_L))
                            * a.alpha / sqrt(2.0);

                    _k[10] = -std::real(a.a_perp_1_R * std::conj(a.a_para_1_R) - 2.0 * a.a_perp_0_R * std::conj(a.a_para_0_R) + a.a_perp_1_L * std::conj(a.a_para_1_L)
                                        - 2.0 * a.a_perp_0_L * std::conj(a.a_para_0_L))
                             * a.polarisation / 2.0;

                    _k[11] = -std::real(a.a_perp_1_R * std::conj(a.a_para_1_R) + a.a_perp_1_L * std::conj(a.a_para_1_L)) * a.polarisation;

                    _k[12] = (norm(a.a_perp_1_R) + norm(a.a_para_1_R) - norm(a.a_perp_1_L) - norm(a.a_para_1_L)) * a.polarisation / 2.0;

                    _k[13] = -(norm(a.a_perp_1_R) + norm(a.a_para_1_R) - 2.0 * norm(a.a_perp_0_R) - 2.0 * norm(a.a_para_0_R) + norm(a.a_perp_1_L) + norm(a.a_para_1_L)
                               - 2.0 * norm(a.a_perp_0_L) - 2.0 * norm(a.a_para_0_L))
                             * a.alpha * a.polarisation / 4.0;

                    _k[14] = -(norm(a.a_perp_1_R) + norm(a.a_para_1_R) + norm(a.a_perp_1_L) + norm(a.a_para_1_L)) * a.alpha * a.polarisation / 2.0;

                    _k[15] = std::real(a.a_perp_1_R * std::conj(a.a_para_1_R) - a.a_perp_1_L * std::conj(a.a_para_1_L)) * a.alpha * a.polarisation;


                    _k[16] = std::real(a.a_perp_1_R * std::conj(a.a_perp_0_R) - a.a_para_1_R * std::conj(a.a_para_0_R) + a.a_perp_1_L * std::conj(a.a_perp_0_L)
                                       - a.a_para_1_L * std::conj(a.a_para_0_L))
                             * a.alpha * a.polarisation / sqrt(2.0);

                    _k[17] = std::real(a.a_perp_1_R * std::conj(a.a_para_0_R) - a.a_para_1_R * std::conj(a.a_perp_0_R) - a.a_perp_1_L * std::conj(a.a_para_0_L)
                                       + a.a_para_1_L * std::conj(a.a_perp_0_L))
                             * a.alpha * a.polarisation / sqrt(2.0);

                    _k[18] = -std::imag(a.a_para_1_R * std::conj(a.a_perp_0_R) - a.a_perp_1_R * std::conj(a.a_para_0_R) + a.a_para_1_L * std::conj(a.a_perp_0_L)
                                        - a.a_perp_1_L * std::conj(a.a_para_0_L))
                             * a.alpha * a.polarisation / sqrt(2.0);

                    _k[19] = -std::imag(a.a_para_1_R * std::conj(a.a_para_0_R) - a.a_perp_1_R * std::conj(a.a_perp_0_R) - a.a_para_1_L * std::conj(a.a_para_0_L)
                                        + a.a_perp_1_L * std::conj(a.a_perp_0_L))
                             * a.alpha * a.polarisation / sqrt(2.0);

                    _k[20] = std::imag(a.a_para_1_R * std::conj(a.a_para_0_R) + a.a_perp_1_R * std::conj(a.a_perp_0_R) + a.a_para_1_L * std::conj(a.a_para_0_L)
                                       + a.a_perp_1_L * std::conj(a.a_perp_0_L))
                             * a.polarisation / sqrt(2.0);

                    _k[21] = -std::imag(a.a_perp_1_R * std::conj(a.a_para_0_R) + a.a_para_1_R * std::conj(a.a_perp_0_R) - a.a_perp_1_L * std::conj(a.a_para_0_L)
                                        - a.a_para_1_L * std::conj(a.a_perp_0_L))
                             * a.polarisation / sqrt(2.0);

                    _k[22] = -std::real(a.a_perp_1_R * std::conj(a.a_para_0_R) + a.a_para_1_R * std::conj(a.a_perp_0_R) + a.a_perp_1_L * std::conj(a.a_para_0_L)
                                        + a.a_para_1_L * std::conj(a.a_perp_0_L))
                             * a.polarisation / sqrt(2.0);

                    _k[23] = std::real(a.a_perp_1_R * std::conj(a.a_perp_0_R) + a.a_para_1_R * std::conj(a.a_para_0_R) - a.a_perp_1_L * std::conj(a.a_perp_0_L)
                                       - a.a_para_1_L * std::conj(a.a_para_0_L))
                             * a.polarisation / sqrt(2.0);

                    _k[24] = std::imag(a.a_perp_1_R * std::conj(a.a_para_0_R) + a.a_para_1_R * std::conj(a.a_perp_0_R) + a.a_perp_1_L * std::conj(a.a_para_0_L)
                                       + a.a_para_1_L * std::conj(a.a_perp_0_L))
                             * a.alpha * a.polarisation / sqrt(2.0);

                    _k[25] = -std::imag(a.a_perp_1_R * std::conj(a.a_perp_0_R) + a.a_para_1_R * std::conj(a.a_para_0_R) - a.a_perp_1_L * std::conj(a.a_perp_0_L)
                                        - a.a_para_1_L * std::conj(a.a_para_0_L))
                             * a.alpha * a.polarisation / sqrt(2.0);

                    _k[26] = -std::real(a.a_perp_1_R * std::conj(a.a_perp_0_R) + a.a_para_1_R * std::conj(a.a_para_0_R) + a.a_perp_1_L * std::conj(a.a_perp_0_L)
                                        + a.a_para_1_L * std::conj(a.a_para_0_L))
                             * a.alpha * a.polarisation / sqrt(2.0);

                    _k[27] = std::real(a.a_perp_1_R * std::conj(a.a_para_0_R) + a.a_para_1_R * std::conj(a.a_perp_0_R) - a.a_perp_1_L * std::conj(a.a_para_0_L)
                                       - a.a_para_1_L * std::conj(a.a_perp_0_L))
                             * a.alpha * a.polarisation / sqrt(2.0);

                    _k[28] = 0.0;

                    _k[29] = std::imag(a.a_perp_0_R * std::conj(a.a_para_0_R) + a.a_perp_0_L * std::conj(a.a_para_0_L)) * a.alpha * a.polarisation;

                    _k[30] = 0.0;

                    _k[31] = (norm(a.a_perp_0_R) - norm(a.a_para_0_R) + norm(a.a_perp_0_L) - norm(a.a_para_0_L)) * a.alpha * a.polarisation / 2.0;

                    _k[32] = (norm(a.a_perp_1_R) - norm(a.a_para_1_R) + norm(a.a_perp_1_L) - norm(a.a_para_1_L)) * a.alpha * a.polarisation / 4.0;

                    _k[33] = std::imag(a.a_perp_1_R * std::conj(a.a_para_1_R) + a.a_perp_1_L * std::conj(a.a_para_1_L)) * a.alpha * a.polarisation / 2.0;
                }
    ...
    template <> struct Implementation<LambdaBToLambdaDilepton<LargeRecoil>>
    {
            ...
            Implementation(const Parameters & p, const Options & o, ParameterUser & u) :
                ...
                polarisation(p["Lambda_b::polarisation@" + o.get("production-polarisation"_ok, "unpolarised"_ov).str()], u),
            ...
            lambdab_to_lambda_dilepton::Amplitudes
            amplitudes(const double & q2)
            {
                ...
                complex<double> tau_1p = (m_Lambda_b + m_Lambda) / m_Lambda_b
                                                 * (c7eff + wc.c7prime() - alpha_s / (4.0 * M_PI) * (wc.c1() * F17c + wc.c2() * F27c + c8eff * F87)
                                                    - alpha_s / (4.0 * M_PI) * (wc.c1() * (F17c - F17u) + wc.c2() * (F27c - F27u) + c8eff * F87) * lambda_hat_u)
                                                 * R1p
                                         + q2 / (2.0 * m_b_MSbar * m_Lambda_b)
                                                   * (Y_top + lambda_hat_u * Y_up - alpha_s / (4.0 * M_PI) * (wc.c1() * F19c + wc.c2() * F29c + wc.c8() * F89)
                ...
                complex<double> tau_1m = (m_Lambda_b - m_Lambda) / m_Lambda_b
                                                 * (c7eff - wc.c7prime() - alpha_s / (4.0 * M_PI) * (wc.c1() * F17c + wc.c2() * F27c)
                                                    - alpha_s / (4.0 * M_PI) * (wc.c1() * (F17c - F17u) + wc.c2() * (F27c - F27u) + c8eff * F87) * lambda_hat_u)
                                                 * R1m
                                         + q2 / (2.0 * m_b_MSbar * m_Lambda_b)
                                                   * (Y_top + lambda_hat_u * Y_up - alpha_s / (4.0 * M_PI) * (wc.c1() * F19c + wc.c2() * F29c + c8eff * F87)
                                                      - alpha_s / (4.0 * M_PI) * (wc.c1() * (F19c - F19u) + wc.c2() * (F29c - F29u) + wc.c8() * F89) * lambda_hat_u);
                complex<double> tau_0p = m_Lambda_b / (m_Lambda_b + m_Lambda)
                                         ...
                                         + m_Lambda_b / (2.0 * m_b_MSbar)
                                                   * (Y_top + lambda_hat_u * Y_up - alpha_s / (4.0 * M_PI) * (wc.c1() * F19c + wc.c2() * F29c)
                                                      - alpha_s / (4.0 * M_PI) * (wc.c1() * (F19c - F19u) + wc.c2() * (F29c - F29u) + wc.c8() * F89) * lambda_hat_u);
                ...
                // cf. [BFvD:2014A], eqs. (??)-(??)
                result.a_perp_1_R =
                        -2.0 * N * (wc.c9() + wc.c9prime() + (wc.c10() + wc.c10prime()) + 2.0 * m_b_MSbar * m_Lambda_b / q2 * tau_1p) * form_factors->f_perp_v(q2) * sqrtsminus;
                result.a_perp_1_L =
                        -2.0 * N * (wc.c9() + wc.c9prime() - (wc.c10() + wc.c10prime()) + 2.0 * m_b_MSbar * m_Lambda_b / q2 * tau_1p) * form_factors->f_perp_v(q2) * sqrtsminus;

                result.a_para_1_R =
                        +2.0 * N * (wc.c9() - wc.c9prime() + (wc.c10() - wc.c10prime()) + 2.0 * m_b_MSbar * m_Lambda_b / q2 * tau_1m) * form_factors->f_perp_a(q2) * sqrtsplus;
                result.a_para_1_L =
                        +2.0 * N * (wc.c9() - wc.c9prime() - (wc.c10() - wc.c10prime()) + 2.0 * m_b_MSbar * m_Lambda_b / q2 * tau_1m) * form_factors->f_perp_a(q2) * sqrtsplus;

                result.a_perp_0_R = +sqrt(2.0) * N * (wc.c9() + wc.c9prime() + (wc.c10() + wc.c10prime()) + 2.0 * m_b_MSbar / m_Lambda_b * tau_0p) * form_factors->f_long_v(q2)
                                    * (m_Lambda_b + m_Lambda) / sqrts * sqrtsminus;
                result.a_perp_0_L = +sqrt(2.0) * N * (wc.c9() + wc.c9prime() - (wc.c10() + wc.c10prime()) + 2.0 * m_b_MSbar / m_Lambda_b * tau_0p) * form_factors->f_long_v(q2)
                                    * (m_Lambda_b + m_Lambda) / sqrts * sqrtsminus;

                result.a_para_0_R = -sqrt(2.0) * N * (wc.c9() - wc.c9prime() + (wc.c10() - wc.c10prime()) + 2.0 * m_b_MSbar / m_Lambda_b * tau_0m) * form_factors->f_long_a(q2)
                                    * (m_Lambda_b - m_Lambda) / sqrts * sqrtsplus;
                result.a_para_0_L = -sqrt(2.0) * N * (wc.c9() - wc.c9prime() - (wc.c10() - wc.c10prime()) + 2.0 * m_b_MSbar / m_Lambda_b * tau_0m) * form_factors->f_long_a(q2)
                                    * (m_Lambda_b - m_Lambda) / sqrts * sqrtsplus;
            ...
            inline lambdab_to_lambda_dilepton::AngularObservables
    ...
    const std::vector<OptionSpecification> Implementation<LambdaBToLambdaDilepton<LargeRecoil>>::options{
    ...
    const std::set<ReferenceName> LambdaBToLambdaDilepton<LargeRecoil>::references{};
    ...
    template <> struct Implementation<LambdaBToLambdaDilepton<LowRecoil>>
    {
            ...
            amplitudes(const double & q2)
            {
                ...
                result.a_perp_1_R = -2.0 * N
                                    * (c9eff + wc.c9prime() + (2.0 * kappa * m_b * m_Lambda_b / q2) * (c7eff + wc.c7prime()) * zeta_perp_V + (wc.c10() + wc.c10prime()) + x_perp_1)
                                    * form_factors->f_perp_v(q2) * sqrtsminus;
                result.a_perp_1_L = -2.0 * N
                                    * (c9eff + wc.c9prime() + (2.0 * kappa * m_b * m_Lambda_b / q2) * (c7eff + wc.c7prime()) * zeta_perp_V - (wc.c10() + wc.c10prime()) + x_perp_1)
                                    * form_factors->f_perp_v(q2) * sqrtsminus;

                result.a_para_1_R = +2.0 * N
                                    * (c9eff - wc.c9prime() + (2.0 * kappa * m_b * m_Lambda_b / q2) * (c7eff - wc.c7prime()) * zeta_perp_A + (wc.c10() - wc.c10prime()) + x_para_1)
                                    * form_factors->f_perp_a(q2) * sqrtsplus;
                result.a_para_1_L = +2.0 * N
                                    * (c9eff - wc.c9prime() + (2.0 * kappa * m_b * m_Lambda_b / q2) * (c7eff - wc.c7prime()) * zeta_perp_A - (wc.c10() - wc.c10prime()) + x_para_1)
                                    * form_factors->f_perp_a(q2) * sqrtsplus;

                result.a_perp_0_R = +sqrt(2.0) * N
                                    * (c9eff + wc.c9prime() + (2.0 * kappa * m_b * m_Lambda_b / q2) * (c7eff + wc.c7prime()) * zeta_long_V + (wc.c10() + wc.c10prime()) + x_perp_0)
                                    * form_factors->f_long_v(q2) * (m_Lambda_b + m_Lambda) / sqrts * sqrtsminus;
                result.a_perp_0_L = +sqrt(2.0) * N
                                    * (c9eff + wc.c9prime() + (2.0 * kappa * m_b * m_Lambda_b / q2) * (c7eff + wc.c7prime()) * zeta_long_V - (wc.c10() + wc.c10prime()) + x_perp_0)
                                    * form_factors->f_long_v(q2) * (m_Lambda_b + m_Lambda) / sqrts * sqrtsminus;

                result.a_para_0_R = -sqrt(2.0) * N
                                    * (c9eff - wc.c9prime() + (2.0 * kappa * m_b * m_Lambda_b / q2) * (c7eff - wc.c7prime()) * zeta_long_A + (wc.c10() - wc.c10prime()) + x_para_0)
                                    * form_factors->f_long_a(q2) * (m_Lambda_b - m_Lambda) / sqrts * sqrtsplus;
                result.a_para_0_L = -sqrt(2.0) * N
                                    * (c9eff - wc.c9prime() + (2.0 * kappa * m_b * m_Lambda_b / q2) * (c7eff - wc.c7prime()) * zeta_long_A - (wc.c10() - wc.c10prime()) + x_para_0)
                                    * form_factors->f_long_a(q2) * (m_Lambda_b - m_Lambda) / sqrts * sqrtsplus;
    ...
    const std::vector<OptionSpecification> Implementation<LambdaBToLambdaDilepton<LowRecoil>>::options{
    ...
    const std::set<ReferenceName> LambdaBToLambdaDilepton<LowRecoil>::references{};
