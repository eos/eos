...
namespace eos
{
    ...
    // cf. [GP:2004A], Eq. (56)
    complex<double>
    BToKstarDileptonAmplitudes<tag::GP2004>::c7eff(const WilsonCoefficients<BToS> & wc, const double & q2) const
    {
    ...
    complex<double>
    BToKstarDileptonAmplitudes<tag::GP2004>::c9eff(const WilsonCoefficients<BToS> & wc, const double & q2) const
    {
    ...
    double
    BToKstarDileptonAmplitudes<tag::GP2004>::norm(const double & q2) const
    {
    ...
    BToKstarDileptonAmplitudes<tag::GP2004>::amplitudes(const double & q2) const
    {
