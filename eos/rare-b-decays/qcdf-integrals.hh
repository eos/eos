...
namespace eos
{
     ...
     */
    template <typename Process_> struct QCDFIntegrals;

    template <> struct QCDFIntegrals<BToKstarDilepton>
    {
    ...
    template <typename Process_, typename Tag_> class QCDFIntegralCalculator
    {
        public:
             ...
             */
            static ResultsType photon_bottom_case(const double & m_b, const double & m_B, const double & m_V, const double & mu, const double & a_1_perp, const double & a_2_perp,
             ...
             * @param a_2_parallel Second Gegenbauer moment for the parallel amplitude.
             */
            static ResultsType photon_charm_case(const double & m_c, const double & m_B, const double & m_V, const double & mu, const double & a_1_perp, const double & a_2_perp,
                                                 const double & a_1_parallel, const double & a_2_parallel);
             ...
             * @param a_2_parallel Second Gegenbauer moment for the parallel amplitude.
             */
            static ResultsType photon_massless_case(const double & m_B, const double & m_V, const double & mu, const double & a_1_perp, const double & a_2_perp,
                                                    const double & a_1_parallel, const double & a_2_parallel);
             ...
             * @param a_2_parallel Second Gegenbauer moment for the parallel amplitude.
             */
            static ResultsType dilepton_bottom_case(const double & s, const double & m_b, const double & m_B, const double & m_V, const double & mu, const double & a_1_perp,
             ...
             * @param a_2_parallel Second Gegenbauer moment for the parallel amplitude.
             */
            static ResultsType dilepton_charm_case(const double & s, const double & m_c, const double & m_B, const double & m_V, const double & mu, const double & a_1_perp,
                                                   const double & a_2_perp, const double & a_1_parallel, const double & a_2_parallel);
             ...
             * @param a_2_parallel Second Gegenbauer moment for the parallel amplitude.
             */
            static ResultsType dilepton_massless_case(const double & s, const double & m_B, const double & m_V, const double & mu, const double & a_1_perp, const double & a_2_perp,
                                                      const double & a_1_parallel, const double & a_2_parallel);
    };
