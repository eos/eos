...
template <typename Tag_> class QCDFIntegralsPhotonTest : public TestCase
{
    public:
...
template <typename Tag_> class QCDFIntegralsDileptonBottomTest : public TestCase
{
    public:
        using Calculator = QCDFIntegralCalculator<BToKstarDilepton, Tag_>;
...
template <typename Tag_> class QCDFIntegralsDileptonCharmTest : public TestCase
{
    public:
        using Calculator = QCDFIntegralCalculator<BToKstarDilepton, Tag_>;
...
template <typename Tag_> class QCDFIntegralsDileptonMasslessTest : public TestCase
{
    public:
        using Calculator = QCDFIntegralCalculator<BToKstarDilepton, Tag_>;
