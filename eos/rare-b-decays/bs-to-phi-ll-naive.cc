...
namespace eos
{
    ...
    BsToPhiDileptonAmplitudes<tag::Naive>::sb_contributions(const double & s, const WilsonCoefficients<BToS> & wc) const
    {
    ...
    BsToPhiDileptonAmplitudes<tag::Naive>::amplitudes(const double & s) const
    {
    ...
    double
    BsToPhiDileptonAmplitudes<tag::Naive>::imag_C9_perp(const double & s) const
    {
        WilsonCoefficients<BToS> wc = model->wilson_coefficients_b_to_s(mu(), lepton_flavor, cp_conjugate);
