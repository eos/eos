        ...
        virtual void run() const
        {
            /* Low Recoil (SM) */
            {
                ...
                /* q^2 = [14.18, 22.8] */
                {
                    ...
                    TEST_CHECK_RELATIVE_ERROR(d.integrated_cp_asymmetry_1(14.18, 22.8),        2.2706273e-05, eps);
                }
            }
            ...
            /* Benchmark Point */
            {
                ...
                /* q^2 = [14.18, 22.8] */
                {
                    ...
                    TEST_CHECK_RELATIVE_ERROR(d.integrated_cp_asymmetry_1(14.18, 22.8),               0.0609245,     eps);
                }
            }
        }
