...
#ifndef MASTER_GUARD_EOS_RARE_B_DECAYS_B_TO_KSTAR_LL_NAIVE_HH
#define MASTER_GUARD_EOS_RARE_B_DECAYS_B_TO_KSTAR_LL_NAIVE_HH 1
...
namespace eos
{
    template <> class BToKstarDileptonAmplitudes<tag::Naive> : public BToKstarDilepton::AmplitudeGenerator
    {
        public:
            ...
            virtual double H_perp_corrections(const double & q2) const;
            virtual double H_para_corrections(const double & q2) const;
            virtual double H_long_corrections(const double & q2) const;
