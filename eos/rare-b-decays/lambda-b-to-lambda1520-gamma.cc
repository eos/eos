...
namespace eos
{
     ...
     */
    template <> struct Implementation<LambdaBToLambda1520Gamma>
    {
    ...
    const std::vector<OptionSpecification> Implementation<LambdaBToLambda1520Gamma>::options{};
    ...
    const std::set<ReferenceName> LambdaBToLambda1520Gamma::references{ "ABR:2022A"_rn };
