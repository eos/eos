    ...
    public TestCase
{
    ...
    BsToPhiCharmoniumGRvDV2021Test() :
        ...
        virtual void run() const
        {
            ...
            p["B_s->phiccbar::Re{alpha_0^perp}@GRvDV2021"]  = 0.02;
            p["B_s->phiccbar::Im{alpha_0^perp}@GRvDV2021"]  = 0.03;
            p["B_s->phiccbar::Re{alpha_1^perp}@GRvDV2021"]  = 0.04;
            p["B_s->phiccbar::Im{alpha_1^perp}@GRvDV2021"]  = 0.05;
            p["B_s->phiccbar::Re{alpha_2^perp}@GRvDV2021"]  = 0.06;
            p["B_s->phiccbar::Im{alpha_2^perp}@GRvDV2021"]  = 0.07;
            p["B_s->phiccbar::Re{alpha_0^para}@GRvDV2021"]  = 0.08;
            p["B_s->phiccbar::Im{alpha_0^para}@GRvDV2021"]  = 0.09;
            p["B_s->phiccbar::Re{alpha_1^para}@GRvDV2021"]  = 0.010;
            p["B_s->phiccbar::Im{alpha_1^para}@GRvDV2021"]  = 0.011;
            p["B_s->phiccbar::Re{alpha_2^para}@GRvDV2021"]  = 0.012;
            p["B_s->phiccbar::Im{alpha_2^para}@GRvDV2021"]  = 0.013;
            p["B_s->phiccbar::Re{alpha_0^long}@GRvDV2021"]  = 0.014;
            p["B_s->phiccbar::Im{alpha_0^long}@GRvDV2021"]  = 0.015;
            p["B_s->phiccbar::Re{alpha_1^long}@GRvDV2021"]  = 0.016;
            p["B_s->phiccbar::Im{alpha_1^long}@GRvDV2021"]  = 0.017;
            p["B_s->phiccbar::Re{alpha_2^long}@GRvDV2021"]  = 0.018;
            p["B_s->phiccbar::Im{alpha_2^long}@GRvDV2021"]  = 0.019;
            ...
            TEST_CHECK_RELATIVE_ERROR(c.branching_ratio(),  51.61403, 1e-5);
