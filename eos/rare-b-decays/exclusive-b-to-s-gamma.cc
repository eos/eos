...
namespace eos
{
    ...
    struct Implementation<BToKstarGamma>
    {
        ...
        Implementation(const Parameters & p, const Options & o, ParameterUser & u) :
            ...
            hbar(p["QM::hbar"], u),
            a_1_perp(p["K^*::a_1_perp@1GeV"], u),
            a_2_perp(p["K^*::a_2_perp@1GeV"], u),
            a_1_par(p["K^*::a_1_para@1GeV"], u),
            a_2_par(p["K^*::a_2_para@1GeV"], u),
        ...
        Amplitudes amplitudes() const
        {
            ...
            WilsonCoefficients<BToS> wc = model->wilson_coefficients_b_to_s(mu(), "mu" /*fake lepton flavour*/, cp_conjugate);
