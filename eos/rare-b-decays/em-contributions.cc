...
namespace eos
{
    ...
    EMContributions::omegaem_99(const double & s_hat, const double & log_m_l_hat)
    {
        ...
        return -2.0 * log_m_l_hat
                       * (-(1.0 + 4.0 * s_hat - 8.0 * s_hat2) / (6.0 * (1.0 - s_hat) * (1.0 + 2.0 * s_hat)) + ln1
                          - (1.0 - 6.0 * s_hat2 + 4.0 * s_hat3) / (2.0 * power_of<2>(1.0 - s_hat) * (1.0 + 2.0 * s_hat)) * ln)
               - 1.0 / 9.0 * li2 + 4.0 * power_of<2>(M_PI) / 27.0 - (37.0 - 3.0 * s_hat - 6.0 * s_hat2) / (72.0 * (1.0 - s_hat) * (1.0 + 2.0 * s_hat))
               - (41.0 + 76.0 * s_hat) / (36.0 * (1.0 + 2.0 * s_hat)) * ln1
               + (14.0 * s_hat3 - 17.0 * s_hat2 - 10.0 * s_hat + 6.0) / (18.0 * power_of<2>(1.0 - s_hat) * (1.0 + 2.0 * s_hat)) * ln + 17.0 / 18.0 * ln1 * ln
    ...
    EMContributions::omegaem_77(const double & s_hat, const double & log_m_l_hat)
    {
        ...
        return -2.0 * log_m_l_hat * (s_hat / (2.0 * (1.0 - s_hat) * (2.0 + s_hat)) + ln1 - s_hat * (-3.0 + 2.0 * s_hat2) / (2.0 * power_of<2>(1.0 - s_hat) * (2.0 + s_hat)) * ln);
    }
    ...
    EMContributions::omegaem_79(const double & s_hat, const double & log_m_l_hat)
    {
        ...
        return -2.0 * log_m_l_hat * (-1.0 / (2.0 * (1.0 - s_hat)) + ln1 + (-1.0 + 2.0 * s_hat - 2.0 * s_hat2) / (2.0 * power_of<2>(1.0 - s_hat)) * ln);
    }
    ...
    EMContributions::omegaem_22(const double & s_hat, const double & log_m_l_hat, const double & mu)
    {
        ...
        return -2.0 * log_m_l_hat
                       * (sigma_2 / (8.0 * power_of<2>(1.0 - s_hat) * (1.0 + 2.0 * s_hat)) + sigma_1 / (9.0 * power_of<2>(1.0 - s_hat) * (1.0 + 2.0 * s_hat)) * log(mu / 5.0))
    ...
    EMContributions::omegaem_27(const double & s_hat, const double & log_m_l_hat, const double & mu)
    {
        ...
        return -2.0 * log_m_l_hat * complex<double>(sigma_3, sigma_3_I) / (96.0 * (1.0 - s_hat) * (1.0 - s_hat)) + 8.0 / 9.0 * omegaem_79(s_hat, log_m_l_hat) * log(mu / 5.0);
    }
} // namespace eos
