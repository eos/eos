...
class TauDecaysObservablesTest : public TestCase
{
    public:
        TauDecaysObservablesTest() :
            TestCase("tau_decays_observables_test")
        {
        }
        ...
        run() const
        {
            /* Test that every observable in this section can be constructed */
            {
                ...
                for (const auto & group : make_tau_decays_section())
                {
