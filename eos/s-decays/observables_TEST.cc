...
class SDecaysObservablesTest : public TestCase
{
    public:
        SDecaysObservablesTest() :
            TestCase("s_decays_observables_test")
        {
        }
        ...
        run() const
        {
            /* Test that every observable in this section can be constructed */
            {
                ...
                for (const auto & group : make_s_decays_section())
                {
