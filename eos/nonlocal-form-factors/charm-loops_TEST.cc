...
class OneLoopTest : public TestCase
{
    public:
        OneLoopTest() :
...
class HelperTest : public TestCase
{
    public:
        HelperTest() :
...
class SeidelFunctionTest : public TestCase
{
    public:
        SeidelFunctionTest() :
...
class FormFactorsTest : public TestCase
{
    public:
        FormFactorsTest() :
...
class LowRecoilTest : public TestCase
{
    public:
        LowRecoilTest() :
...
class CharmlessTest : public TestCase
{
    public:
        CharmlessTest() :
