...
namespace eos
{
    ...
    namespace nff
    {
        ...
        const constexpr char * BToKstar::label;
        ...
        const constexpr char * BsToPhi::label;
    } // namespace nff

    namespace nff_p_to_v
    {
        class Naive : public NonlocalFormFactor<PToV>
        {
            public:
                ...
                H_perp(const double &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                H_para(const double &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                H_long(const double &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                H_perp(const complex<double> &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                H_para(const complex<double> &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                H_long(const complex<double> &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                Hhat_perp(const double &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                Hhat_para(const double &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                Hhat_long(const double &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                ratio_perp(const double &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                ratio_para(const double &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                ratio_long(const double &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                ratio_perp(const complex<double> &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                ratio_para(const complex<double> &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                ratio_long(const complex<double> &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                F_ratio_perp(const complex<double> &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                F_ratio_para(const complex<double> &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                F_ratio_long(const complex<double> &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                get_orthonormal_perp_coefficients(const unsigned &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                get_orthonormal_para_coefficients(const unsigned &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                get_orthonormal_long_coefficients(const unsigned &) const
                {
                    return 0.0;
                }
                ...
                virtual double
                weak_bound_log_likelihood() const
                {
                    return 0.0;
                }

                virtual double
                strong_bound_log_likelihood() const
                {
                    return 0.0;
                }

                virtual complex<double>
                normalized_moment_V1(const double &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                normalized_moment_V2(const double &) const
                {
                    return 0.0;
                }

                virtual complex<double>
                normalized_moment_V23(const double &) const
                {
                    return 0.0;
                }

                static NonlocalFormFactorPtr<PToV>
                make(const Parameters & p, const Options & o)
                {
         ...
         */
        template <typename Process_> class GvDV2020 : public NonlocalFormFactor<PToV>
        {
            private:
            ...
            public:
                ...
                phi(const complex<double> & q2, const std::array<unsigned, 4> & phi_parameters) const
                {
                    ...
                    const complex<double> phi2 =
                            pow(m_B4 * power_of<4>(z - 1.) - 2 * m_B2 * power_of<2>(z - 1.) * (-16 * m_D02 * z + m_V2 * power_of<2>(z - 1.) + s_0 * power_of<2>(z + 1.))
                                        + power_of<2>(16 * m_D02 * z + m_V2 * power_of<2>(z - 1.) - s_0 * power_of<2>(z + 1.)),
                                0.5); //(C8)
                    const complex<double> phi3 =
                            pow(8 * m_D02 + 4 * pow(4 * m_D04 - s_0 * m_D02, 0.5) - s_0, 0.5) / (-8 * m_D02 - 4 * pow(4 * m_D04 - s_0 * m_D02, 0.5) + s_0 * (z + 1.)); //(C9)
                ...
                inline complex<double>
                phi(const double & q2, const std::array<unsigned, 4> & phi_parameters) const
                {
                ...
                inline complex<double>
                H_residue_jpsi(const std::array<unsigned, 4> & phi_parameters, const std::array<complex<double>, 6> & alpha) const
                {
                ...
                inline complex<double>
                H_residue_psi2s(const std::array<unsigned, 4> & phi_parameters, const std::array<complex<double>, 6> & alpha) const
                {
                    const double m_Jpsi2  = power_of<2>(m_Jpsi);
                    const double m_psi2S2 = power_of<2>(m_psi2S);
                ...
                virtual complex<double>
                H_perp(const complex<double> & q2) const
                {
                    const std::array<complex<double>, 6> alpha_perp{
                        complex<double>(re_alpha_0_perp, im_alpha_0_perp), complex<double>(re_alpha_1_perp, im_alpha_1_perp), complex<double>(re_alpha_2_perp, im_alpha_2_perp),
                        complex<double>(re_alpha_3_perp, im_alpha_3_perp), complex<double>(re_alpha_4_perp, im_alpha_4_perp), complex<double>(re_alpha_5_perp, im_alpha_5_perp),
                    };
                ...
                virtual complex<double>
                H_perp(const double & q2) const
                {
                    return H_perp(complex<double>(q2, 0.0));
                }

                virtual complex<double>
                Hhat_perp(const double & q2) const
                {
                    const std::array<complex<double>, 6> alpha_perp{
                        complex<double>(re_alpha_0_perp, im_alpha_0_perp), complex<double>(re_alpha_1_perp, im_alpha_1_perp), complex<double>(re_alpha_2_perp, im_alpha_2_perp),
                        complex<double>(re_alpha_3_perp, im_alpha_3_perp), complex<double>(re_alpha_4_perp, im_alpha_4_perp), complex<double>(re_alpha_5_perp, im_alpha_5_perp),
                ...
                virtual complex<double>
                H_para(const complex<double> & q2) const
                {
                    const std::array<complex<double>, 6> alpha_para{
                        complex<double>(re_alpha_0_para, im_alpha_0_para), complex<double>(re_alpha_1_para, im_alpha_1_para), complex<double>(re_alpha_2_para, im_alpha_2_para),
                        complex<double>(re_alpha_3_para, im_alpha_3_para), complex<double>(re_alpha_4_para, im_alpha_4_para), complex<double>(re_alpha_5_para, im_alpha_5_para),
                    };
                ...
                virtual complex<double>
                H_para(const double & q2) const
                {
                    return H_para(complex<double>(q2, 0.0));
                }

                virtual complex<double>
                Hhat_para(const double & q2) const
                {
                    const std::array<complex<double>, 6> alpha_para{
                        complex<double>(re_alpha_0_para, im_alpha_0_para), complex<double>(re_alpha_1_para, im_alpha_1_para), complex<double>(re_alpha_2_para, im_alpha_2_para),
                        complex<double>(re_alpha_3_para, im_alpha_3_para), complex<double>(re_alpha_4_para, im_alpha_4_para), complex<double>(re_alpha_5_para, im_alpha_5_para),
                ...
                virtual complex<double>
                H_long(const complex<double> & q2) const
                {
                    const std::array<complex<double>, 6> alpha_long{
                        complex<double>(re_alpha_0_long, im_alpha_0_long), complex<double>(re_alpha_1_long, im_alpha_1_long), complex<double>(re_alpha_2_long, im_alpha_2_long),
                        complex<double>(re_alpha_3_long, im_alpha_3_long), complex<double>(re_alpha_4_long, im_alpha_4_long), complex<double>(re_alpha_5_long, im_alpha_5_long),
                    };
                ...
                virtual complex<double>
                H_long(const double & q2) const
                {
                    return H_long(complex<double>(q2, 0.0));
                }

                virtual complex<double>
                Hhat_long(const double & q2) const
                {
                    const std::array<complex<double>, 6> alpha_long{
                        complex<double>(re_alpha_0_long, im_alpha_0_long), complex<double>(re_alpha_1_long, im_alpha_1_long), complex<double>(re_alpha_2_long, im_alpha_2_long),
                        complex<double>(re_alpha_3_long, im_alpha_3_long), complex<double>(re_alpha_4_long, im_alpha_4_long), complex<double>(re_alpha_5_long, im_alpha_5_long),
                ...
                virtual complex<double>
                ratio_perp(const complex<double> & q2) const
                {
                    const double          m_V2   = power_of<2>(m_V);
                ...
                virtual complex<double>
                ratio_perp(const double & q2) const
                {
                    return ratio_perp(complex<double>(q2, 0.0));
                }

                virtual complex<double>
                F_ratio_perp(const complex<double> & q2) const
                {
                    return (m_B + m_V) / m_B * form_factors->t_1(q2) / form_factors->v(q2);
                }

                virtual complex<double>
                ratio_para(const complex<double> & q2) const
                {
                ...
                virtual complex<double>
                ratio_para(const double & q2) const
                {
                    return ratio_para(complex<double>(q2, 0.0));
                }

                virtual complex<double>
                F_ratio_para(const complex<double> & q2) const
                {
                    return (m_B - m_V) / m_B * form_factors->t_2(q2) / form_factors->a_1(q2);
                }

                virtual complex<double>
                ratio_long(const complex<double> & q2) const
                {
                    const double          m_V2   = power_of<2>(m_V);
                    const double          m_B2   = power_of<2>(m_B);
                    const complex<double> lambda = eos::lambda(complex<double>(m_B2, 0.0), complex<double>(m_V2, 0.0), q2);
                    const complex<double> F_long =
                            ((m_B2 - m_V2 - q2) * power_of<2>(m_B + m_V) * form_factors->a_1(q2) - lambda * form_factors->a_2(q2)) / (2 * m_V * m_B2 * (m_B + m_V));

                    return H_long(q2) / F_long;
                }

                virtual complex<double>
                ratio_long(const double & q2) const
                {
                    return ratio_long(complex<double>(q2, 0.0));
                }

                virtual complex<double>
                F_ratio_long(const complex<double> & q2) const
                {
                    const double          m_V2   = power_of<2>(m_V);
                    const double          m_B2   = power_of<2>(m_B);
                    const complex<double> lambda = eos::lambda(complex<double>(m_B2, 0.0), complex<double>(m_V2, 0.0), q2);
                    const complex<double> F_long =
                            ((m_B2 - m_V2 - q2) * power_of<2>(m_B + m_V) * form_factors->a_1(q2) - lambda * form_factors->a_2(q2)) / (2 * m_V * m_B2 * (m_B + m_V));
                    const complex<double> F_T_long =
                            q2 * ((m_B2 + 3 * m_V2 - q2) * (m_B2 - m_V2) * form_factors->t_2(q2) - lambda * form_factors->a_2(q2)) / (2 * m_V * m_B2 * m_B * (m_B2 - m_V2));
                ...
                virtual complex<double>
                get_orthonormal_perp_coefficients(const unsigned & i) const
                {
                    const std::array<complex<double>, 6> alpha_perp{
                        complex<double>(re_alpha_0_perp, im_alpha_0_perp), complex<double>(re_alpha_1_perp, im_alpha_1_perp), complex<double>(re_alpha_2_perp, im_alpha_2_perp),
                        complex<double>(re_alpha_3_perp, im_alpha_3_perp), complex<double>(re_alpha_4_perp, im_alpha_4_perp), complex<double>(re_alpha_5_perp, im_alpha_5_perp),
                ...
                virtual complex<double>
                get_orthonormal_para_coefficients(const unsigned & i) const
                {
                    const std::array<complex<double>, 6> alpha_para{
                        complex<double>(re_alpha_0_para, im_alpha_0_para), complex<double>(re_alpha_1_para, im_alpha_1_para), complex<double>(re_alpha_2_para, im_alpha_2_para),
                        complex<double>(re_alpha_3_para, im_alpha_3_para), complex<double>(re_alpha_4_para, im_alpha_4_para), complex<double>(re_alpha_5_para, im_alpha_5_para),
                ...
                virtual complex<double>
                get_orthonormal_long_coefficients(const unsigned & i) const
                {
                    const std::array<complex<double>, 6> alpha_long{
                        complex<double>(re_alpha_0_long, im_alpha_0_long), complex<double>(re_alpha_1_long, im_alpha_1_long), complex<double>(re_alpha_2_long, im_alpha_2_long),
                        complex<double>(re_alpha_3_long, im_alpha_3_long), complex<double>(re_alpha_4_long, im_alpha_4_long), complex<double>(re_alpha_5_long, im_alpha_5_long),
         ...
         */
        template <typename Process_> class GRvDV2022order5 : public NonlocalFormFactor<PToV>
        {
            private:
                std::shared_ptr<FormFactors<PToV>> form_factors;
                ...
                static const unsigned                         interpolation_order = 5;
            ...
            public:
                ...
                // Residue of H at s = m_Jpsi2 computed as the residue wrt z -z_Jpsi divided by dz/ds evaluated at s = m_Jpsi2
                inline complex<double>
                H_residue_jpsi(const std::array<unsigned, 4> & phi_parameters, const std::array<complex<double>, interpolation_order + 1> & interpolation_values) const
                {
                    const double m_Jpsi2  = power_of<2>(m_Jpsi);
                    const double m_psi2S2 = power_of<2>(m_psi2S);
                ...
                // Residue of H at s = m_psi2S2 computed as the residue wrt z -z_psi2S divided by dz/ds evaluated at s = m_psi2S2
                inline complex<double>
                H_residue_psi2s(const std::array<unsigned, 4> & phi_parameters, const std::array<complex<double>, interpolation_order + 1> & interpolation_values) const
                {
                    const double m_Jpsi2  = power_of<2>(m_Jpsi);
                    const double m_psi2S2 = power_of<2>(m_psi2S);
                ...
                {
                    const std::array<complex<double>, interpolation_order + 1> interpolation_values{
                        complex<double>(re_at_m7_long, im_at_m7_long), complex<double>(re_at_m5_long, im_at_m5_long),     complex<double>(re_at_m3_long, im_at_m3_long),
                        complex<double>(re_at_m1_long, im_at_m1_long), polar<double>(abs_at_Jpsi_long, arg_at_Jpsi_long), polar<double>(abs_at_psi2S_long, arg_at_psi2S_long)
                    };
                ...
                inline std::pair<gsl_vector *, gsl_vector *>
                orthonormal_perp_coefficients() const
                {
                    const std::array<complex<double>, interpolation_order + 1> interpolation_values{
                        complex<double>(re_at_m7_perp, im_at_m7_perp),
                        complex<double>(re_at_m5_perp, im_at_m5_perp),
                ...
                inline std::pair<gsl_vector *, gsl_vector *>
                orthonormal_para_coefficients() const
                {
                    const std::array<complex<double>, interpolation_order + 1> interpolation_values{
                        complex<double>(re_at_m7_para, im_at_m7_para),
                        complex<double>(re_at_m5_para, im_at_m5_para),
                ...
                inline std::pair<gsl_vector *, gsl_vector *>
                orthonormal_long_coefficients() const
                {
                    const std::array<complex<double>, interpolation_order + 1> interpolation_values{
                        complex<double>(re_at_m7_long, im_at_m7_long), complex<double>(re_at_m5_long, im_at_m5_long),     complex<double>(re_at_m3_long, im_at_m3_long),
                        complex<double>(re_at_m1_long, im_at_m1_long), polar<double>(abs_at_Jpsi_long, arg_at_Jpsi_long), polar<double>(abs_at_psi2S_long, arg_at_psi2S_long)
                ...
                get_orthonormal_perp_coefficients(const unsigned & i) const
                {
                    ...
                    return complex<double>(gsl_vector_get(coefficients.first, i), gsl_vector_get(coefficients.second, i));
                }
                ...
                weak_bound() const
                {
                    ...
                    for (unsigned i = 0; i <= interpolation_order; ++i)
                    {
                        coeff = power_of<2>(gsl_vector_get(perp_coefficients.first, i)) + power_of<2>(gsl_vector_get(perp_coefficients.second, i));
                        if (coeff > largest_absolute_coeff)
                        {
                            largest_absolute_coeff = coeff;
                        }
                        coeff = power_of<2>(gsl_vector_get(para_coefficients.first, i)) + power_of<2>(gsl_vector_get(para_coefficients.second, i));
                        if (coeff > largest_absolute_coeff)
                        {
                            largest_absolute_coeff = coeff;
                        }
                        coeff = power_of<2>(gsl_vector_get(long_coefficients.first, i)) + power_of<2>(gsl_vector_get(long_coefficients.second, i));
                        if (coeff > largest_absolute_coeff)
                        {
                            largest_absolute_coeff = coeff;
                        }
                ...
                strong_bound() const
                {
                    ...
                    for (unsigned i = 0; i <= interpolation_order; ++i)
                    {
                        coefficient_sum += power_of<2>(gsl_vector_get(perp_coefficients.first, i)) + power_of<2>(gsl_vector_get(perp_coefficients.second, i));
                        coefficient_sum += power_of<2>(gsl_vector_get(para_coefficients.first, i)) + power_of<2>(gsl_vector_get(para_coefficients.second, i));
                        coefficient_sum += power_of<2>(gsl_vector_get(long_coefficients.first, i)) + power_of<2>(gsl_vector_get(long_coefficients.second, i));
                    }
    ...
    template <typename Process_> struct Implementation<NonlocalFormFactorObservable<Process_, PToV>>
    {
    ...
    template <typename Process_> NonlocalFormFactorObservable<Process_, PToV>::~NonlocalFormFactorObservable() = default;

    template <typename Process_> const std::vector<OptionSpecification> Implementation<NonlocalFormFactorObservable<Process_, PToV>>::options{};
    ...
    template <typename Process_>
    const std::set<ReferenceName> NonlocalFormFactorObservable<Process_, PToV>::references{
        "GvDV:2020A"_rn,
        "GRvDV:2022A"_rn,
    };
