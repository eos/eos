...
{
    inline double
    lcda_tw2(const double & u, const double & a_1, const double & a_2)
    {
        return 6.0 * u * (1.0 - u) * (1.0 + a_1 * 3.0 * (2.0 * u - 1.0) + a_2 * 3.0 / 2.0 * (5.0 * power_of<2>(2.0 * u - 1.0) - 1.0));
    }

    static complex<double>
    z_ratio(const double & s, const double mq2)
    {
    ...
    */
    ...
    HardScattering::t_perp_s0(const double & u, const double & m_q, const double & m_B)
    {
        ...
        { // m != 0
            if (1 - 4 * m2 / (m_B2 - u * m_B2) > 0)
            {
                ...
                a      = (1 - sq) / (1 + sq);
                LxpLxm = -1. / 3 * power_of<2>(M_PI) + std::log(a) * (std::log(a) + complex<double>(0, M_PI)) + gsl_sf_dilog(-a) + gsl_sf_dilog(-1. / a);
            }
            else
            {
    ...
    complex<double>
    HardScattering::t_perp(const double & s, const double & u, const double & m_q, const double & m_B, const double & m_M)
    {
        if (s == 0)
        {
        ...
        if (m_q > 0)
        {
            return 2 * m_B / (ub * E) * I1(s, u, m_q, m_B) + s / (ub * ub * E * E) * (CharmLoops::B0(ub * power_of<2>(m_B) + u * s, m_q) - CharmLoops::B0(s, m_q));
        }
        return 2 * m_B / (ub * E) * I1(s, u, m_q, m_B);
    }

    complex<double>
    HardScattering::t_par(const double & s, const double & u, const double & m_q, const double & m_B, const double & m_M)
    {
        const double ub = 1.0 - u;
        ...
        {
            return 2 * m_B / (ub * E) * I1(s, u, m_q, m_B)
                   + (ub * power_of<2>(m_B) + u * s) / (ub * ub * E * E) * (CharmLoops::B0(ub * power_of<2>(m_B) + u * s, m_q) - CharmLoops::B0(s, m_q));
        }
        return 2 * m_B / (ub * E) * I1(s, u, m_q, m_B);
    }
    ...
    complex<double>
    HardScattering::j1(const double & s, const double & u, const double & m_q, const double & m_B, const double & a_1, const double & a_2)
    {
        const double ubar = 1.0 - u;
    ...
    complex<double>
    HardScattering::j2(const double & s, const double & u, const double & m_q, const double & m_B, const double & a_1, const double & a_2)
    {
    ...
    complex<double>
    HardScattering::j2_massless(const double & s, const double & u, const double & m_B, const double & a_1, const double & a_2)
    {
        const double ubar = 1.0 - u, ubar2 = ubar * ubar;
        const double s_hat = s / power_of<2>(m_B);
    ...
    complex<double>
    HardScattering::j3(const double & s, const double & u, const double & m_q, const double & m_B, const double & a_1, const double & a_2)
    {
        const double ubar  = 1.0 - u;
    ...
    complex<double>
    HardScattering::j3_massless(const double & s, const double & u, const double & m_B, const double & a_1, const double & a_2)
    {
        const double ubar  = 1.0 - u;
        const double s_hat = s / power_of<2>(m_B);
    ...
    complex<double>
    HardScattering::j4(const double & s, const double & u, const double & m_q, const double & m_B, const double & mu, const double & a_1, const double & a_2)
    {
        const double ubar = 1.0 - u;
    ...
    complex<double>
    HardScattering::j5(const double & s, const double & u, const double & m_q, const double & m_B, const double & mu, const double & a_1, const double & a_2)
    {
        const double ubar  = 1.0 - u;
        const double s_hat = s / power_of<2>(m_B);
    ...
    complex<double>
    HardScattering::j6(const double & s, const double & u, const double & m_q, const double & m_B, const double & mu, const double & a_1, const double & a_2)
    {
        ...
        const double weight = power_of<2>(u) * (3.0 + a_1 * (-9.0 + 12.0 * u) + a_2 * (18.0 - 60.0 * u + 45.0 * power_of<2>(u)));
        const double ubar   = 1.0 - u;
    ...
    double
    HardScattering::j7(const double & s, const double & u, const double & m_B, const double & a_1, const double & a_2)
    {
        const double ubar = 1.0 - u;
