...
namespace eos
{
    ...
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<9>(ObservableCache cache, const std::array<ObservablePtr, 9> & observables,
                                             const std::array<double, 9> & mean, const std::array<std::array<double, 9>, 9> & covariance,
                                             const unsigned & number_of_observations = 9u);
    ...
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<18>(ObservableCache cache, const std::array<ObservablePtr, 18> & observables,
                                             const std::array<double, 18> & mean, const std::array<std::array<double, 18>, 18> & covariance,
                                             const unsigned & number_of_observations = 18u);
    ...
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<24>(ObservableCache cache, const std::array<ObservablePtr, 24> & observables,
                                             const std::array<double, 24> & mean, const std::array<std::array<double, 24>, 24> & covariance,
                                             const unsigned & number_of_observations = 24u);
    ...
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<8>(ObservableCache cache, const std::array<ObservablePtr, 8> & observables,
                                             ...
                                             const unsigned & number_of_observations = 8u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<9>(ObservableCache cache, const std::array<ObservablePtr, 9> & observables,
                                             const std::array<double, 9> & mean, const std::array<double, 9> & variances,
                                             const std::array<std::array<double, 9>, 9> & correlation,
                                             const unsigned & number_of_observations = 9u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<11>(ObservableCache cache, const std::array<ObservablePtr, 11> & observables,
    ...
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<16>(ObservableCache cache, const std::array<ObservablePtr, 16> & observables,
                                             ...
                                             const unsigned & number_of_observations = 16u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<18>(ObservableCache cache, const std::array<ObservablePtr, 18> & observables,
                                             const std::array<double, 18> & mean, const std::array<double, 18> & variances,
                                             const std::array<std::array<double, 18>, 18> & correlation,
                                             const unsigned & number_of_observations = 18u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<19>(ObservableCache cache, const std::array<ObservablePtr, 19> & observables,
    ...
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<22>(ObservableCache cache, const std::array<ObservablePtr, 22> & observables,
                                             ...
                                             const unsigned & number_of_observations = 22u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<24>(ObservableCache cache, const std::array<ObservablePtr, 24> & observables,
                                             const std::array<double, 24> & mean, const std::array<double, 24> & variances,
                                             const std::array<std::array<double, 24>, 24> & correlation,
                                             const unsigned & number_of_observations = 24u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<36>(ObservableCache cache, const std::array<ObservablePtr, 36> & observables,
