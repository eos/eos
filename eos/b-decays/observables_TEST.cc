...
class BDecaysObservablesTest : public TestCase
{
    public:
        BDecaysObservablesTest() :
            TestCase("b_decays_observables_test")
        {
        }
        ...
        run() const
        {
            /* Test that every observable in this section can be constructed */
            {
                ...
                for (const auto & group : make_b_decays_section())
                {
