...
namespace eos
{
     ...
     */
    template <> struct Implementation<BToThreeLeptonsNeutrino>
    {
             ...
             */
            double
            double_differential_decay_width(const double & q2, const double & k2) const
            {
                ...
                const double prefactor =
                        (power_of<2>(g_fermi * abs(model->ckm_ub()) * alpha_qed * 4 * M_PI) / (2.0 * power_of<2>(q2)) * (1.0 - m_l_sq / k2) * sqrt(1.0 - (4.0 * m_lprime_sq) / q2)
                         * sqrt(power_of<2>(k2) - 2.0 * k2 * m_B_sq + m_B_4 - 2.0 * k2 * q2 - 2.0 * m_B_sq * q2 + power_of<2>(q2)) / (32768.0 * m_B_3 * power_of<6>(M_PI)));

                const double f11 = (64 * (2 * power_of<2>(k2) - k2 * m_l_sq - m_l_4) * M_PI * (power_of<2>(k2) - 2 * k2 * (m_B_sq - 2 * q2) + power_of<2>(m_B_sq - q2))
                                    * (2 * m_lprime_sq + q2))
                                   / (9. * k2 * m_B_sq);
                const double f22 = (32 * (2 * power_of<2>(k2) - k2 * m_l_sq - m_l_4) * M_PI * (power_of<2>(k2) - 2 * k2 * (m_B_sq - 5 * q2) + power_of<2>(m_B_sq - q2)) * q2
                                    * (2 * m_lprime_sq + q2))
                                   / (9. * power_of<2>(k2) * m_B_sq);
                const double f33 = (32 * m_l_sq * (k2 - m_l_sq) * M_PI * q2 * (2 * m_lprime_sq + q2) * (power_of<2>(k2) + power_of<2>(m_B_sq - q2) - 2 * k2 * (m_B_sq + q2)))
                                   / (3. * power_of<2>(k2) * m_B_sq);
                const double f44 = (64 * (k2 - m_l_sq) * (2 * k2 + m_l_sq) * M_PI * (2 * m_lprime_sq + q2) * (power_of<2>(k2) + power_of<2>(m_B_sq - q2) - 2 * k2 * (m_B_sq + q2)))
                                   / (9. * k2 * m_B_sq);
                const double f12 = (128 * (2 * power_of<2>(k2) - k2 * m_l_sq - m_l_4) * M_PI * q2 * (k2 - m_B_sq + q2) * (2 * m_lprime_sq + q2)) / (3. * k2 * m_B_sq);
                const double f15 = -(256 * m_l_sq * M_PI * (2 * m_lprime_sq + q2)
                                     * (-((k2 - m_l_sq) * (2 * k2 - m_B_sq + m_l_sq + q2) * sqrt(power_of<2>(k2) + power_of<2>(m_B_sq - q2) - 2 * k2 * (m_B_sq + q2)))
                                        + 2 * k2 * (k2 - m_B_sq) * (k2 - m_B_sq + 2 * m_l_sq + q2)
                                                  * std::atanh(((k2 - m_l_sq) * sqrt(power_of<2>(k2) + power_of<2>(m_B_sq - q2) - 2 * k2 * (m_B_sq + q2)))
                                                               / (power_of<2>(k2) + m_l_sq * (-m_B_sq + q2) - k2 * (m_B_sq - m_l_sq + q2)))))
                                   / (3. * m_B * (k2 - m_l_sq) * sqrt(power_of<2>(k2) + power_of<2>(m_B_sq - q2) - 2 * k2 * (m_B_sq + q2)));
                const double f25 = -(-256 * m_l_sq * M_PI * q2 * (2 * m_lprime_sq + q2)
                                     * (3 * (k2 - m_l_sq) * sqrt(power_of<2>(k2) + power_of<2>(m_B_sq - q2) - 2 * k2 * (m_B_sq + q2))
                                        + (-4 * power_of<2>(k2) + 6 * k2 * m_B_sq - 4 * k2 * m_l_sq + 2 * m_l_4)
                                                  * std::atanh(((k2 - m_l_sq) * sqrt(power_of<2>(k2) + power_of<2>(m_B_sq - q2) - 2 * k2 * (m_B_sq + q2)))
                                                               / (power_of<2>(k2) + m_l_sq * (-m_B_sq + q2) - k2 * (m_B_sq - m_l_sq + q2)))))
                                   / (3. * m_B * (k2 - m_l_sq) * sqrt(power_of<2>(k2) + power_of<2>(m_B_sq - q2) - 2 * k2 * (m_B_sq + q2)));
                const double f35 = -(-128 * m_l_sq * M_PI * q2 * (2 * m_lprime_sq + q2)
                                     * (-((k2 - m_l_sq) * (power_of<2>(k2) + k2 * (3 * m_B_sq - 3 * m_l_sq - q2) + m_l_sq * (-m_B_sq + q2))
                                          * sqrt(power_of<2>(k2) + power_of<2>(m_B_sq - q2) - 2 * k2 * (m_B_sq + q2)))
                                        + 4 * k2 * (k2 - m_B_sq) * (k2 * m_B_sq - m_l_4)
                                                  * std::atanh(((k2 - m_l_sq) * sqrt(power_of<2>(k2) + power_of<2>(m_B_sq - q2) - 2 * k2 * (m_B_sq + q2)))
                                                               / (power_of<2>(k2) + m_l_sq * (-m_B_sq + q2) - k2 * (m_B_sq - m_l_sq + q2)))))
                                   / (3. * k2 * m_B * (k2 - m_B_sq) * (k2 - m_l_sq) * sqrt(power_of<2>(k2) + power_of<2>(m_B_sq - q2) - 2 * k2 * (m_B_sq + q2)));
                const double f45 = -(-256 * m_l_sq * M_PI * (2 * m_lprime_sq + q2)
                                     * (-((k2 - m_l_sq) * (k2 - m_B_sq + q2) * sqrt(power_of<2>(k2) + power_of<2>(m_B_sq - q2) - 2 * k2 * (m_B_sq + q2)))
                                        + 2 * k2 * (power_of<2>(k2) + m_B_4 - m_B_sq * q2 + 2 * m_l_sq * q2 - k2 * (2 * m_B_sq + q2))
                                                  * std::atanh(((k2 - m_l_sq) * sqrt(power_of<2>(k2) + power_of<2>(m_B_sq - q2) - 2 * k2 * (m_B_sq + q2)))
                                                               / (power_of<2>(k2) + m_l_sq * (-m_B_sq + q2) - k2 * (m_B_sq - m_l_sq + q2)))))
                                   / (3. * m_B * (k2 - m_l_sq) * sqrt(power_of<2>(k2) + power_of<2>(m_B_sq - q2) - 2 * k2 * (m_B_sq + q2)));
                // clang-format off
                ...
                * (power_of<2>(k2) * m_l_sq - k2 * m_l_sq * q2 + k2 * m_B_sq * (- 2 * m_l_sq + q2)
                ...
                const double amp = f11 * norm(F_1) + f22 * norm(F_2) + f33 * norm(F_3) + f44 * norm(F_4) + f12 * real(F_1 * conj(F_2)) + f15 * f_B * real(F_1)
                                   + f25 * f_B * real(F_2) + f35 * f_B * real(F_3) + f45 * f_B * real(F_4) + f55 * power_of<2>(f_B);

                if (power_of<2>(m_B - m_l) < q2 || q2 < 4 * m_lprime_sq || power_of<2>(m_B - sqrt(q2)) < k2 || k2 < m_l_sq)
                {
                    return 0.0;
                }
             ...
             */
            double
            quintuple_differential_decay_width(const double & q2, const double & k2, const double & z_gamma, const double & z_w, const double & phi) const
            {
                const double m_B_sq = m_B * m_B, m_B_3 = m_B_sq * m_B, m_B_4 = m_B_sq * m_B_sq;
                ...
                * q2 * (- 1 + z_gamma_sq) * (- 1 + z_w_sq) * cos(2 * phi))) / (k4 * m_B_sq);
                // clang-format on
                const double f33 = (2 * m_l_sq * (-k2 + m_l_sq) * q2 * (k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * (-4 * m_lprime_sq * z_gamma_sq + q2 * (-1 + z_gamma_sq)))
                                   / (k4 * m_B_sq);
                const double f44 = ((k2 - m_l_sq) * (k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2))
                                    * (-((4 * m_lprime_sq * (-1 + z_gamma_sq) - q2 * (1 + z_gamma_sq)) * (k2 + m_l_sq + k2 * z_w_sq - m_l_sq * z_w_sq))
                                       + (k2 - m_l_sq) * (4 * m_lprime_sq - q2) * (-1 + z_gamma_sq) * (-1 + z_w_sq) * cos(2 * phi)))
                                   / (k2 * m_B_sq);
                const double f2c1Re =
                        (4 * (k2 - m_l_sq) * sqrt(q2)
                         * ((k2 - m_l_sq) * (k4 - 2 * k2 * (m_B_sq - 3 * q2) + m_B_sq_q2_diff2) * (-4 * m_lprime_sq + q2) * z_gamma * sqrt(1 - z_gamma_sq) * z_w * sqrt(1 - z_w_sq)
                                    * cos(phi)
                            + sqrt(k2) * sqrt(q2) * (k2 - m_B_sq + q2)
                                      * (m_l_sq * (q2 * (1 + z_w_sq + z_gamma_sq * (1 - 3 * z_w_sq)) + 4 * m_lprime_sq * (1 - z_w_sq + z_gamma_sq * (-1 + 3 * z_w_sq)))
                                         + k2 * (4 * m_lprime_sq * (1 + z_w_sq + z_gamma_sq * (1 - 3 * z_w_sq)) + q2 * (3 - z_w_sq + z_gamma_sq * (-1 + 3 * z_w_sq)))
                                         - (k2 - m_l_sq) * (4 * m_lprime_sq - q2) * (-1 + z_gamma_sq) * (-1 + z_w_sq) * cos(2 * phi))))
                        / (std::pow(k2, 1.5) * m_B_sq);
                const double f3c1Re = (4 * m_l_sq * (k2 - m_l_sq) * sqrt(q2) * sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2))
                                       * (2 * sqrt(k2) * sqrt(q2) * (-4 * m_lprime_sq * z_gamma_sq + q2 * (-1 + z_gamma_sq)) * z_w
                                          - (4 * m_lprime_sq - q2) * (k2 - m_B_sq + q2) * z_gamma * sqrt(1 - z_gamma_sq) * sqrt(1 - z_w_sq) * cos(phi)))
                                      / (std::pow(k2, 1.5) * m_B_sq);
                const double f4c1Re = (4 * (k2 - m_l_sq) * sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2))
                                       * ((k2 - m_B_sq + q2) * (-4 * m_lprime_sq * (-1 + z_gamma_sq) + q2 * (1 + z_gamma_sq)) * z_w
                                          + 2 * sqrt(k2) * sqrt(q2) * (-4 * m_lprime_sq + q2) * z_gamma * sqrt(1 - z_gamma_sq) * sqrt(1 - z_w_sq) * cos(phi)))
                                      / m_B_sq;
                const double f3c2Re = (4 * m_l_sq * (k2 - m_l_sq) * q2 * sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2))
                                       * ((k2 - m_B_sq + q2) * (-4 * m_lprime_sq * z_gamma_sq + q2 * (-1 + z_gamma_sq)) * z_w
                                          + 2 * sqrt(k2) * sqrt(q2) * (-4 * m_lprime_sq + q2) * z_gamma * sqrt(1 - z_gamma_sq) * sqrt(1 - z_w_sq) * cos(phi)))
                                      / (k4 * m_B_sq);
                const double f4c2Re = (4 * (k2 - m_l_sq) * sqrt(q2) * sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2))
                                       * (2 * sqrt(k2) * sqrt(q2) * (-4 * m_lprime_sq * (-1 + z_gamma_sq) + q2 * (1 + z_gamma_sq)) * z_w
                                          - (4 * m_lprime_sq - q2) * (k2 - m_B_sq + q2) * z_gamma * sqrt(1 - z_gamma_sq) * sqrt(1 - z_w_sq) * cos(phi)))
                                      / (sqrt(k2) * m_B_sq);
                const double f2c1Im = (4.0 * (k2 - m_l_sq) * sqrt(q2) * (-4 * m_lprime_sq + q2) * (k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_gamma * sqrt(1 - z_gamma_sq)
                                       * sqrt(1 - z_w_sq) * sin(phi))
                                      / (sqrt(k2) * m_B_sq);
                const double f4c1Im =
                        (-4.0 * m_l_sq_k2_diff2 * (-4 * m_lprime_sq + q2) * sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * sqrt(1 - z_gamma_sq) * sqrt(1 - z_w_sq)
                         * (2 * sqrt(k2) * sqrt(q2) * z_gamma * z_w + (k2 - m_B_sq + q2) * sqrt(1 - z_gamma_sq) * sqrt(1 - z_w_sq) * cos(phi)) * sin(phi))
                        / (k2 * m_B_sq);
                const double f4c2Im =
                        (-4.0 * m_l_sq_k2_diff2 * sqrt(q2) * (-4 * m_lprime_sq + q2) * sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * sqrt(1 - z_gamma_sq) * sqrt(1 - z_w_sq)
                         * ((k2 - m_B_sq + q2) * z_gamma * z_w + 2 * sqrt(k2) * sqrt(q2) * sqrt(1 - z_gamma_sq) * sqrt(1 - z_w_sq) * cos(phi)) * sin(phi))
                        / (std::pow(k2, 1.5) * m_B_sq);
                const double f4c3Im = (4.0 * m_l_sq * (-k2 + m_l_sq) * sqrt(q2) * (-4 * m_lprime_sq + q2) * (k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_gamma
                                       * sqrt(1 - z_gamma_sq) * sqrt(1 - z_w_sq) * sin(phi))
                                      / (std::pow(k2, 1.5) * m_B_sq);
                // clang-format off
                ...
                * cos(phi)))/(k2 * m_B * (k2 - m_B_sq) * (k4 - m_l_sq * (m_B_sq - q2 + sqrt(k4
                ...
                + sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_w)));
                // clang-format on
                const double f54Re = (-8 * m_l_sq * (-k2 + m_l_sq)
                                      * ((4 * m_lprime_sq * (-1 + z_gamma_sq) - q2 * (1 + z_gamma_sq))
                                                 * (k4 + (m_B_sq - q2) * (m_B_sq - q2 + sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_w)
                                                    - k2 * (2 * m_B_sq + 2 * q2 + sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_w))
                                         + 2 * sqrt(k2) * sqrt(q2) * (-4 * m_lprime_sq + q2) * sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_gamma * sqrt(1 - z_gamma_sq)
                                                   * sqrt(1 - z_w_sq) * cos(phi)))
                                     / (m_B
                                        * (-k4 + k2 * (m_B_sq - m_l_sq + q2 - sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_w)
                                           + m_l_sq * (m_B_sq - q2 + sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_w)));
                const double f52Im = (-8.0 * m_l_sq * (k2 - m_l_sq) * sqrt(q2) * (-4 * m_lprime_sq + q2) * (k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_gamma
                                      * sqrt(1 - z_gamma_sq) * sqrt(1 - z_w_sq) * sin(phi))
                                     / (sqrt(k2) * m_B
                                        * (k4 - m_l_sq * (m_B_sq - q2 + sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_w)
                                           + k2 * (-m_B_sq + m_l_sq - q2 + sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_w)));
                const double f53Im = (-8.0 * m_l_sq * (-k2 + m_l_sq) * sqrt(q2) * (-4 * m_lprime_sq + q2) * (k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_gamma
                                      * sqrt(1 - z_gamma_sq) * sqrt(1 - z_w_sq) * sin(phi))
                                     / (sqrt(k2) * m_B
                                        * (k4 - m_l_sq * (m_B_sq - q2 + sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_w)
                                           + k2 * (-m_B_sq + m_l_sq - q2 + sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_w)));
                const double f54Im =
                        (8.0 * m_l_sq * m_l_sq_k2_diff2 * (-4 * m_lprime_sq + q2) * sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * sqrt(1 - z_gamma_sq) * sqrt(1 - z_w_sq)
                         * (sqrt(q2) * z_gamma * (sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) + 3 * k2 * z_w + m_B_sq * z_w - q2 * z_w)
                            + 2 * sqrt(k2) * (k2 - m_B_sq) * sqrt(1 - z_gamma_sq) * sqrt(1 - z_w_sq) * cos(phi))
                         * sin(phi))
                        / (sqrt(k2) * m_B * (k2 - m_B_sq)
                           * (k4 - m_l_sq * (m_B_sq - q2 + sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_w)
                              + k2 * (-m_B_sq + m_l_sq - q2 + sqrt(k4 + m_B_sq_q2_diff2 - 2 * k2 * (m_B_sq + q2)) * z_w)));
                // clang-format off
                ...
                * m_lprime_sq - q2) * (-1 + z_gamma_sq) * (-1 + z_w_sq) * cos(2 * phi)))
                ...
                return prefactor
                       * (f11 * norm(F_1) + f22 * norm(F_2) + f33 * norm(F_3) + f44 * norm(F_4) + f2c1Re * real(conj(F_2) * F_1) + f3c1Re * real(conj(F_3) * F_1)
                          + f4c1Re * real(conj(F_4) * F_1) + f3c2Re * real(conj(F_3) * F_2) + f4c2Re * real(conj(F_4) * F_2) + f2c1Im * imag(conj(F_2) * F_1)
                          + f4c1Im * imag(conj(F_4) * F_1) + f4c2Im * imag(conj(F_4) * F_2) + f4c3Im * imag(conj(F_4) * F_3) + f51Re * f_B * real(F_1) + f52Re * f_B * real(F_2)
                          + f53Re * f_B * real(F_3) + f54Re * f_B * real(F_4) + f52Im * f_B * imag(F_2) + f53Im * f_B * imag(F_3) + f54Im * f_B * imag(F_4)
                          + f55 * power_of<2>(f_B));
            }
             ...
             */
            double
            quintuple_differential_branching_ratio(const double & q2, const double & k2, const double & z_gamma, const double & z_w, const double & phi) const
            {
             ...
             */
            double
            double_differential_branching_ratio(const double & q2, const double & k2) const
            {
                return double_differential_decay_width(q2, k2) * tau_B / hbar;
            }

            double
            integrated_branching_ratio(const double & q2_min, const double & q2_max, const double & k2_min, const double & k2_max) const
            {
            ...
            double
            _asymmetry_numerator(const double & q2, const double & k2) const
            {
                const double m_B_sq = m_B * m_B, m_B_3 = m_B_sq * m_B, m_B_4 = m_B_sq * m_B_sq;
                ...
                const double g13 = (64 * m_l_sq * (k2 - m_l_sq) * M_PI * q2 * (2 * m_lprime_sq + q2) * sqrt(k4 - 2 * k2 * m_B_sq + m_B_4 - 2 * k2 * q2 - 2 * m_B_sq * q2 + q4))
                                   / (3. * k2 * m_B_sq);
                const double g14 =
                        (64 * (k2 - m_l_sq) * M_PI * (-k2 + m_B_sq - q2) * (2 * m_lprime_sq + q2) * sqrt(k4 - 2 * k2 * m_B_sq + m_B_4 - 2 * k2 * q2 - 2 * m_B_sq * q2 + q4))
                        / (3. * m_B_sq);
                const double g23 = (-32 * m_l_sq * (k2 - m_l_sq) * M_PI * (-k2 + m_B_sq - q2) * q2 * (2 * m_lprime_sq + q2)
                                    * sqrt(k4 - 2 * k2 * m_B_sq + m_B_4 - 2 * k2 * q2 - 2 * m_B_sq * q2 + q4))
                                   / (3. * k4 * m_B_sq);
                const double g24 =
                        (-128 * (k2 - m_l_sq) * M_PI * q2 * (2 * m_lprime_sq + q2) * sqrt(k4 - 2 * k2 * m_B_sq + m_B_4 - 2 * k2 * q2 - 2 * m_B_sq * q2 + q4)) / (3. * m_B_sq);
                const double g15 = -(64 * m_l_sq * M_PI * (2 * m_lprime_sq + q2)
                                     * (2 * m_l_sq_k2_diff2 * sqrt(k4 - 2 * k2 * m_B_sq + m_B_4 - 2 * k2 * q2 - 2 * m_B_sq * q2 + q4)
                                        - (4 * k2 * power_of<2>(-k2 + m_B_sq) * (-k2 + m_B_sq - 2 * m_l_sq - q2)
                                           * log((4 * k2 * power_of<2>(-k2 + m_B_sq) * m_l_sq + 4 * k2 * (k2 - m_l_sq) * (m_B_sq - m_l_sq) * q2)
                                                 / power_of<2>((k2 + m_l_sq) * (-k2 + m_B_sq - q2) + 2 * k2 * q2)))
                                                  / sqrt(k4 - 2 * k2 * m_B_sq + m_B_4 - 2 * k2 * q2 - 2 * m_B_sq * q2 + q4)))
                                   / (3. * m_B * (-k2 + m_B_sq) * (k2 - m_l_sq));
                const double g25 = -(64 * m_l_sq * M_PI * q2 * (2 * m_lprime_sq + q2)
                                     * (m_l_sq_k2_diff2 * sqrt(k4 - 2 * k2 * m_B_sq + m_B_4 - 2 * k2 * q2 - 2 * m_B_sq * q2 + q4)
                                        + (4 * k2 * (-k2 + m_B_sq) * (3 * k2 * (-k2 + m_B_sq) + m_l_sq_k2_diff2)
                                           * log((4 * k2 * power_of<2>(-k2 + m_B_sq) * m_l_sq + 4 * k2 * (k2 - m_l_sq) * (m_B_sq - m_l_sq) * q2)
                                                 / power_of<2>((k2 + m_l_sq) * (-k2 + m_B_sq - q2) + 2 * k2 * q2)))
                                                  / sqrt(k4 - 2 * k2 * m_B_sq + m_B_4 - 2 * k2 * q2 - 2 * m_B_sq * q2 + q4)))
                                   / (3. * k2 * m_B * (-k2 + m_B_sq) * (k2 - m_l_sq));
                const double g35 = -(256 * m_l_sq * (k2 * (-k2 + m_B_sq) + (k2 - m_l_sq) * (k2 + m_l_sq)) * M_PI * q2 * (2 * m_lprime_sq + q2)
                                     * log((4 * k2 * power_of<2>(-k2 + m_B_sq) * m_l_sq + 4 * k2 * (k2 - m_l_sq) * (m_B_sq - m_l_sq) * q2)
                                           / power_of<2>((k2 + m_l_sq) * (-k2 + m_B_sq - q2) + 2 * k2 * q2)))
                                   / (3. * m_B * (k2 - m_l_sq) * sqrt(k4 - 2 * k2 * m_B_sq + m_B_4 - 2 * k2 * q2 - 2 * m_B_sq * q2 + q4));
                const double g45 = -(256 * k2 * m_l_sq * M_PI * (2 * m_lprime_sq + q2) * ((-k2 + m_B_sq) * (-k2 + m_B_sq - q2) - 2 * (k2 - m_l_sq) * q2)
                                     * log((4 * k2 * power_of<2>(-k2 + m_B_sq) * m_l_sq + 4 * k2 * (k2 - m_l_sq) * (m_B_sq - m_l_sq) * q2)
                                           / power_of<2>((k2 + m_l_sq) * (-k2 + m_B_sq - q2) + 2 * k2 * q2)))
                                   / (3. * m_B * (k2 - m_l_sq) * sqrt(k4 - 2 * k2 * m_B_sq + m_B_4 - 2 * k2 * q2 - 2 * m_B_sq * q2 + q4));
                const double g55 =
                        (256 * k2 * m_l_sq * M_PI * (2 * m_lprime_sq + q2)
                         * ((-k2 + m_B_sq) * m_l_sq_k2_diff2 * (m_B_sq - m_l_sq) * (2 * m_l_sq + q2) * sqrt(k4 - 2 * k2 * m_B_sq + m_B_4 - 2 * k2 * q2 - 2 * m_B_sq * q2 + q4)
                            + ((4 * m_l_sq * (m_B_sq - m_l_sq) + 2 * (power_of<2>(-k2 + m_B_sq) + (-k2 + m_B_sq) * (k2 - m_l_sq) + m_l_sq_k2_diff2)
                                - (-k2 + m_B_sq) * (-k2 + m_B_sq - q2))
                               * ((k2 + m_l_sq) * (-k2 + m_B_sq - q2) + 2 * k2 * q2) * (power_of<2>(-k2 + m_B_sq) * m_l_sq + (k2 - m_l_sq) * (m_B_sq - m_l_sq) * q2)
                               * log((4 * k2 * power_of<2>(-k2 + m_B_sq) * m_l_sq + 4 * k2 * (k2 - m_l_sq) * (m_B_sq - m_l_sq) * q2)
                                     / power_of<2>((k2 + m_l_sq) * (-k2 + m_B_sq - q2) + 2 * k2 * q2)))
                                      / sqrt(k4 - 2 * k2 * m_B_sq + m_B_4 - 2 * k2 * q2 - 2 * m_B_sq * q2 + q4)))
                        / (3. * (-k2 + m_B_sq) * (k2 - m_l_sq) * ((k2 + m_l_sq) * (-k2 + m_B_sq - q2) + 2 * k2 * q2)
                           * (power_of<2>(-k2 + m_B_sq) * m_l_sq + (k2 - m_l_sq) * (m_B_sq - m_l_sq) * q2));
                ...
                return prefactor
                       * (g13 * real(conj(F_3) * F_1) + g14 * real(conj(F_4) * F_1) + g23 * real(conj(F_3) * F_2) + g24 * real(conj(F_4) * F_2) + g15 * real(F_1) * f_B
                          + g25 * real(F_2) * f_B + g35 * real(F_3) * f_B + g45 * real(F_4) * f_B + g55 * power_of<2>(f_B));
            }

            double
            double_differential_forward_backward_asymmetry(const double & q2, const double & k2) const
            {
                const double m_l_sq = m_l * m_l, m_lprime_sq = m_lprime * m_lprime;
            ...
            double
            integrated_forward_backward_asymmetry(const double & q2_min, const double & q2_max, const double & k2_min, const double & k2_max) const
            {
                std::function<double(const std::array<double, 2u> &)> integrand = [&](const std::array<double, 2u> & x) { return this->_asymmetry_numerator(x[0], x[1]); };
                ...
                return integrate<2>(integrand, x_min, x_max, config_cubature) / ((hbar / tau_B) * integrated_branching_ratio(q2_min, q2_max, k2_min, k2_max));
            }
    };

    const std::vector<OptionSpecification> Implementation<BToThreeLeptonsNeutrino>::options{
    ...
    double
    BToThreeLeptonsNeutrino::double_differential_branching_ratio(const double & q2, const double & k2) const
    {
        return _imp->double_differential_branching_ratio(q2, k2);
    }

    double
    BToThreeLeptonsNeutrino::quintuple_differential_branching_ratio(const double & q2, const double & k2, const double & z_gamma, const double & z_w, const double & phi) const
    {
        return _imp->quintuple_differential_branching_ratio(q2, k2, z_gamma, z_w, phi);
    }

    double
    BToThreeLeptonsNeutrino::integrated_branching_ratio(const double & q2_min, const double & q2_max, const double & k2_min, const double & k2_max) const
    {
        return _imp->integrated_branching_ratio(q2_min, q2_max, k2_min, k2_max);
    }

    double
    BToThreeLeptonsNeutrino::double_differential_forward_backward_asymmetry(const double & q2, const double & k2) const
    {
        return _imp->double_differential_forward_backward_asymmetry(q2, k2);
    }

    double
    BToThreeLeptonsNeutrino::integrated_forward_backward_asymmetry(const double & q2_min, const double & q2_max, const double & k2_min, const double & k2_max) const
    {
        return _imp->integrated_forward_backward_asymmetry(q2_min, q2_max, k2_min, k2_max);
    }

    const std::string BToThreeLeptonsNeutrino::description = "\
The decayB^- -> l^- nubar l_prime^+ l_prime^-, where l is either e, mu or tau and l_prime is either e or mu";

    const std::string BToThreeLeptonsNeutrino::kinematics_description_q2 = "\
The invariant mass of the l_prime pair in GeV^2.";

    const std::string BToThreeLeptonsNeutrino::kinematics_description_k2 = "\
The invariant mass of the l^- nubar pair in GeV^2.";

    const std::string BToThreeLeptonsNeutrino::kinematics_description_z_gamma = "\
The cosine of the angle between l_prime^- and the negative photon direction of flight.";

    const std::string BToThreeLeptonsNeutrino::kinematics_description_z_w = "\
The cosine of the angle between charged l^- and the negative W boson direction of flight.";

    const std::string BToThreeLeptonsNeutrino::kinematics_description_phi = "\
The angle between the q2 and the k2 plane.";

    const std::set<ReferenceName> BToThreeLeptonsNeutrino::references{ "KKvDZ:2022A"_rn };
