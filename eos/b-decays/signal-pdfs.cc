...
namespace eos
{
        ...
        auto imp = new Implementation<SignalPDFGroup>(
                ...
                R"()",
                {
                    ...
                    and the angle $\theta_\ell$ between the charged lepton and the photon in the $B$ rest frame.)",
                                    ...
                                    std::make_tuple("E_gamma"s, "cos(theta_l)"s),
                                    "B_u->gammalnu::NormalizationPDF(E_gamma,cos(theta_l))",
                                    std::make_tuple("E_gamma_min"s)),
                    ...
                    of the $W$ helicity angle $z_W$, and the azimuthal angle $\phi$.)",
                                    ...
                                    std::make_tuple("q2"s, "k2"s, "z_gamma"s, "z_w"s, "phi"s),
                                    "B_u->enumumu::NormalizationPDF(q2,k2,z_gamma,z_w,phi)",
                                    std::make_tuple("q2_min"s, "q2_max"s, "k2_min"s, "k2_max"s)),
        ...
        auto imp = new Implementation<SignalPDFGroup>(
                ...
                R"()",
                {
                    ...
                    make_signal_pdf("B->pilnu::P(q2)",
                                    ...
                                    std::make_tuple("q2_min"s, "q2_max"s)),
                    ...
                    and the cosine of the angle $\theta_\ell$ between the charged lepton and the negative $\bar{B}$ flight direction in the $\ell^-\bar\nu$ rest frame.)",
                                    ...
                                    std::make_tuple("q2"s, "cos(theta_l)"s),
        ...
        auto imp = new Implementation<SignalPDFGroup>(
                ...
                R"()",
                {
                    ...
                    and the azimuthal angle $\phi$ between the two decay planes.)",
                                    ...
                                    std::make_tuple("q2"s, "cos(theta_l)"s, "cos(theta_D)"s, "phi"s),
                    ...
                    and the azimuthal angle $\phi$ between the two decay planes.)",
                                    ...
                                    std::make_tuple("q2"s, "cos(theta_l)"s, "cos(theta_K)"s, "phi"s),
                    ...
                    and the azimuthal angle $\phi$ between the two decay planes.)",
                                    ...
                                    std::make_tuple("q2"s, "cos(theta_l)"s, "cos(theta_D_s)"s, "phi"s),
        ...
        auto imp = new Implementation<SignalPDFGroup>(
                ...
                R"()",
                {
                    ...
                    negative $B^+$ flight direction in the $\pi^+\pi^-$ rest frame.)",
                                    ...
                                    std::make_tuple("q2"s, "k2"s, "cos(theta_pi)"s),
                                    "B^+->pi^+pi^-lnu::NormalizationPDF(q2,k2,cos(theta_pi))",
                                    std::make_tuple("q2_min"s, "q2_max"s, "k2_min"s, "k2_max"s, "cos(theta)_min"s, "cos(theta)_max"s)),
        });
        ...
        auto imp = new Implementation<SignalPDFGroup>(
                ...
                R"()",
                {
                    ...
                    and the azimuthal angle $\phi$ between the two decay planes.)",
                                    ...
                                    std::make_tuple("q2"s, "cos(theta_l)"s, "cos(theta_L)"s, "phi"s),
    ...
    {
        auto imp = new Implementation<SignalPDFSection>("Signal PDFs in (semi)leptonic $b$-hadron decays",
                                                        "",
                                                        {
                                                            // Leptonic and photoleptonic B decays
                                                            make_b_to_leptons_pdf_group(),
