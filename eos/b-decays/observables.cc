    ...
    make_nonleptonic_b_to_p_p_group()
    {
        auto imp = new Implementation<ObservableGroup>(
            ...
            R"()",
            {
                ...
                make_expression_observable("B^0->K^0Kbar^0::BR_avg", R"(\bar{\mathcal{B}}(B^0\to K^0K^0))",
                        Unit::None(),
                        R"(
                        0.5 * ( <<B^0->K^0Kbar^0::BR>> + <<Bbar^0->Kbar^0K^0::BR>> )
                        )"),

                make_expression_observable("B^0->K^0Kbar^0::A_CP", R"(A_\mathrm{CP}(B^0\to K^0K^0))",
                        Unit::None(),
                        R"(
                ...
                make_expression_observable("B^+->K^0pi^+::BR_avg", R"(\bar{\mathcal{B}}(B^+\to K^+\pi^0))",
                        Unit::None(),
                        R"(
                        0.5 * ( <<B^+->K^0pi^+::BR>> + <<B^-->Kbar^0pi^-::BR>> )
                        )"),

                make_expression_observable("B^+->K^0pi^+::A_CP", R"(A_\mathrm{CP}(B^+\to K^+\pi^0))",
                        Unit::None(),
                        R"(
                ...
                make_expression_observable("B^0->K^+pi^-::BR_avg", R"(\bar{\mathcal{B}}(B^+\to K^+\pi^0))",
                        Unit::None(),
                        R"(
                        0.5 * ( <<B^0->K^+pi^-::BR>> + <<Bbar^0->K^-pi^+::BR>> )
                        )"),

                make_expression_observable("B^0->K^+pi^-::A_CP", R"(A_\mathrm{CP}(B^+\to K^+\pi^0))",
                        Unit::None(),
                        R"(
                ...
                make_expression_observable("B->PP::ratio_pi^+pi^0/K^0pi^+", R"(\frac{B^+\to\pi^+\pi^0}{B^+\to K^0\pi^+})",
                        Unit::None(),
                        R"(
                        <<B^+->pi^+pi^0::BR_avg>> / <<B^+->K^0pi^+::BR_avg>>
                        )"),

                make_expression_observable("B->PP::ratio_K^+Kbar^0/K^0pi^+", R"(\frac{B^+\to K^+\bar{K}^0}{B^+\to K^0\pi^+})",
                        Unit::None(),
                        R"(
                        <<B^+->K^+Kbar^0::BR_avg>> / <<B^+->K^0pi^+::BR_avg>>
                        )"),

                make_expression_observable("B->PP::ratio_pi^+pi^-/K^+pi^-", R"(\frac{B^0\to\pi^+\pi^-}{B^0\to K^+\pi^-})",
                        Unit::None(),
                        R"(
                        <<B^0->pi^+pi^-::BR_avg>> / <<B^0->K^+pi^-::BR_avg>>
                        )"),

                make_expression_observable("B->PP::ratio_K^+pi^0/K^0pi^+", R"(\frac{B^+\to K^+\pi^0}{B^+\to K^0\pi^+})",
                        Unit::None(),
                        R"(
                        <<B^+->K^+pi^0::BR_avg>> / <<B^+->K^0pi^+::BR_avg>>
                        )"),

                make_expression_observable("B->PP::ratio_K^+pi^-/K^0pi^0", R"(\frac{B^0\to K^+\pi^-}{B^0\to K^0\pi^0})",
                        Unit::None(),
                        R"(
                        <<B^0->K^+pi^-::BR_avg>> / <<B^0->K^0pi^0::BR_avg>>
                        )")
            }
        );
