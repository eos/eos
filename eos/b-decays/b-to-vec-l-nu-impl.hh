...
namespace eos
{
        ...
        class AngularObservables
        {
            ...
            public:
                ...
                AngularObservables(const Amplitudes & a)
                {
                    ...
                    _vv[0] = NF * 2.0
                             * ((1.0 + mlH2) * (std::norm(a.a_0) + 16.0 * std::norm(a.a_0_T)) + 2.0 * mlH2 * std::norm(a.a_t) + 2.0 * std::norm(a.a_P)
                                + 4.0 * mlH * std::real(a.a_t * std::conj(a.a_P)) - 16.0 * mlH * std::real(a.a_0_T * std::conj(a.a_0)));

                    _vv[1] = NF * 2.0 * (1.0 - mlH2) * (-std::norm(a.a_0) + 16.0 * std::norm(a.a_0_T));

                    _vv[2] = -NF * 8.0 * std::real(mlH * (mlH * a.a_t + a.a_P) * std::conj(a.a_0) - 4.0 * (mlH * a.a_t + a.a_P) * std::conj(a.a_0_T));

                    _vv[3] = NF
                             * ((3.0 + mlH2) * (std::norm(a.a_para) + std::norm(a.a_perp)) / 2.0 + 8.0 * (1.0 + 3.0 * mlH2) * (std::norm(a.a_para_T) + std::norm(a.a_perp_T))
                                - 16.0 * mlH * std::real(a.a_para_T * std::conj(a.a_para) + a.a_perp_T * std::conj(a.a_perp)));

                    _vv[4] = NF * (1.0 - mlH2) * ((std::norm(a.a_para) + std::norm(a.a_perp)) / 2.0 - 8.0 * (std::norm(a.a_para_T) + std::norm(a.a_perp_T)));

                    _vv[5] = NF * 4.0
                             * std::real(-a.a_para * std::conj(a.a_perp) - 16.0 * mlH2 * a.a_para_T * std::conj(a.a_perp_T)
                                         + 4.0 * mlH * (a.a_perp_T * std::conj(a.a_para) + a.a_para_T * std::conj(a.a_perp)));

                    _vv[6] = NF * (1.0 - mlH2) * (-(std::norm(a.a_para) - std::norm(a.a_perp)) + 16.0 * (std::norm(a.a_para_T) - std::norm(a.a_perp_T)));

                    _vv[7] = NF * 2.0 * (1.0 - mlH2) * std::imag(a.a_para * std::conj(a.a_perp));

                    _vv[8] = NF * std::sqrt(2.0) * (1.0 - mlH2) * std::real(a.a_para * std::conj(a.a_0) - 16.0 * a.a_para_T * std::conj(a.a_0_T));

                    _vv[9] = NF * 2.0 * std::sqrt(2.0)
                             * std::real(-a.a_perp * std::conj(a.a_0) + a.a_para * mlH * std::conj(mlH * a.a_t + a.a_P) - 16.0 * mlH2 * a.a_perp_T * std::conj(a.a_0_T)
                                         + 4.0 * mlH * (a.a_0_T * std::conj(a.a_perp) + a.a_perp_T * std::conj(a.a_0)) - 4.0 * a.a_para_T * std::conj(mlH * a.a_t + a.a_P));

                    _vv[10] = NF * 2.0 * std::sqrt(2.0)
                              * std::imag(-a.a_para * std::conj(a.a_0) + mlH * a.a_perp * std::conj(mlH * a.a_t + a.a_P)
                                          + 4.0 * mlH * (a.a_0_T * std::conj(a.a_para) - a.a_para_T * std::conj(a.a_0)) + 4.0 * a.a_perp_T * std::conj(mlH * a.a_t + a.a_P));

                    _vv[11] = NF * std::sqrt(2.0) * (1.0 - mlH2) * std::imag(a.a_perp * std::conj(a.a_0));
                }

                AngularObservables() { _vv.fill(0.0); }
                ...
                inline double
                normalized_amplitude_polarization_L() const
                {
                ...
                inline double
                normalized_amplitude_polarization_T() const
                {
    ...
    class BToVectorLeptonNeutrino::IntermediateResult : public CacheableObservable::IntermediateResult
    {
        public:
