...
namespace eos
{
        ...
        public ScatteringAmplitudes<PPToPP>
    {
        ...
        public:
            ...
            complex<double> scattering_amplitude(const double & s, const unsigned & l, const std::string & i) const;
            complex<double> omnes_factor(const double & s, const unsigned & l, const std::string & i) const;
