...
namespace eos
{
        ...
        public virtual ParameterUser
    {
        public:
            ...
            virtual complex<double> scattering_amplitude(const double & s, const unsigned & l, const std::string & i) const = 0;
            virtual complex<double> omnes_factor(const double & s, const unsigned & l, const std::string & i) const = 0;
