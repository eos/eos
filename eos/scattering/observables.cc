    ...
    make_ee_to_ccbar_group()
    {
        auto imp = new Implementation<ObservableGroup>(
            ...
            R"(The "assume_isospin" option equalises the couplings of isospin-related channels.)",
            {
                ...
                make_cacheable_observable("e^+e^-->D^0Dbar^*0::sigma_S(E)", R"(\sigma_{S}(e^+e^- \to D^0 \bar{D}^{*0}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
                        &EEToCCBar::sigma_eetoD0Dbarstar0_S,
                        std::make_tuple("E")),

                make_cacheable_observable("e^+e^-->D^0Dbar^*0::sigma_D(E)", R"(\sigma_{D}(e^+e^- \to D^0 \bar{D}^{*0}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
                ...
                make_cacheable_observable("e^+e^-->D^+D^*-::sigma_S(E)", R"(\sigma_{S}(e^+e^- \to D^+ D^{*-}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
                        &EEToCCBar::sigma_eetoDpDstarm_S,
                        std::make_tuple("E")),

                make_cacheable_observable("e^+e^-->D^+D^*-::sigma_D(E)", R"(\sigma_{D}(e^+e^- \to D^+ D^{*-}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
