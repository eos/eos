    ...
    make_ee_to_ccbar_group()
    {
        auto imp = new Implementation<ObservableGroup>(
            ...
            R"(The "assume_isospin" option equalises the couplings of isospin-related channels.)",
            {
                ...
                make_cacheable_observable("e^+e^-->D^*0Dbar^*0::sigma_1P1(E)", R"(\sigma_{{}^1P_1}(e^+e^- \to D^{*0} \bar{D}^{*0}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
                        &EEToCCBar::sigma_eetoDstar0Dstarbar0_1P1,
                        std::make_tuple("E")),

                make_cacheable_observable("e^+e^-->D^*0Dbar^*0::sigma_5P1(E)", R"(\sigma_{{}^5P_1}(e^+e^- \to D^{*0} \bar{D}^{*0}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
                        &EEToCCBar::sigma_eetoDstar0Dstarbar0_5P1,
                        std::make_tuple("E")),

                make_cacheable_observable("e^+e^-->D^*0Dbar^*0::sigma_5F1(E)", R"(\sigma_{{}^5F_1}(e^+e^- \to D^{*0} \bar{D}^{*0}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
                ...
                make_cacheable_observable("e^+e^-->D^*+D^*-::sigma_1P1(E)", R"(\sigma_{{}^1P_1}(e^+e^- \to D^{*+} D^{*-}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
                        &EEToCCBar::sigma_eetoDstarpDstarm_1P1,
                        std::make_tuple("E")),

                make_cacheable_observable("e^+e^-->D^*+D^*-::sigma_5P1(E)", R"(\sigma_{{}^5P_1}(e^+e^- \to D^{*+} D^{*-}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
                        &EEToCCBar::sigma_eetoDstarpDstarm_5P1,
                        std::make_tuple("E")),

                make_cacheable_observable("e^+e^-->D^*+D^*-::sigma_5F1(E)", R"(\sigma_{{}^5F_1}(e^+e^- \to D^{*+} D^{*-}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
                ...
                make_cacheable_observable("e^+e^-->D^0Dbar^*0::sigma(E)", R"(\sigma(e^+e^- \to D^0 \bar{D}^{*0} + \mathrm{h.c.}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
                        &EEToCCBar::sigma_eetoD0Dbarstar0,
                        std::make_tuple("E")),

                make_cacheable_observable("e^+e^-->D^0Dbar^*0::sigma_S(E)", R"(\sigma_{S}(e^+e^- \to D^0 \bar{D}^{*0} + \mathrm{h.c.}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
                        &EEToCCBar::sigma_eetoD0Dbarstar0_S,
                        std::make_tuple("E")),

                make_cacheable_observable("e^+e^-->D^0Dbar^*0::sigma_D(E)", R"(\sigma_{D}(e^+e^- \to D^0 \bar{D}^{*0} + \mathrm{h.c.}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
                        &EEToCCBar::sigma_eetoD0Dbarstar0_D,
                        std::make_tuple("E")),

                make_cacheable_observable("e^+e^-->D^+D^*-::sigma(E)", R"(\sigma(e^+e^- \to D^+ D^{*-} + \mathrm{h.c.}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
                        &EEToCCBar::sigma_eetoDpDstarm,
                        std::make_tuple("E")),

                make_cacheable_observable("e^+e^-->D^+D^*-::sigma_S(E)", R"(\sigma_{S}(e^+e^- \to D^+ D^{*-} + \mathrm{h.c.}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
                        &EEToCCBar::sigma_eetoDpDstarm_S,
                        std::make_tuple("E")),

                make_cacheable_observable("e^+e^-->D^+D^*-::sigma_D(E)", R"(\sigma_{D}(e^+e^- \to D^+ D^{*-} + \mathrm{h.c.}))",
                        Unit::InverseGeV2(),
                        &EEToCCBar::prepare,
                        &EEToCCBar::sigma_eetoDpDstarm_D,
                        std::make_tuple("E")),
