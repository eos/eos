...
namespace eos
{
    namespace dft
    {
        template <typename T_, std::size_t rank_> class Container;

        template <std::size_t rank_> class Container<double, rank_>
        {
            private:
                std::size_t                    _size;
                double *                       _data;
        ...
        template <std::size_t rank_> class Container<std::complex<double>, rank_>
        {
            private:
                std::size_t                    _size;
        ...
        operator* (Container<std::complex<double>, rank_> lhs, const Container<std::complex<double>, rank_> & rhs)
        {
            lhs *= rhs;
            return lhs;
        }
