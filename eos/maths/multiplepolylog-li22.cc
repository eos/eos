...
#define LINLOGA1MAX 8
        ...
        complex<double>
        li2logA0rec(complex<double> next, int nc, const complex<double> & lsq)
        {
            if (nc < LI2LOGA0MAX)
            {
        ...
        complex<double>
        li2logA0(const complex<double> & x)
        {
        ...
        complex<double>
        li22rec(complex<double> next, complex<double> extra, int nc, const complex<double> & a, const complex<double> & ab, int & ncmax)
        {
            if (nc < ncmax)
            {
        ...
        complex<double>
        li22fast(const complex<double> & a, const complex<double> & b, int & ncmax)
        {
        ...
        complex<double>
        li22stufflerec(complex<double> next, complex<double> extra, int nc, const complex<double> & b, const complex<double> & ab, int & ncmax)
        {
            if (nc < ncmax)
            {
                return next + li22stufflerec(ccli22stuffle1[nc] * b * next + ccli22stuffle2[nc] * extra, extra * ab, nc + 1, b, ab, ncmax);
            }
            return next + ccli22stuffle1[nc] * b * next + ccli22stuffle2[nc] * extra;
        }

        complex<double>
        li22stuffle(const complex<double> & a, const complex<double> & b, int & ncmax)
        {
            const complex<double> ab = a * b;
        ...
        complex<double>
        li224q(const complex<double> & a, const complex<double> & b, complex<double> q, int & ncmax)
        {
            const complex<double> ab = a * b;
        ...
        void
        threelicrrec(complex<double> next, int nc, const complex<double> & xsq, complex<double> * li2var, complex<double> * li3var, complex<double> * li4var)
        {
        ...
        complex<double>
        threelicr(const complex<double> & a, complex<double> c2, complex<double> c3)
        {
...
#define LIALLBERNMAX 9
        ...
        void
        threelibeoddrec(complex<double> next, int nc, const complex<double> & xsq, complex<double> * li2var, complex<double> * li3var, complex<double> * tli4var)
        {
        ...
        void
        threelibeevenrec(complex<double> next, int nc, const complex<double> & xsq, complex<double> * li3var, complex<double> * tli4var)
        {
        ...
        complex<double>
        threelibe(const complex<double> & a, complex<double> c2, complex<double> c3)
        {
        ...
        void
        sixlimmmbeoddrec(complex<double> nextx, complex<double> nexty, int nc, const complex<double> & xsq, const complex<double> & ysq, complex<double> * li2dif,
                         complex<double> * li3dif, complex<double> * tli4dif)
        {
        ...
        void
        sixlimmmbeevenrec(complex<double> nextx, complex<double> nexty, int nc, const complex<double> & xsq, const complex<double> & ysq, complex<double> * li3dif,
                          complex<double> * tli4dif)
        {
            const complex<double> dif  = nextx - nexty;
        ...
        complex<double>
        sixlimmmbe(const complex<double> & a, const complex<double> & b, complex<double> c2, complex<double> c3)
        {
            const complex<double> x       = -std::log(1. - a);
            const complex<double> xsq     = x * x;
        ...
        void
        sixlipmpbeoddrec(complex<double> nextx, complex<double> nexty, int nc, const complex<double> & xsq, const complex<double> & ysq, complex<double> * li2sum,
                         complex<double> * li3dif, complex<double> * tli4sum)
        {
        ...
        void
        sixlipmpbeevenrec(complex<double> nextx, complex<double> nexty, int nc, const complex<double> & xsq, const complex<double> & ysq, complex<double> * li3dif,
                          complex<double> * tli4sum)
        {
        ...
        complex<double>
        sixlipmpbe(const complex<double> & a, const complex<double> & b, complex<double> c2, complex<double> c3)
        {
            const complex<double> x       = -std::log(1. - a);
            const complex<double> xsq     = x * x;
            const complex<double> y       = -std::log(1. - b);
        ...
        complex<double>
        sixlimmm(const complex<double> & a, const complex<double> & b, complex<double> c2, complex<double> c3)
        {
            if (a.real() < 0.5)
            {
                if (b.real() < 0.5)
        ...
        complex<double>
        sixlipmp(const complex<double> & a, const complex<double> & b, complex<double> c2, complex<double> c3)
        {
        ...
        complex<double>
        li22inv(const complex<double> & x, const complex<double> & y, int & ncmax)
        {
            ...
            return li224q(ix, iy, ccli22invc10 + ccli22invc9 * logmxsq, ncmax) + sixlimmm(ix, iy, ccli22invc9 * (logmxysq - logmxsq), ccli22invc8 * logmxy) + ccli22invc1
                   + logmxy * (ccli22invc4 * logmx + ccli22invc6 * logmxy)
        ...
        complex<double>
        li22qfast(const complex<double> & a, const complex<double> & b, complex<double> q, int & ncmax)
        {
        ...
        complex<double>
        li22invstuffle(const complex<double> & x, const complex<double> & y, int & ncmax)
        {
            ...
            //   return -li22qfast(iy,ix,li2(x),ncmax) + sixlimmm(ix,iy,pi*pi/6.+0.5*logmxysq,2.*logmxy) +
            //   (15.*(logmxysq*logmxysq-6.*logmxysq*logmysq+(6.*logmxsq+8.*logmxy*logmy-3.*logmysq)*logmysq)+30.*(logmxsq+4.*logmxy*logmy-3.*logmysq)*pi*pi-14.*pi*pi*pi*pi)/360.;

            return -li22qfast(iy, ix, -dilog(ix), ncmax) + dilog(iy) * (ccli22invstuffle1 * logmxsq + ccli22invstuffle2)
                   + sixlimmm(ix, iy, ccli22invstuffle3 + ccli22invstuffle4 * logmxysq, ccli22invstuffle5 * logmxy) + ccli22invstuffle6 * logmxysq * logmxysq
                   + ccli22invstuffle7 * logmxysq * logmysq + (ccli22invstuffle8 * logmxsq + ccli22invstuffle9 * logmxy * logmy + ccli22invstuffle10 * logmysq) * logmysq
                   + ccli22invstuffle11 * logmxsq + ccli22invstuffle12 * logmxy * logmy + ccli22invstuffle13 * logmysq + ccli22invstuffle14;
        }
        ...
        complex<double>
        li22invspecial(const complex<double> & x, const complex<double> & y, int & ncmax)
        {
            const complex<double> logmxy   = std::log(-x * y);
            const complex<double> logmx    = std::log(-x);
            const complex<double> logmxysq = logmxy * logmxy;
            ...
            //  return li224q(ix,iy,pi*pi/6.+0.5*logmxsq,ncmax) - sixlipmp(ix, y, 0.5*(logmxsq-logmxysq), -2.*logmxy) + (pi*pi/(12.) + 1/(24.)*logmxysq)*logmxysq
            //  + 7.*pi*pi*pi*pi/(360.);

            return li224q(ix, iy, ccli22invsp1 + ccli22invsp2 * logmxsq, ncmax) - sixlipmp(ix, y, ccli22invsp3 * (logmxsq - logmxysq), ccli22invsp4 * logmxy)
        ...
        complex<double>
        li22invstufflespecial(const complex<double> & x, const complex<double> & y, int & ncmax)
        {
            // To be used when x<1 and y>1
            ...
            //   return -li22qfast(iy,ix,li2(x),ncmax) +
            //   sixlipmp(x,iy,-pi*pi/6.-0.5*logmxysq,2.*logmxy)+(-3.*logmxsq*logmxsq+8.*logmx*logmxsq*logmxy-6.*logmxsq*logmxysq+logmxysq*logmxysq+6.*logmxsq*logmysq-6.*logmxysq*logmysq+8.*logmxy*logmy*logmysq-3.*logmysq*logmysq-2.*(3.*logmxsq+logmxysq-4.*logmxy*(logmx+logmy)+3.*logmysq)*pi*pi-3.*pi*pi*pi*pi)/24.;

            //   return -li22qfast(iy,ix,-li2(ix),ncmax) + li2(iy)*(0.5*logmxsq+pi*pi/6.) +
            //   sixlipmp(x,iy,-pi*pi/6.-0.5*logmxysq,2.*logmxy)+(-3.*logmxsq*logmxsq+8.*logmx*logmxsq*logmxy-6.*logmxsq*logmxysq+logmxysq*logmxysq+6.*logmxsq*logmysq-6.*logmxysq*logmysq+8.*logmxy*logmy*logmysq-3.*logmysq*logmysq-2.*(3.*logmxsq+logmxysq-4.*logmxy*(logmx+logmy)+3.*logmysq)*pi*pi-3.*pi*pi*pi*pi)/24.;

            return -li22qfast(iy, ix, -dilog(ix), ncmax) + dilog(iy) * (ccli22invstufflesp1 * logmxsq + ccli22invstufflesp2)
                   + sixlipmp(x, iy, ccli22invstufflesp3 + ccli22invstufflesp4 * logmxysq, ccli22invstufflesp5 * logmxy) + ccli22invstufflesp6 * logmxsq * logmxsq
                   + ccli22invstufflesp7 * logmx * logmxsq * logmxy + ccli22invstufflesp8 * logmxsq * logmxysq + ccli22invstufflesp9 * logmxysq * logmxysq
                   + ccli22invstufflesp10 * logmxsq * logmysq + ccli22invstufflesp11 * logmxysq * logmysq + ccli22invstufflesp12 * logmxy * logmy * logmysq
                   + ccli22invstufflesp13 * logmysq * logmysq + ccli22invstufflesp14 * logmxsq + ccli22invstufflesp15 * logmxysq + ccli22invstufflesp16 * logmxy * (logmx + logmy)
                   + ccli22invstufflesp17 * logmysq + ccli22invstufflesp18;
        }

        complex<double>
        li22diagonalind(const complex<double> & iab, int & nmo, const complex<double> & logomx, const complex<double> & litx)
        {
        ...
        complex<double>
        li22diagonal(const complex<double> & a, const complex<double> & b, char ncmax)
        {
            complex<double>       res    = 0;
            const complex<double> ab     = a * b;
        ...
        // This is Li22(x/2,y)
        complex<double>
        holderf1rec(complex<double> part1, complex<double> part2, const complex<double> & x, const complex<double> & xy, int n, int & nn)
        {
            if (n < nn)
            {
        ...
        complex<double>
        holderf1(const complex<double> & x, const complex<double> & xy, int & nn)
        {
        ...
        complex<double>
        holderf2rec(complex<double> part1, complex<double> part2, complex<double> part3, complex<double> part4, const complex<double> & x, const complex<double> & z, int n,
                    int & nn)
        {
            if (n < nn)
            {
                return part1
                       + holderf2rec(part1 * x * ccholder21[n] + part2, part2 * ccholder22[n] + part3, part3 * z * ccholder23[n] + part4, part4 * ccholder24[n], x, z, n + 1, nn);
            }
            return part1;
        }

        complex<double>
        holderf2(const complex<double> & x, const complex<double> & z, int & nn)
        {
        ...
        // This is Li12(x/2,y)
        complex<double>
        holderf3rec(complex<double> part1, complex<double> part2, const complex<double> & x, const complex<double> & xy, int n, int & nn)
        {
            if (n < nn)
            {
        ...
        complex<double>
        holderf3(const complex<double> & x, const complex<double> & xy, int & nn)
        {
        ...
        complex<double>
        holderf4rec(complex<double> part1, complex<double> part2, const complex<double> & x, int n, int & nn)
        {
            if (n < nn)
            {
        ...
        complex<double>
        holderf4(const complex<double> & x, int & nn)
        {
        ...
        complex<double>
        holderf5rec(complex<double> part1, complex<double> part2, complex<double> part3, const complex<double> & y, int n, int & nn)
        {
            if (n < nn)
            {
                return part1 + holderf5rec(part1 * ccholder51[n] + part2, y * part2 * ccholder52[n] + part3, part3 * ccholder53[n], y, n + 1, nn);
            }
            return part1;
        }

        complex<double>
        holderf5(const complex<double> & y, int & nn)
        {
        ...
        complex<double>
        li22holder(const complex<double> & x, const complex<double> & y, int ncmax)
        {
            ...
            return holderf1(x, xy, ncmax) + holderf2(r1, r2, ncmax) + ccholderclog2 * holderf3(x, xy, ncmax) - holderf4(r2, ncmax) * li2logA0(xyh)
                   - holderf5(r2, ncmax) * std::log(1. - xyh);
        }

        complex<double>
        li22holderstuffle(const complex<double> & x, const complex<double> & y, int ncmax)
        {
            const complex<double> xy = x * y;
        ...
        complex<double>
        li22logA0recint(complex<double> next, int nc, int & nco, const complex<double> & p, const complex<double> & logapp, int & ncmax)
        {
            if (nc < ncmax)
            {
                return next * (ccli22logA0a[nc][nco] + ccli22logA0b[nc][nco] * logapp) + li22logA0recint(next * p, nc + 1, nco, p, logapp, ncmax);
            }
            return next * (ccli22logA0a[nc][nco] + ccli22logA0b[nc][nco] * logapp);
        }

        complex<double>
        li22logA0rec(complex<double> next, int nc, const complex<double> & t, const complex<double> & p, const complex<double> & logapp, const complex<double> & logompt,
                     const complex<double> & litt, int & ncmax)
        {
            if (nc < ncmax)
            {
                return next * (ccli22logA0c[nc] * logompt + ccli22logA0d[nc] * litt) + li22logA0recint(next * p, 1, nc, p, logapp, ncmax)
        ...
        complex<double>
        li22logA0(const complex<double> & x, const complex<double> & y, int ncmax)
        {
            const complex<double> xy      = x * y;
        ...
        complex<double>
        li22logA1recint(complex<double> next, int nc, int & nco, const complex<double> & b, const complex<double> & logb, const complex<double> & logbxi, int & ncmax)
        {
            if (nc < ncmax)
            {
                return next * (ccli22logA1k1[nc][nco] + ccli22logA1k2[nc][nco] * logb + ccli22logA1k3[nc][nco] * logbxi)
                       + li22logA1recint(next * b, nc + 1, nco, b, logb, logbxi, ncmax);
            }
        ...
        complex<double>
        li22logA1rec(complex<double> next, int nc, const complex<double> & a, const complex<double> & b, const complex<double> & logb, const complex<double> & logbxi,
                     const complex<double> & logabdif, int & ncmax)
        {
            if (nc < ncmax)
            {
                return next * (ccli22logA1k4[nc] + b * ccli22logA1k5[nc]) * logabdif + li22logA1recint(next, 0, nc, b, logb, logbxi, ncmax)
        ...
        complex<double>
        li22logA1ff2(const complex<double> & x, const complex<double> & y, int & ncmax)
        {
            ...
            res = li22logA1rec(1., 0, a, b, logb, logbxi, logabdif, ncmax)
                  + apb * a * (dilog(li2a1) - dilog(li2a2) + logbxi * std::log((apb + ccxizero) / a) - logb * std::log(apb / a));
        ...
        complex<double>
        crli12rec(complex<double> part1, complex<double> part2, const complex<double> & x, const complex<double> & xy, int n, int & nn)
        {
            if (n < nn)
            {
        ...
        complex<double>
        crli12(const complex<double> & x, const complex<double> & y, int nn)
        {
            const complex<double> xy = x * y;
        ...
        complex<double>
        li22logA1ff1(const complex<double> & x, const complex<double> & y)
        {
        ...
        complex<double>
        li22logA1(const complex<double> & x, const complex<double> & y, int ncmax)
        {
            if (ncmax > 99)
            {
        ...
        complex<double>
        li22logA1stuffle(const complex<double> & x, const complex<double> & y, int ncmax)
        {
            const complex<double> xy = x * y;
        ...
        complex<double>
        li22smalla(const complex<double> & a, const complex<double> & b)
        {
        ...
        complex<double>
        li22smallastuffle(const complex<double> & a, const complex<double> & b)
        {
            const complex<double> ab = a * b;
        ...
        complex<double>
        li22smallainv(const complex<double> & x, const complex<double> & y)
        {
            const complex<double> xy     = x * y;
            const complex<double> ix     = 1. / x;
            const complex<double> iy     = 1. / y;
            ...
            return li22smalla(ix, iy) - quadlog(xy) + 3. * (quadlog(y) + quadlog(ix)) + 2. * (trilog(ix) - trilog(y)) * logmxy + dilog(ix) * (pisqos + logmxy * logmxy / 2.)
                   + dilog(y) * (logmxy * logmxy - logmx * logmx) / 2.;
        }

        complex<double>
        li22smallainvstuffle(const complex<double> & x, const complex<double> & y)
        {
            const complex<double> xy     = x * y;
            const complex<double> ix     = 1. / x;
            const complex<double> iy     = 1. / y;
            ...
            return li22smallastuffle(ix, iy) - quadlog(xy) + 3. * (quadlog(y) + quadlog(ix)) + 2. * (trilog(ix) - trilog(y)) * logmxy + dilog(ix) * (pisqos + logmxy * logmxy / 2.)
                   + dilog(y) * (logmxy * logmxy - logmx * logmx) / 2.;
        }

        // This is Li22(x,x)
        complex<double>
        li22xx(complex<double> x)
        {
            const complex<double> xsq  = x * x;
        ...
        li22x1(complex<double> x)
        {
            ...
            return li22x1c1 * (quadlog(arg1) + quadlog(arg2) + quadlog(x)) + li22x1c2 * trilog(x) * logomx + li22x1c3 * li2x * li2x
                   + logomxsq * (li22x1c4 * logomxsq + li22x1c5 * logomx * log(-x) + li22x1c6) + li22x1c7 * logomx + li22x1c8;
        }
        ...
        li221y(complex<double> y)
        {
            ...
            return li221yc1 * (quadlog(arg1) + quadlog(arg2)) + quadlog(y) + li221yc2 * trilog(y) * logomy + (li221yc9 + li221yc3 * li2y) * li2y
                   + logomysq * (li221yc4 * logomysq + li221yc5 * logomy * std::log(-y) + li221yc6) + li221yc7 * logomy + li221yc8;
        }

        const double epsdif = 5e-14;

        complex<double>
        li22basic(const complex<double> & x, const complex<double> & y)
        {
    ...
    complex<double>
    li22(const complex<double> & x, const complex<double> & y)
    {
