...
complex<double>
test_func_1(const complex<double> & z)
{
    return z;
}
...
complex<double>
test_func_2(const complex<double> & z)
{
    return 2.0 + z;
}
...
complex<double>
test_func_3(const complex<double> & z)
{
...
complex<double>
test_func_4(const complex<double> & z)
{
    return (1.0 - z) / z;
}
...
complex<double>
test_func_5(const complex<double> & z)
{
    return z / (1.0 - z);
}
...
/// TESTS
/////////
class OuterFunctionTest : public TestCase
{
    public:
        OuterFunctionTest() :
