...
class DftContainerDoubleRankOneTest : public TestCase
{
    public:
...
class DftContainerComplexDoubleRankOneTest : public TestCase
{
    public:
...
class DftContainerComplexDoubleMultiplicationTest : public TestCase
{
    public:
