        ...
        virtual void run() const
        {
            ...
            // Test the derivatives
            {
...

                {
                    ...
                    TEST_CHECK_RELATIVE_ERROR(p2.real(), -2.56765,            1.0e-5);
                    TEST_CHECK_RELATIVE_ERROR(p3.real(), +6.48297,            1.0e-5);
                    TEST_CHECK_RELATIVE_ERROR(p4.real(), -15.2203,            1.0e-5);
                    TEST_CHECK_RELATIVE_ERROR(p5.real(), +34.0797,            1.0e-5);
                }
