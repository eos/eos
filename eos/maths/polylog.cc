...
namespace eos
{
    ...
    namespace trilog_impl
    {
        ...
        std::array<complex<double>, max_iterations> series_coefficient_f1{
            { +1.2020569031595943,
             ...
             0.0, +0.000011574074074074074,
             0.0, -9.8418997228521038e-8,
             0.0, +1.1482216343327454e-9,
             0.0, -1.5815724990809166e-11,
             0.0, +2.4195009792525152e-13,
             0.0, -3.9828977769894877e-15,
             0.0, +6.9233666183059291e-17,
             0.0, -1.2552722304499773e-18,
             0.0, +2.3537540027684652e-20,
             0.0, -4.536398903458687e-22,
             0.0, +8.9451696703926432e-24,
             0.0, -1.7982840046954963e-25,
             0.0, +3.6754997647937384e-27,
             0.0, -7.6208079715647952e-29,
             0.0, +1.600041964369486e-30,
             0.0, -3.3967611475603756e-32,
             0.0, +7.2822722867577647e-34,
             0.0, -1.5750226479580035e-35,
             0.0, +3.4335400924805893e-37,
             0.0, -7.53884999808987e-39,
             0.0, +1.6660681647653604e-40,
             0.0, -3.7038989028813871e-42,
             0.0, +8.2792117964682747e-44,
             0.0, -1.8599148146309811e-45,
             0.0 }
        };
    ...
    namespace quadlog_impl
    {
        ...
        std::array<complex<double>, max_iterations> series_coefficient_f1{
            { +1.082323233711138192,
             +1.20205690315959428,
             +0.822467033424113218,
             0.0, -0.020833333333333333,
        ...
        g(const complex<double> & z)
        {
            ...
            complex<double> result = a * (-1.0 / 30.0 + b * b * (1.0 - 2.0 * b * (1.0 - 0.5 * b))) + complex<double>(0.0, -M_PI / 3.0) * theta * power_of<3>(lnz);
    ...
    complex<double>
    quadlog(const complex<double> & z)
    {
        // special cases
        if (z == complex<double>(0.0, 0.0))
        {
