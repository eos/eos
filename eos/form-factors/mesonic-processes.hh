...
namespace eos
{
    ...
    struct BToPiPi {
        ...
        static constexpr std::array<double, 3> lambda_1  = { -std::numbers::inv_sqrt3 / std::numbers::sqrt2 , 0.0 , -std::numbers::inv_sqrt3 / std::numbers::sqrt2 };
        static constexpr std::array<double, 3> lambda_2  = { 0.0 , 1.0 / std::numbers::sqrt2 , 0.0 };
        ...
        static constexpr IsospinRepresentation rep_1 = IsospinRepresentation::zero;
        static constexpr IsospinRepresentation rep_2 = IsospinRepresentation::one;
    };
