...
namespace eos
{
    ...
    complex<double>
    SSEFormFactors<Process_, PToP>::_calc_ff(const complex<double> & s, const double & m_R, const double & tp, const std::array<Parameter_, 3> & a) const
    {
    ...
    {
        return _calc_ff(s, _traits.m_R_1m, _traits.tp, _a_fp);
    }
    ...
    {
        return _calc_ff(s, _traits.m_R_1m, _traits.tp, _a_ft);
    }
    ...
    {
        return _calc_ff(s, _traits.m_R_1m, _traits.tp, _a_ft) * s / _mB() / (_mB + _mP);
    }
