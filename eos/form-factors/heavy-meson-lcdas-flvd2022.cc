...
namespace eos
{
    namespace heavy_meson_lcdas
    {
        ...
        FLvD2022::FLvD2022(const Parameters & p, const Options & o) :
            ...
            a({ UsedParameter(p[parameter("a^phi+_0")], *this),
                ...
                UsedParameter(p[parameter("a^phi+_8")], *this) })
        {
            ...
            {
                alpha_s = [this](const double & mu) -> double { return model->alpha_s(mu); };
            }
            else
            {
                ...
                const std::array<std::array<double, 9>, 9> rge_matrix = {
                    {
                     { 1.,
                          -0.5 * g,
                          0.16666666666666666 * g * (1. + g),
                          -0.041666666666666664 * g * (1. + g) * (2. + g),
                          0.008333333333333333 * g * (1. + g) * (2. + g) * (3. + g),
                          -0.001388888888888889 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g),
                          0.0001984126984126984 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (5. + g),
                          -0.0000248015873015873 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (5. + g) * (6. + g),
                          2.7557319223985893e-6 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (5. + g) * (6. + g) * (7. + g) },
                     { -1. * g,
                          1. + 0.5 * (-1. + g) * g,
                          -0.16666666666666666 * g * (4. + (-1. + g) * g),
                          0.041666666666666664 * g * (6. + 5. * g + g3),
                          -0.008333333333333333 * g * (1. + g) * (2. + g) * (8. + (-1. + g) * g),
                          0.001388888888888889 * g * (1. + g) * (2. + g) * (3. + g) * (10. + (-1. + g) * g),
                          -0.0001984126984126984 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (12. + (-1. + g) * g),
                          0.0000248015873015873 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (5. + g) * (14. + (-1. + g) * g),
                          -2.7557319223985893e-6 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (5. + g) * (6. + g) * (16. + (-1. + g) * g) },
                     { 0.5 * g * (1. + g),
                          -0.25 * g * (4. + (-1. + g) * g),
                          1. + 0.08333333333333333 * (-1. + g) * g * (10. + (-1. + g) * g),
                          -0.020833333333333332 * g * (36. + (-1. + g) * g * (16. + (-1. + g) * g)),
                          0.004166666666666667 * g * (1. + g) * (4. + (-1. + g) * g) * (18. + (-1. + g) * g),
                          -0.0006944444444444445 * g * (1. + g) * (2. + g) * (120. + (-1. + g) * g * (28. + (-1. + g) * g)),
                          0.0000992063492063492 * g * (1. + g) * (2. + g) * (3. + g) * (180. + (-1. + g) * g * (34. + (-1. + g) * g)),
                          -0.00001240079365079365 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (252. + (-1. + g) * g * (40. + (-1. + g) * g)),
                          1.3778659611992946e-6 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (5. + g) * (336. + (-1. + g) * g * (46. + (-1. + g) * g)) },
                     { -0.16666666666666666 * g * (1. + g) * (2. + g),
                          0.08333333333333333 * g * (6. + 5. * g + g3),
                          -0.027777777777777776 * g * (36. + (-1. + g) * g * (16. + (-1. + g) * g)),
                          0.006944444444444444 * (6. + (-1. + g) * g) * (24. + (-1. + g) * g * (22. + (-1. + g) * g)),
                          -0.001388888888888889 * g * (576. + (-1. + g) * g * (348. + (-1. + g) * g * (40. + (-1. + g) * g))),
                          0.0002314814814814815 * g * (1. + g) * (1440. + (-1. + g) * g * (18. + (-1. + g) * g) * (34. + (-1. + g) * g)),
                          -0.00003306878306878307 * g * (1. + g) * (2. + g) * (16. + (-1. + g) * g) * (180. + (-1. + g) * g * (48. + (-1. + g) * g)),
                          4.133597883597884e-6 * g * (1. + g) * (2. + g) * (3. + g) * (5040. + (-1. + g) * g * (1356. + (-1. + g) * g * (76. + (-1. + g) * g))),
                          -4.592886537330982e-7 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (6. + (-1. + g) * g) * (1344. + (-1. + g) * g * (82. + (-1. + g) * g)) },
                     { 0.041666666666666664 * g * (1. + g) * (2. + g) * (3. + g),
                          -0.020833333333333332 * g * (1. + g) * (2. + g) * (8. + (-1. + g) * g),
                          0.006944444444444444 * g * (1. + g) * (4. + (-1. + g) * g) * (18. + (-1. + g) * g),
                          -0.001736111111111111 * g * (576. + (-1. + g) * g * (348. + (-1. + g) * g * (40. + (-1. + g) * g))),
                          1. + 0.00034722222222222224 * (-1. + g) * g * (14. + (-1. + g) * g) * (264. + (-1. + g) * g * (46. + (-1. + g) * g)),
                          -0.00005787037037037037 * g * (14400. + (-1. + g) * g * (18. + (-1. + g) * g) * (592. + (-1. + g) * g * (62. + (-1. + g) * g))),
                          8.267195767195768e-6 * g * (1. + g) * (43200. + (-1. + g) * g * (18. + (-1. + g) * g) * (1272. + (-1. + g) * g * (82. + (-1. + g) * g))),
                          -1.033399470899471e-6 * g * (1. + g) * (2. + g) * (100800. + (-1. + g) * g * (41856. + (-1. + g) * g * (4028. + (-1. + g) * g * (120. + (-1. + g) * g)))),
                          1.1482216343327455e-7 * g * (1. + g) * (2. + g) * (3. + g)
                                  * (201600. + (-1. + g) * g * (68976. + (-1. + g) * g * (76. + (-4. + g) * g) * (73. + g * (2. + g)))) },
                     { -0.008333333333333333 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g),
                          0.004166666666666667 * g * (1. + g) * (2. + g) * (3. + g) * (10. + (-1. + g) * g),
                          -0.001388888888888889 * g * (1. + g) * (2. + g) * (120. + (-1. + g) * g * (28. + (-1. + g) * g)),
                          0.00034722222222222224 * g * (1. + g) * (1440. + (-1. + g) * g * (18. + (-1. + g) * g) * (34. + (-1. + g) * g)),
                          -1. * g - 0.00006944444444444444 * (-1. + g) * (18. + (-1. + g) * g) * (592. + (-1. + g) * g * (62. + (-1. + g) * g)) * g2,
                          1. + 0.000011574074074074073 * (-1. + g) * g * (125280. + (-1. + g) * g * (37896. + (-1. + g) * g * (3508. + (-1. + g) * g * (110. + (-1. + g) * g)))),
                          -1.6534391534391535e-6 * g
                                  * (518400. + (-1. + g) * g * (444960. + (-1. + g) * g * (89136. + (-1. + g) * g * (5908. + (-1. + g) * g * (140. + (-1. + g) * g))))),
                          2.066798941798942e-7 * g * (1. + g)
                                  * (1.8144e6 + (-1. + g) * g * (1.13184e6 + (-1. + g) * g * (171576. + (-1. + g) * g * (8908. + (-1. + g) * g * (170. + (-1. + g) * g))))),
                          -2.296443268665491e-8 * g * (1. + g) * (2. + g)
                                  * (4.8384e6 + (-1. + g) * g * (2.38752e6 + (-1. + g) * g * (292416. + (-1. + g) * g * (12508. + (-1. + g) * g * (200. + (-1. + g) * g))))) },
                     { 0.001388888888888889 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (5. + g),
                          -0.0006944444444444445 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (12. + (-1. + g) * g),
                          0.0002314814814814815 * g * (1. + g) * (2. + g) * (3. + g) * (180. + (-1. + g) * g * (34. + (-1. + g) * g)),
                          -0.00005787037037037037 * g * (1. + g) * (2. + g) * (16. + (-1. + g) * g) * (180. + (-1. + g) * g * (48. + (-1. + g) * g)),
                          0.000011574074074074073 * g * (1. + g) * (43200. + (-1. + g) * g * (18. + (-1. + g) * g) * (1272. + (-1. + g) * g * (82. + (-1. + g) * g))),
                          -1. * g
                                  - 1.9290123456790124e-6 * (-1. + g) * (444960. + (-1. + g) * g * (89136. + (-1. + g) * g * (5908. + (-1. + g) * g * (140. + (-1. + g) * g))))
                                            * g2,
                          1.
                                  + 2.755731922398589e-7 * (-1. + g) * g
                                            * (5.78016e6
                                               + (-1. + g) * g * (2.036592e6 + (-1. + g) * g * (236472. + (-1. + g) * g * (10528. + (-1. + g) * g * (182. + (-1. + g) * g))))),
                          -0.875 * g
                                  - 3.444664902998236e-8 * (-1. + g)
                                            * (2.446848e7
                                               + (-1. + g) * g * (5.780304e6 + (-1. + g) * g * (484608. + (-1. + g) * g * (16408. + (-1. + g) * g * (224. + (-1. + g) * g)))))
                                            * g2,
                          3.827405447775818e-9 * g * (1. + g)
                                  * (1.016064e8
                                     + (-1. + g) * g
                                               * (7.200576e7
                                                  + (-1. + g) * g
                                                            * (1.2986496e7 + (-1. + g) * g * (858744. + (-1. + g) * g * (23548. + (-1. + g) * g * (266. + (-1. + g) * g)))))) },
                     { -0.0001984126984126984 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (5. + g) * (6. + g),
                          0.0000992063492063492 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (5. + g) * (14. + (-1. + g) * g),
                          -0.00003306878306878307 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (252. + (-1. + g) * g * (40. + (-1. + g) * g)),
                          8.267195767195768e-6 * g * (1. + g) * (2. + g) * (3. + g) * (5040. + (-1. + g) * g * (1356. + (-1. + g) * g * (76. + (-1. + g) * g))),
                          -1.6534391534391535e-6 * g * (1. + g) * (2. + g)
                                  * (100800. + (-1. + g) * g * (41856. + (-1. + g) * g * (4028. + (-1. + g) * g * (120. + (-1. + g) * g)))),
                          2.755731922398589e-7 * g * (1. + g)
                                  * (1.8144e6 + (-1. + g) * g * (1.13184e6 + (-1. + g) * g * (171576. + (-1. + g) * g * (8908. + (-1. + g) * g * (170. + (-1. + g) * g))))),
                          -1. * g - 3.936759889140842e-8 * (-1. + g) * (2.446848e7 + (-1. + g) * g * (5.780304e6 + (-1. + g) * g * (484608. + (-1. + g) * g * (16408. + (-1. + g) * g * (224. + (-1. + g) * g))))) * g2,
                          1.
                                  + 4.920949861426052e-9 * (-1. + g) * g
                                            * (3.4909056e8
                                               + (-1. + g) * g
                                                         * (1.38517632e8
                                                            + (-1. + g) * g
                                                                      * (1.9022736e7
                                                                         + (-1. + g) * g * (1.074176e6 + (-1. + g) * g * (26600. + (-1. + g) * g * (280. + (-1. + g) * g)))))),
                          -0.8888888888888888 * g
                                  - 5.467722068251169e-10 * (-1. + g)
                                            * (1.71932544e9
                                               + (-1. + g) * g
                                                         * (4.62214656e8
                                                            + (-1. + g) * g
                                                                      * (4.6160784e7
                                                                         + (-1. + g) * g * (1.993024e6 + (-1. + g) * g * (39144. + (-1. + g) * g * (336. + (-1. + g) * g))))))
                                            * g2 },
                     { 0.0000248015873015873 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (5. + g) * (6. + g) * (7. + g),
                          -0.00001240079365079365 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (5. + g) * (6. + g) * (16. + (-1. + g) * g),
                          4.133597883597884e-6 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (5. + g) * (336. + (-1. + g) * g * (46. + (-1. + g) * g)),
                          -1.033399470899471e-6 * g * (1. + g) * (2. + g) * (3. + g) * (4. + g) * (6. + (-1. + g) * g) * (1344. + (-1. + g) * g * (82. + (-1. + g) * g)),
                          2.066798941798942e-7 * g * (1. + g) * (2. + g) * (3. + g)
                                  * (201600. + (-1. + g) * g * (68976. + (-1. + g) * g * (76. + (-4. + g) * g) * (73. + g * (2. + g)))),
                          -3.444664902998236e-8 * g * (1. + g) * (2. + g)
                                  * (4.8384e6 + (-1. + g) * g * (2.38752e6 + (-1. + g) * g * (292416. + (-1. + g) * g * (12508. + (-1. + g) * g * (200. + (-1. + g) * g))))),
                          4.920949861426052e-9 * g * (1. + g)
                                  * (1.016064e8
                                     + (-1. + g) * g
                                               * (7.200576e7
                                                  + (-1. + g) * g * (1.2986496e7 + (-1. + g) * g * (858744. + (-1. + g) * g * (23548. + (-1. + g) * g * (266. + (-1. + g) * g)))))),
                          -1. * g - 6.151187326782565e-10 * (-1. + g) * (1.71932544e9 + (-1. + g) * g * (4.62214656e8 + (-1. + g) * g * (4.6160784e7 + (-1. + g) * g * (1.993024e6 + (-1. + g) * g * (39144. + (-1. + g) * g * (336. + (-1. + g) * g)))))) * g2,
                          1.
                                  + 6.834652585313961e-11 * (-1. + g) * g
                                            * (2.676022272e10
                                               + (-1. + g) * g
                                                         * (1.1692594944e10
                                                            + (-1. + g) * g
        ...
        FLvD2022::phitilde_plus(const double & tau, const double & mu) const
        {
            ...
            const Weights c = { 1.0, p1, p2, p3, p4, p5, p6, p7, p8 };
        ...
        FLvD2022::t_d_dt_phitilde_plus(const double & tau, const double & mu) const
        {
            ...
            const Weights c = { 1.0 - x, (2.0 - x) * p1, (3.0 - x) * p2, (4.0 - x) * p3, (5.0 - x) * p4, (6.0 - x) * p5, (7.0 - x) * p6, (8.0 - x) * p7, (9.0 - x) * p8 };
        ...
        {
            // Cp. [FLvD:2022A], Eq. (44)
            const Weights c = { 0, -1.0, 0, -2.0 / 3.0, 0.0, -23.0 / 45.0, 0.0, -44.0 / 105.0, 0.0 };
        ...
        {
            // Cp. [FLvD:2022A], Eq. (45)
            const Weights c = { 0.0, 0.0, 4.0 / 3.0, 0.0, 4.0 / 3.0, 0.0, 56.0 / 45.0, 0.0, 3272.0 / 2835.0 };
        ...
        const std::set<ReferenceName> FLvD2022::references{ "FLvD:2022A"_rn };

        const std::vector<OptionSpecification> FLvD2022::options{
            {       "Q"_ok,                   { "b"_ov },        "b"_ov },
