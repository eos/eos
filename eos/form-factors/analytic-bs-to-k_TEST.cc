...
class AnalyticFormFactorBsToKDKMMO2008Test : public TestCase
{
    public:
        ...
        run() const
        {
             ...
             */
            {
                ...
                AnalyticFormFactorBToPseudoscalarDKMMO2008<QuarkFlavor::bottom, QuarkFlavor::up, QuarkFlavor::down> ff(p,
                                                                                                                       Options{
