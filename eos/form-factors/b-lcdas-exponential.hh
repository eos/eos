...
#ifndef EOS_GUARD_EOS_FORM_FACTORS_B_LCDAS_EXP_HH
#define EOS_GUARD_EOS_FORM_FACTORS_B_LCDAS_EXP_HH 1
...
namespace eos
{
    namespace b_lcdas
    {
        ...
        */
        class Exponential:
            public BMesonLCDAs,
            public PrivateImplementationPattern<Exponential>
        {
            public:
                Exponential(const Parameters &, const Options &);
                ~Exponential();
