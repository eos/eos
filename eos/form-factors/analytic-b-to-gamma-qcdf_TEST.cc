    ...
    public:
        ...
        run() const
        {
            // Regression tests at the inputs of [BBJW:2018A], Table 1, with sigmahat_1 = 0.
            {
                ...
                // [BBJW:2018A], Fig. 5 (center), dash-dotted curve: xi^ht at E_gamma = 2 GeV.
                for (const auto & [lambda_B, published] : std::array<std::pair<double, double>, 3>{
                ...
                // [BBJW:2018A], Fig. 6, black dash-dotted curve: Delta_xi^ht.
                ...
                // condensate, these values exceed the dashed curves in Fig. 6 by 31--36%.
