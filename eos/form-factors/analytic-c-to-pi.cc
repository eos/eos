...
#include <eos/form-factors/analytic-c-to-pi.hh>
...
namespace eos
{
    ...
    struct Implementation<AnalyticFormFactorBToPiDKMMO2008>
    {
        ...
        static double rho_1(const double & s, const double & mc, const double & mu)
        {
            ...
            const double lnmumb = std::log(mu / mc);
...
// for diagnostics purposes only
    ...
    double
    AnalyticFormFactorBToPiDKMMO2008::MDp_lcsr(const double & q2) const
    {
        return _imp->MDp_lcsr(q2);
    }

    double
    AnalyticFormFactorBToPiDKMMO2008::MD0_lcsr(const double & q2) const
    {
        return _imp->MD0_lcsr(q2);
    }

    double
    AnalyticFormFactorBToPiDKMMO2008::MDT_lcsr(const double & q2) const
    {
        return _imp->MDT_lcsr(q2);
    }

    double
    AnalyticFormFactorBToPiDKMMO2008::MD_svz() const
    {
        return _imp->MD_svz();
    }
