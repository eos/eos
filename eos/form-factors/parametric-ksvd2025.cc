...
namespace eos
{
    ...
    double KSvD2025FormFactors<VacuumToKPi>::lambda_plus() const
    {
    ...
    double KSvD2025FormFactors<VacuumToKPi>::lambda_zero() const
    {
        const double f_at_0 = this->fp_at_0();
    ...
    {
        { "n-resonances-1m"_ok, { "1"s, "2"s, "3"s }, "2"s },
        { "n-resonances-0p"_ok, { "1"s, "2"s       }, "2"s }
    };
