...
namespace eos
{
    ...
    KKRvD2024FormFactors<VacuumToPiPi>::KKRvD2024FormFactors(const Parameters & p, const Options & /*o*/) :
        ...
        _M_fp_I1(p["0->pipi::M_(+,1)@KKRvD2024"], *this), _G_fp_I1(p["0->pipi::Gamma_(+,1)@KKRvD2024"], *this), _m_pi(p["mass::pi^+"], *this),
        _t_0(p["0->pipi::t_0@KKRvD2024"], *this), _hbar(p["QM::hbar"], *this)
    {
    }
