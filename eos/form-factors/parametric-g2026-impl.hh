...
namespace eos
{
    ...
    const std::map<std::tuple<QuarkFlavor, QuarkFlavor>, std::vector<std::string>> G2026FormFactorTraits<Process_, PToV>::pole_A0_names{
        { std::make_tuple(QuarkFlavor::bottom,      QuarkFlavor::up), { "mass::B_u,A^0[1]@G2026", "mass::B_u,A^0[2]@G2026", "mass::B_u,A^0[3]@G2026" } },
        { std::make_tuple(QuarkFlavor::bottom,    QuarkFlavor::down), { "mass::B_d,A^0[1]@G2026", "mass::B_d,A^0[2]@G2026", "mass::B_d,A^0[3]@G2026" } },
        { std::make_tuple(QuarkFlavor::bottom, QuarkFlavor::strange), { "mass::B_s,A^0[1]@G2026", "mass::B_s,A^0[2]@G2026", "mass::B_s,A^0[3]@G2026" } },
        { std::make_tuple(QuarkFlavor::bottom,   QuarkFlavor::charm), { "mass::B_c,A^0[1]@G2026", "mass::B_c,A^0[2]@G2026", "mass::B_c,A^0[3]@G2026" } },
    };

    template <typename Process_>
    const std::map<std::tuple<QuarkFlavor, QuarkFlavor>, std::vector<std::string>> G2026FormFactorTraits<Process_, PToV>::pole_V1_names{
        { std::make_tuple(QuarkFlavor::bottom,      QuarkFlavor::up), { "mass::B_u,V^1[1]@G2026", "mass::B_u,V^1[2]@G2026", "mass::B_u,V^1[3]@G2026" } },
        { std::make_tuple(QuarkFlavor::bottom,    QuarkFlavor::down), { "mass::B_d,V^1[1]@G2026", "mass::B_d,V^1[2]@G2026", "mass::B_d,V^1[3]@G2026" } },
        { std::make_tuple(QuarkFlavor::bottom, QuarkFlavor::strange), { "mass::B_s,V^1[1]@G2026", "mass::B_s,V^1[2]@G2026", "mass::B_s,V^1[3]@G2026" } },
        { std::make_tuple(QuarkFlavor::bottom,   QuarkFlavor::charm), { "mass::B_c,V^1[1]@G2026", "mass::B_c,V^1[2]@G2026", "mass::B_c,V^1[3]@G2026" } },
    };

    template <typename Process_>
    const std::map<std::tuple<QuarkFlavor, QuarkFlavor>, std::vector<std::string>> G2026FormFactorTraits<Process_, PToV>::pole_A1_names{
        { std::make_tuple(QuarkFlavor::bottom,      QuarkFlavor::up), { "mass::B_u,A^1[1]@G2026", "mass::B_u,A^1[2]@G2026", "mass::B_u,A^1[3]@G2026" } },
        { std::make_tuple(QuarkFlavor::bottom,    QuarkFlavor::down), { "mass::B_d,A^1[1]@G2026", "mass::B_d,A^1[2]@G2026", "mass::B_d,A^1[3]@G2026" } },
        { std::make_tuple(QuarkFlavor::bottom, QuarkFlavor::strange), { "mass::B_s,A^1[1]@G2026", "mass::B_s,A^1[2]@G2026", "mass::B_s,A^1[3]@G2026" } },
        { std::make_tuple(QuarkFlavor::bottom,   QuarkFlavor::charm), { "mass::B_c,A^1[1]@G2026", "mass::B_c,A^1[2]@G2026", "mass::B_c,A^1[3]@G2026" } },
    };
    ...
    template <typename Process_> G2026FormFactors<Process_, PToV>::~G2026FormFactors() = default;
    ...
    template <typename Process_>
    double
    G2026FormFactors<Process_, PToV>::_phi(const double & s, const double & sG, const double & s0, const std::vector<double> & Mres, const double & tchi, const unsigned Kn,
                                           const int Ksp, const int Ksm, const int Kspm, const unsigned a, const unsigned b, const unsigned c, const unsigned d) const
    {
        ...
        const double norm = std::sqrt(_traits.eta / (Kn * pow(sp, Ksp) * pow(sm, Ksm) * pow(sp - sm, Kspm) * M_PI * tchi));

        // Individual factors from the new definition
        const double factor_const = std::pow((sG - s) / (sG - s0), 0.25) * (sqrt_sG_s + sqrt_sG_s0);

        const double factor_a = std::pow(sp - s, 0.25 * a);

        const double factor_b = std::pow(sqrt_sG_s + sqrt_sG_sm, 0.5 * b);

        const double factor_c = std::pow(sqrt_sG_s + sqrt_sG, -(c + 3.0));

        const double factor_d = std::pow((sqrt_sG_s + sqrt_sG) / (sqrt_sG_s + sqrt_sG_Q2), d);
        ...
        return norm * factor_const * factor_a * factor_b * factor_c * factor_d * factor_Mres;
    }
    ...
    {
        return _phi(q2, _traits.sV, _traits.s0V, _traits.m_R_V1, _traits.tchi_V1, 24 /*Kn*/, 1 /*Ksp*/, 0 /*Ksm*/, 0 /*Kspm*/, 3 /*a*/, 3 /*b*/, 1 /*c*/, 3 /*d*/
        );
    }
    ...
    {
        return _phi(q2, _traits.sA, _traits.s0A, _traits.m_R_A0, _traits.tchi_A0, 16 /*Kn*/, 0 /*Ksp*/, 0 /*Ksm*/, 0 /*Kspm*/, 3 /*a*/, 3 /*b*/, 1 /*c*/, 2 /*d*/
        );
    }
    ...
    {
        return _phi(q2, _traits.sA, _traits.s0A, _traits.m_R_A1, _traits.tchi_A1, 24 /*Kn*/, -1 /*Ksp*/, 0 /*Ksm*/, 0 /*Kspm*/, 1 /*a*/, 1 /*b*/, 1 /*c*/, 3 /*d*/
        );
    }
    ...
    {
        return _phi(q2, _traits.sA, _traits.s0A, _traits.m_R_A1, _traits.tchi_A1, 12 /*Kn*/, 0 /*Ksp*/, 0 /*Ksm*/, -2 /*Kspm*/, 1 /*a*/, 1 /*b*/, 2 /*c*/, 3 /*d*/
        );
    }
    ...
    {
        return _phi(q2, _traits.sV, _traits.s0V, _traits.m_R_V1, _traits.tchi_T1, 24 /*Kn*/, 0 /*Ksp*/, 0 /*Ksm*/, 0 /*Kspm*/, 3 /*a*/, 3 /*b*/, 2 /*c*/, 4 /*d*/
        );
    }
    ...
    {
        return _phi(q2, _traits.sA, _traits.s0A, _traits.m_R_A1, _traits.tchi_AT1, 24 /*Kn*/, -1 /*Ksp*/, -1 /*Ksm*/, 0 /*Kspm*/, 1 /*a*/, 1 /*b*/, 2 /*c*/, 4 /*d*/
        );
    }
    ...
    {
        return _phi(q2, _traits.sA, _traits.s0A, _traits.m_R_A1, _traits.tchi_AT1, 48 /*Kn*/, 1 /*Ksp*/, 0 /*Ksm*/, -2 /*Kspm*/, 1 /*a*/, 1 /*b*/, 1 /*c*/, 4 /*d*/
        );
    }
    ...
    {
        const double          x_A12 = _phi_a_12(0.0) * _traits.blaschke_product(0.0, _traits.sA, _traits.m_R_A1) * (power_of<2>(_mB) - power_of<2>(_mV)) / 8.0 / _mB / _mV;
    ...
    template <typename Process_>
    double
    G2026FormFactors<Process_, PToV>::f_perp(const double &) const
    {
        return 0.0;
    }
    ...
    template <typename Process_>
    double
    G2026FormFactors<Process_, PToV>::f_para(const double &) const
    {
        return 0.0;
    }
    ...
    template <typename Process_>
    double
    G2026FormFactors<Process_, PToV>::f_long(const double &) const
    {
        return 0.0;
    }
    ...
    template <typename Process_>
    double
    G2026FormFactors<Process_, PToV>::f_perp_T(const double &) const
    {
        return 0.0;
    }
    ...
    template <typename Process_>
    double
    G2026FormFactors<Process_, PToV>::f_para_T(const double &) const
    {
        return 0.0;
    }
    ...
    template <typename Process_>
    double
    G2026FormFactors<Process_, PToV>::f_long_T(const double &) const
    {
        return 0.0;
    }
    ...
    template <typename Process_> const std::set<ReferenceName> G2026FormFactors<Process_, PToV>::references{ "G:2026A"_rn };

    template <typename Process_> const std::vector<OptionSpecification> G2026FormFactors<Process_, PToV>::options{};
    ...
    template <typename Process_>
    const std::map<std::tuple<QuarkFlavor, QuarkFlavor>, std::vector<std::string>> G2026FormFactorTraits<Process_, PToP>::pole_V0_names{
        { std::make_tuple(QuarkFlavor::bottom,      QuarkFlavor::up), { "mass::B_u,V^0[1]@G2026", "mass::B_u,V^0[2]@G2026", "mass::B_u,V^0[3]@G2026" } },
        { std::make_tuple(QuarkFlavor::bottom,    QuarkFlavor::down), { "mass::B_d,V^0[1]@G2026", "mass::B_d,V^0[2]@G2026", "mass::B_d,V^0[3]@G2026" } },
        { std::make_tuple(QuarkFlavor::bottom, QuarkFlavor::strange), { "mass::B_s,V^0[1]@G2026", "mass::B_s,V^0[2]@G2026", "mass::B_s,V^0[3]@G2026" } },
        { std::make_tuple(QuarkFlavor::bottom,   QuarkFlavor::charm), { "mass::B_c,V^0[1]@G2026", "mass::B_c,V^0[2]@G2026", "mass::B_c,V^0[3]@G2026" } },
        {  std::make_tuple(QuarkFlavor::charm, QuarkFlavor::strange), { "mass::D_s,V^0[1]@G2026", "mass::D_s,V^0[2]@G2026", "mass::D_s,V^0[3]@G2026" } }
    };

    template <typename Process_>
    const std::map<std::tuple<QuarkFlavor, QuarkFlavor>, std::vector<std::string>> G2026FormFactorTraits<Process_, PToP>::pole_V1_names{
        { std::make_tuple(QuarkFlavor::bottom,      QuarkFlavor::up), { "mass::B_u,V^1[1]@G2026", "mass::B_u,V^1[2]@G2026", "mass::B_u,V^1[3]@G2026" } },
        { std::make_tuple(QuarkFlavor::bottom,    QuarkFlavor::down), { "mass::B_d,V^1[1]@G2026", "mass::B_d,V^1[2]@G2026", "mass::B_d,V^1[3]@G2026" } },
        { std::make_tuple(QuarkFlavor::bottom, QuarkFlavor::strange), { "mass::B_s,V^1[1]@G2026", "mass::B_s,V^1[2]@G2026", "mass::B_s,V^1[3]@G2026" } },
        { std::make_tuple(QuarkFlavor::bottom,   QuarkFlavor::charm), { "mass::B_c,V^1[1]@G2026", "mass::B_c,V^1[2]@G2026", "mass::B_c,V^1[3]@G2026" } },
    ...
    template <typename Process_> G2026FormFactors<Process_, PToP>::~G2026FormFactors() = default;
    ...
    template <typename Process_>
    double
    G2026FormFactors<Process_, PToP>::_phi(const double & s, const double & sG, const std::vector<double> & Mres, const double & tchi, const unsigned Kn, const int Ksp,
                                           const int Ksm, const int Kspm, const unsigned a, const unsigned b, const unsigned c, const unsigned d) const
    {
        // Common kinematic invariants
        ...
        // Individual factors from the new definition
        const double factor_const = std::pow((sG - s) / (sG - _traits.s0V), 0.25) * (sqrt_sG_s + sqrt_sG_s0);
    ...
    {
        return _phi(q2, _traits.sV, _traits.m_R_V1, _traits.tchi_V1, 48 /*Kn*/, 0 /*Ksp*/, 0 /*Ksm*/, 0 /*Kspm*/, 3 /*a*/, 3 /*b*/, 2 /*c*/, 3 /*d*/
        );
    }
    ...
    {
        return _phi(q2, _traits.sV, _traits.m_R_V0, _traits.tchi_V0, 16 /*Kn*/, -1 /*Ksp*/, -1 /*Ksm*/, 0 /*Kspm*/, 1 /*a*/, 1 /*b*/, 1 /*c*/, 2 /*d*/
        );
    }
    ...
    {
        return _phi(q2, _traits.sV, _traits.m_R_V1, _traits.tchi_T1, 48 /*Kn*/, 1 /*Ksp*/, 0 /*Ksm*/, 0 /*Kspm*/, 3 /*a*/, 3 /*b*/, 1 /*c*/, 4 /*d*/
        );
    }
    ...
    template <typename Process_>
    double
    G2026FormFactors<Process_, PToP>::f_plus_T(const double &) const
    {
        return 0.0;
    }
    ...
    template <typename Process_> const std::set<ReferenceName> G2026FormFactors<Process_, PToP>::references{ "G:2026A"_rn };

    template <typename Process_> const std::vector<OptionSpecification> G2026FormFactors<Process_, PToP>::options{};
