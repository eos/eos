...
namespace eos
{
    template <> struct AnalyticFormFactorBToPLCSRProcessTraits<BToK>
    {
            ...
            static const constexpr char *                               f_P                 = "decay-constant::K_d";
    ...
    template class AnalyticFormFactorBToPLCSR<BToK>;
} // namespace eos
