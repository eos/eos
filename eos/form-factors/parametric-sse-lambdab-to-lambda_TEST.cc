...
class SSEOneHalfPlusToOneHalfPlusFormFactorsTest :
    public TestCase
{
    public:
        ...
        virtual void run() const
        {
            /* Lambda_b -> Lambda */
            {
                ...
                std::shared_ptr<FormFactors<OneHalfPlusToOneHalfPlus>> ff =
                    FormFactorFactory<OneHalfPlusToOneHalfPlus>::create("Lambda_b->Lambda::SSE", p, Options{ });
            ...
            /* Lambda_c -> neutron */
            {
                Parameters p = Parameters::Defaults();
                std::shared_ptr<FormFactors<OneHalfPlusToOneHalfPlus>> ff =
                    FormFactorFactory<OneHalfPlusToOneHalfPlus>::create("Lambda_c->neutron::SSE", p, Options{ });
                TEST_CHECK(ff.get() != nullptr);
            ...
            /* Lambda_c -> proton (rare c -> u) */
            {
                Parameters p = Parameters::Defaults();
                std::shared_ptr<FormFactors<OneHalfPlusToOneHalfPlus>> ff =
                    FormFactorFactory<OneHalfPlusToOneHalfPlus>::create("Lambda_c->proton::SSE", p, Options{ });
                TEST_CHECK(ff.get() != nullptr);
