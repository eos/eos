...
namespace eos
{
    ...
    HQETFormFactorBase::HQETFormFactorBase(const Parameters & p, const Options & o, const std::string & prefix) :
        ...
        _opt_lp_zorder(o, option_specifications, "z-order-lp"),
        ...
        _opt_slp_zorder(o, option_specifications, "z-order-slp"),
        _enable_slp_z2(1.0 ? _opt_slp_zorder.value() >= 2 : 0.0),
        _opt_sslp_zorder(o, option_specifications, "z-order-sslp"),
        _enable_sslp_z1(1.0 ? _opt_sslp_zorder.value() >= 1 : 0.0),
        _enable_sslp_z2(1.0 ? _opt_sslp_zorder.value() >= 2 : 0.0),
        _opt_sslp_limit(o, option_specifications, "SU3F-limit-sslp"),
    ...
    {
        { "z-order-lp",      { "2", "3", "4", "5" }, "3"     },
        { "z-order-slp",     { "1", "2" },           "2"     },
        { "z-order-sslp",    { "0", "1", "2" },      "1"     },
        { "SU3F-limit-sslp", { "true", "false" },    "false" }
    };
