...
namespace eos
{
    template <> struct AnalyticFormFactorBToVLCSRTraits<BsToDsstar>
    {
            ...
            static const constexpr char *                               f_V                 = "decay-constant::D_s^*";
    ...
    template class AnalyticFormFactorBToVLCSR<BsToDsstar>;
} // namespace eos
