...
namespace eos
{
    ...
    struct Implementation<AnalyticFormFactorBToPLCSR<Process_>>
    {
        ...
        Implementation(const Parameters & p, const Options & o, ParameterUser & u) :
            ...
            s0_0_p(p["B->" + stringify(Process_::P) + "::s_0^+,0@B-LCSR"], u),
            s0_1_p(p["B->" + stringify(Process_::P) + "::s_0^+,1@B-LCSR"], u),
            s0_0_pm(p["B->" + stringify(Process_::P) + "::s_0^+/-,0@B-LCSR"], u),
            s0_1_pm(p["B->" + stringify(Process_::P) + "::s_0^+/-,1@B-LCSR"], u),
            s0_0_t(p["B->" + stringify(Process_::P) + "::s_0^T,0@B-LCSR"], u),
            s0_1_t(p["B->" + stringify(Process_::P) + "::s_0^T,1@B-LCSR"], u),
            M2(p["B->" + stringify(Process_::P) + "::M^2@B-LCSR"], u),
            mu(p["B->" + stringify(Process_::P) + "::mu@B-LCSR"], u),
            b_lcdas(p, o),
