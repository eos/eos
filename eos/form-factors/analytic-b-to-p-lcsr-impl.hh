...
namespace eos
{
    ...
    template <typename Transition_> struct Implementation<AnalyticFormFactorBToPLCSR<Transition_>>
    {
            ...
            switch_borel(opt_method.value() == "borel")
            {
                ...
                {
                    case QuarkFlavor::up:
                    case QuarkFlavor::down: m_v = [this]() -> double { return this->model->m_ud_msbar(this->mu()) / 2.0; }; break;

                    case QuarkFlavor::strange: m_v = [this]() -> double { return this->model->m_s_msbar(this->mu()); }; break;

                    case QuarkFlavor::charm: m_v = [this]() -> double { return this->model->m_c_msbar(this->mu()); }; break;

                    default: throw InternalError("Unknown valence quark flavor: '" + stringify(q_v) + "'");
                }
            ...
            inline double
            phi_plus(const double & omega) const
            {
                return switch_2pt_phi * b_lcdas->phi_plus(omega);
            }

            inline double
            phi_bar(const double & omega) const
            {
                return switch_2pt_phi * b_lcdas->phi_bar(omega);
            }

            inline double
            phi_bar_d1(const double & omega) const
            {
                return switch_2pt_phi * b_lcdas->phi_bar_d1(omega);
            }

            inline double
            g_plus(const double & omega) const
            {
                return switch_2pt_g * b_lcdas->g_plus(omega);
            }

            inline double
            g_plus_d1(const double & omega) const
            {
                return switch_2pt_g * b_lcdas->g_plus_d1(omega);
            }

            inline double
            g_plus_d2(const double & omega) const
            {
                return switch_2pt_g * b_lcdas->g_plus_d2(omega);
            }

            inline double
            g_bar(const double & omega) const
            {
                return switch_2pt_g * b_lcdas->g_bar(omega);
            }

            inline double
            g_bar_d1(const double & omega) const
            {
                return switch_2pt_g * b_lcdas->g_bar_d1(omega);
            }

            inline double
            g_bar_d2(const double & omega) const
            {
                return switch_2pt_g * b_lcdas->g_bar_d2(omega);
            }

            inline double
            g_bar_d3(const double & omega) const
            {
                return switch_2pt_g * b_lcdas->g_bar_d3(omega);
            }

            inline double
            phi_3(const double omega_1, const double omega_2) const
            {
                return switch_3pt * b_lcdas->phi_3(omega_1, omega_2);
            }

            inline double
            phi_bar_3(const double omega_1, const double omega_2) const
            {
                return switch_3pt * b_lcdas->phi_bar_3(omega_1, omega_2);
            }

            inline double
            phi_bar2_3(const double omega_1, const double omega_2) const
            {
                return switch_3pt * b_lcdas->phi_bar2_3(omega_1, omega_2);
            }

            inline double
            phi_bar_bar_3(const double omega_1, const double omega_2) const
            {
                return switch_3pt * b_lcdas->phi_bar_bar_3(omega_1, omega_2);
            }

            inline double
            phi_4(const double omega_1, const double omega_2) const
            {
                return switch_3pt * b_lcdas->phi_4(omega_1, omega_2);
            }

            inline double
            phi_bar_4(const double omega_1, const double omega_2) const
            {
                return switch_3pt * b_lcdas->phi_bar_4(omega_1, omega_2);
            }

            inline double
            phi_bar2_4(const double omega_1, const double omega_2) const
            {
                return switch_3pt * b_lcdas->phi_bar2_4(omega_1, omega_2);
            }

            inline double
            phi_bar_bar_4(const double omega_1, const double omega_2) const
            {
                return switch_3pt * b_lcdas->phi_bar_bar_4(omega_1, omega_2);
            }

            inline double
            psi_bar_4(const double omega_1, const double omega_2) const
            {
                return switch_3pt * b_lcdas->psi_bar_4(omega_1, omega_2);
            }

            inline double
            psi_bar_bar_4(const double omega_1, const double omega_2) const
            {
                return switch_3pt * b_lcdas->psi_bar_bar_4(omega_1, omega_2);
            }

            inline double
            chi_bar_4(const double omega_1, const double omega_2) const
            {
                return switch_3pt * b_lcdas->chi_bar_4(omega_1, omega_2);
            }

            inline double
            chi_bar_bar_4(const double omega_1, const double omega_2) const
            {
            ...
            double
            s(const double & sigma, const double & q2) const
            {
            ...
            double
            sigma(const double & s, const double & q2) const
            {
            ...
            double
            sigma_0(const double & q2, const double & s0_0, const double & s0_1) const
            {
            ...
            inline double
            I1_fp_2pt_phi_p(const double & sigma, const double & /*q2*/) const
            {
            ...
            inline double
            I2_fp_2pt_phi_bar(const double & sigma, const double & /*q2*/) const
            {
            ...
            inline double
            I2d1_fp_2pt_phi_bar(const double & sigma, const double & /*q2*/) const
            {
            ...
            inline double
            I2_fp_2pt_g_p(const double & sigma, const double & /*q2*/) const
            {
            ...
            inline double
            I2d1_fp_2pt_g_p(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_+ proportional to g_+
                const double sigmabar = 1.0 - sigma;
            ...
            inline double
            I3_fp_2pt_g_p(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_+ proportional to g_+
                const double m_v2     = power_of<2>(m_v());
                const double sigmabar = 1.0 - sigma;
            ...
            inline double
            I3d1_fp_2pt_g_p(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_+ proportional to g_+
                const double m_v2     = power_of<2>(m_v());
                const double sigmabar = 1.0 - sigma;
            ...
            inline double
            I3d2_fp_2pt_g_p(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_+ proportional to g_+
                const double m_v2     = power_of<2>(m_v());
                const double sigmabar = 1.0 - sigma;
            ...
            inline double
            I3_fp_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
            ...
            inline double
            I3d1_fp_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_+ proportional to g_bar
                const double sigmabar = 1.0 - sigma;
            ...
            inline double
            I3d2_fp_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_+ proportional to g_bar
                const double m_B2     = power_of<2>(m_B());
                const double sigmabar = 1.0 - sigma;
            ...
            inline double
            I4_fp_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_+ proportional to g_bar
                const double m_v2     = power_of<2>(m_v());
                const double sigmabar = 1.0 - sigma;
            ...
            inline double
            I4d1_fp_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_+ proportional to g_bar
                const double m_v2     = power_of<2>(m_v());
                const double sigmabar = 1.0 - sigma;
            ...
            inline double
            I4d2_fp_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_+ proportional to g_bar
                const double m_v2     = power_of<2>(m_v());
                const double sigmabar = 1.0 - sigma;
            ...
            inline double
            I4d3_fp_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_+ proportional to g_bar
                const double m_v2     = power_of<2>(m_v());
                const double sigmabar = 1.0 - sigma;
                ...
                return 24.0 * m_B() * m_v2 * (g_bar_d3 * power_of<3>(sigmabar) + 6.0 * g_bar_d2 * power_of<2>(sigmabar) + 18.0 * g_bar_d1 * sigmabar + 24.0 * g_bar)
                       / power_of<5>(sigmabar);
            }
            ...
            // {{{
            double
            I2_fp_3pt_phi_3(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I2_fp_3pt_phi_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I3_fp_3pt_phi_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_3
                const double m_B2 = power_of<2>(m_B);
                ...
                const double C_3 = -2.0 * (u * (m_B2 * sigmabar2 + q2) + 4.0 * m_B * m_v * sigmabar + m_v2 * u) / (m_B * power_of<3>(sigmabar));

                return C_3 * phi_bar_3;
            }

            double
            I3d1A_fp_3pt_phi_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_3
            ...
            double
            I3d1B_fp_3pt_phi_bar_3(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_3
                ...
                const double C_3 = (2.0 * (sigma - 2.0) * sigmabar * (2.0 * m_B2 * sigma - q2) + 4.0 * m_B2 * sigmabar + 8.0 * m_B * m_v * sigmabar * (-sigma + sigmabar + 1.0)
                                    + m_v2 * (sigma + 5.0 * sigmabar - 1.0) - 2.0 * q2 * (sigma - 1.0) * sigma)
            ...
            double
            I3d1C_fp_3pt_phi_bar_3(const double & sigma, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_3
            ...
            double
            I4_fp_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                ...
                const double C_4 = -6.0 * m_v * u * (2.0 * m_B * sigmabar + m_v * (2.0 * u - 1.0)) / (power_of<3>(sigmabar));

                return C_4 * phi_bar_bar_3;
            }

            double
            I4d1A_fp_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_3
                const double m_v      = this->m_v();
            ...
            double
            I4d1B_fp_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_3
                const double omega_2 = m_B * sigma - omega_1;
                ...
                const double C_4 = 6.0 * m_v * (m_B - m_B * sigma) * (2.0 * m_B * sigmabar + m_v) / (power_of<4>(sigmabar) * omega_2);

                return C_4 * phi_bar_bar_3;
            }

            double
            I4d1C_fp_3pt_phi_bar_bar_3(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_3
            ...
            double
            I4d2A_fp_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_3
                const double m_v      = this->m_v();
                const double sigma2   = power_of<2>(sigma);
            ...
            double
            I4d2B_fp_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_3
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return 6.0 * m_B * m_v
                       * (2.0
                                  * (4.0 * m_B * (-m_v + 2.0 * m_B * (-1 + sigma)) * (-1 + sigma) * sigma
                                  ...
                                  * phi_bar_bar_3
                          + m_B * (-m_v + 2.0 * m_B * (-1 + sigma)) * (-1 + sigma) * (-omega_1 + m_B * sigma) * sigmabar * phi_bar_3)
                       / (power_of<2>(omega_2) * power_of<5>(sigmabar));
            }

            double
            I4d2C_fp_3pt_phi_bar_bar_3(const double & sigma, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_3
                const double omega_1 = m_B * sigma;
            ...
            double
            I4d2D_fp_3pt_phi_bar_bar_3(const double & sigma, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_3
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return (6.0 * m_v * ((-4.0 * m_B * sigmabar - m_v) * phi_bar_bar_3 - m_B * sigmabar * (-2.0 * m_B * sigmabar - m_v) * phi_bar_3)) / (power_of<4>(sigmabar));
            }

            double
            I2_fp_3pt_phi_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I2_fp_3pt_phi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I3_fp_3pt_phi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
                ...
                const double C_3 = 2.0 * (m_B2 * sigmabar2 * u + 2.0 * m_B * m_v * sigmabar + m_v2 * (-(u - 1.0)) - q2 * u + q2) / (m_B * power_of<3>(sigmabar));

                return C_3 * phi_bar_4;
            }

            double
            I3d1A_fp_3pt_phi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I3d1B_fp_3pt_phi_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_4
                const double omega_2 = m_B * sigma - omega_1;
                ...
                const double C_3 = -2.0 * m_B * (m_B * sigmabar2 + 2.0 * m_v * sigmabar) / ((-omega_1 + m_B * sigma) * power_of<3>(sigmabar));

                return C_3 * phi_bar_4;
            }

            double
            I3d1C_fp_3pt_phi_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_4
                const double omega_1 = m_B * sigma;
                ...
                const double C_3 = (2.0 * sigmabar * (2.0 * m_B * m_v * sigmabar + m_v2 + q2) - q2 * sigma2 + sigma * (q2 - q2 * sigmabar)) / (omega_2 * power_of<4>(sigmabar));

                return C_3 * phi_bar_4;
            }

            double
            I3_fp_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                ...
                const double C_3 = 2.0 * u * (m_B * sigmabar * (2.0 * u - 1.0) + 2.0 * m_v) / (m_B * power_of<3>(sigmabar));

                return C_3 * phi_bar_bar_4;
            }

            double
            I3d1A_fp_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double m_v      = this->m_v();
                ...
                const double C_3 = 2.0
                                   * (4.0 * m_B3 * sigma2 * sigmabar - m_B2 * sigmabar2 * (omega_2 + 4.0 * omega_1)
            ...
            double
            I3d1B_fp_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
                ...
                const double C_3 = -2.0 * (m_B * sigmabar + 2.0 * m_v) / ((-omega_1 + m_B * sigma) * power_of<3>(sigmabar));

                return C_3 * phi_bar_bar_4;
            }

            double
            I3d1C_fp_3pt_phi_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_4
            ...
            double
            I4_fp_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_4
                const double m_B2     = power_of<2>(m_B);
                const double m_v      = this->m_v();
                ...
                const double C_4 = 6.0 * u * (m_B2 * sigmabar2 - q2) * (m_B * sigmabar * (2.0 * u - 1.0) + 2.0 * m_v) / (m_B * power_of<4>(sigmabar));

                return C_4 * phi_bar_bar_4;
            }

            double
            I4d1A_fp_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_4
            ...
            double
            I4d1B_fp_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
                ...
                const double C_4 = -6.0 * (m_B * sigmabar + 2.0 * m_v) * (m_B2 * sigmabar2 - q2) / (power_of<4>(sigmabar) * omega_2);

                return C_4 * phi_bar_bar_4;
            }

            double
            I4d1C_fp_3pt_phi_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_4
            ...
            double
            I4d2A_fp_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B), m_B5 = power_of<5>(m_B);
                const double m_v    = this->m_v();
            ...
            double
            I4d2B_fp_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d2C_fp_3pt_phi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_4
                const double omega_1 = m_B * sigma;
                ...
                const double C_4 = -6.0 * m_B * (m_B * sigmabar - 2.0 * m_v) * (m_B2 * sigmabar2 - q2) / (power_of<2>(omega_2) * power_of<4>(sigmabar));

                return C_4 * phi_bar_bar_4;
            }

            double
            I4d2D_fp_3pt_phi_bar_bar_4(const double & sigma, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to phi_bar_bar_4
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return -(6.0 * pow(sigmabar, -4.0)
                         * ((q2 - m_B * sigmabar * (m_B + 4.0 * m_v - m_B * sigma + 2.0 * m_B * sigmabar)) * phi_bar_bar_4
                            + (m_B2 * sigmabar2 - q2) * (2.0 * m_v + m_B * sigmabar) * phi_bar_4));
            }

            double
            I2_fp_3pt_psi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I3_fp_3pt_psi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
                ...
                const double C_3 = 2.0 * (2.0 * u - 1.0) * (-m_B2 * sigmabar2 + m_v2 + q2) / (m_B * power_of<3>(sigmabar));

                return C_3 * psi_bar_4;
            }

            double
            I3d1A_fp_3pt_psi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
                ...
                const double C_3 =
                        -(2.0
                          * (6.0 * m_B3 * sigma3 + 3.0 * (2.0 * omega_1 + omega_2) * (m_v2 + q2) + 2.0 * m_B3 * sigmabar - 2.0 * m_B * (m_v2 + q2) * sigmabar
                             + m_B2 * (2.0 * omega_1 + omega_2) * (-3.0 + 2.0 * sigmabar) + 3.0 * m_B2 * sigma2 * (-(2.0 * omega_1) - omega_2 + 2.0 * m_B * (-2.0 + sigmabar))
                             - 2.0 * m_B * sigma * (3.0 * (m_v2 + q2) + m_B * (2.0 * omega_1 + omega_2) * (-3.0 + sigmabar) + m_B2 * (-3.0 + 4.0 * sigmabar))))
            ...
            double
            I3d1B_fp_3pt_psi_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3d1C_fp_3pt_psi_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I4_fp_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I4d1A_fp_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double m_v      = this->m_v();
                const double sigma2   = power_of<2>(sigma);
            ...
            double
            I4d1B_fp_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d1C_fp_3pt_psiA_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
            ...
            double
            I4d2A_fp_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double m_v      = this->m_v();
                const double sigma2   = power_of<2>(sigma);
            ...
            double
            I4d2B_fp_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return 6.0 * m_B * m_v
                       * (2.0
                                  * (4.0 * m_B * (-m_v + 2.0 * m_B * (-1 + sigma)) * (-1 + sigma) * sigma
                                     ...
                                     + omega_1 * (-(4.0 * m_B * (-1 + sigma) * (-2.0 + 2.0 * sigma + sigmabar)) + m_v * (-4.0 + 4.0 * sigma + sigmabar)))
                                  * psi_bar_bar_4
                          + m_B * (-m_v + 2.0 * m_B * (-1 + sigma)) * (-1 + sigma) * (-omega_1 + m_B * sigma) * sigmabar * psi_bar_4)
                       / (power_of<2>(omega_2) * power_of<5>(sigmabar));
            }

            double
            I4d2C_fp_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I4d2D_fp_3pt_psiA_bar_bar_4(const double & sigma, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return (6.0 * m_v * ((-4.0 * m_B * sigmabar - m_v) * psi_bar_bar_4 - m_B * sigmabar * (-2.0 * m_B * sigmabar - m_v) * psi_bar_4)) / (power_of<4>(sigmabar));
            }

            double
            I3_fp_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double m_v      = this->m_v();
                const double sigmabar = 1.0 - sigma;
            ...
            double
            I3d1A_fp_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double m_v      = this->m_v();
            ...
            double
            I3d1B_fp_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3d1C_fp_3pt_psiB_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
            ...
            double
            I4_fp_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double m_B2     = power_of<2>(m_B);
                const double m_v      = this->m_v();
            ...
            double
            I4d1A_fp_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B), m_B5 = power_of<5>(m_B);
                const double m_v    = this->m_v();
            ...
            double
            I4d1B_fp_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d1C_fp_3pt_psiB_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
            ...
            double
            I4d2A_fp_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B), m_B5 = power_of<5>(m_B);
                const double m_v    = this->m_v();
            ...
            double
            I4d2B_fp_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d2C_fp_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I4d2D_fp_3pt_psiB_bar_bar_4(const double & sigma, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to psi_bar_bar_4
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return -(6.0 * pow(sigmabar, -4.0)
                         * ((q2 - m_B * sigmabar * (m_B + 4.0 * m_v - m_B * sigma + 2.0 * m_B * sigmabar)) * psi_bar_bar_4
                            + (m_B2 * sigmabar2 - q2) * (2.0 * m_v + m_B * sigmabar) * psi_bar_4));
            }

            double
            I3_fp_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -0.0 - I3_fp_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I3d1A_fp_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -0.0 - I3d1A_fp_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I3d1B_fp_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return -0.0 - I3d1B_fp_3pt_psiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I3d1C_fp_3pt_psi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return -0.0 - I3d1C_fp_3pt_psiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4_fp_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -I4_fp_3pt_psiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4_fp_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d1A_fp_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -I4d1A_fp_3pt_psiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4d1A_fp_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d1B_fp_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return -I4d1B_fp_3pt_psiA_bar_bar_4(sigma, omega_1, q2) - I4d1B_fp_3pt_psiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I4d1C_fp_3pt_psi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return -I4d1C_fp_3pt_psiA_bar_bar_4(sigma, omega_2, q2) - I4d1C_fp_3pt_psiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4d2A_fp_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -I4d2A_fp_3pt_psiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4d2A_fp_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d2B_fp_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return -I4d2B_fp_3pt_psiA_bar_bar_4(sigma, omega_1, q2) - I4d2B_fp_3pt_psiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I4d2C_fp_3pt_psi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return -I4d2C_fp_3pt_psiA_bar_bar_4(sigma, omega_2, q2) - I4d2C_fp_3pt_psiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4d2D_fp_3pt_psi_bar_bar_4(const double & sigma, const double & q2) const
            {
                return -I4d2D_fp_3pt_psiA_bar_bar_4(sigma, q2) - I4d2D_fp_3pt_psiB_bar_bar_4(sigma, q2);
            }

            double
            I2_fp_3pt_chi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I3_fp_3pt_chi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
                ...
                const double C_3 = -2.0 * (m_B2 * sigmabar2 * (2.0 * u - 1.0) + 4.0 * m_B * m_v * sigmabar + m_v2 + q2) / (m_B * power_of<3>(sigmabar));

                return C_3 * chi_bar_4;
            }

            double
            I3d1A_fp_3pt_chi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
                ...
                const double C_3 = 2.0
                                   * (2.0 * omega_2 * sigma2 * q2 - 2.0 * m_B3 * sigmabar3 * sigma + 2.0 * omega_2 * q2 * sigma * (-1 + sigmabar)
                                      + sigmabar
                                                * (-(3.0 * m_v2 * omega_2) - 3.0 * omega_2 * q2 - 8.0 * m_B * m_v * omega_2 * sigmabar
            ...
            double
            I3d1B_fp_3pt_chi_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3d1C_fp_3pt_chi_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I4_fp_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I4d1A_fp_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double m_v      = this->m_v();
                const double sigma2   = power_of<2>(sigma);
            ...
            double
            I4d1B_fp_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d1C_fp_3pt_chiA_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
            ...
            double
            I4d2A_fp_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double m_v      = this->m_v();
                const double sigma2   = power_of<2>(sigma);
            ...
            double
            I4d2B_fp_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return 6.0 * m_B * m_v
                       * (2.0
                                  * (4.0 * m_B * (-m_v + 2.0 * m_B * (-1 + sigma)) * (-1 + sigma) * sigma
                                     ...
                                     + omega_1 * (-(4.0 * m_B * (-1 + sigma) * (-2.0 + 2.0 * sigma + sigmabar)) + m_v * (-4.0 + 4.0 * sigma + sigmabar)))
                                  * chi_bar_bar_4
                          + m_B * (-m_v + 2.0 * m_B * (-1 + sigma)) * (-1 + sigma) * (-omega_1 + m_B * sigma) * sigmabar * chi_bar_4)
                       / (power_of<2>(omega_2) * power_of<5>(sigmabar));
            }

            double
            I4d2C_fp_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I4d2D_fp_3pt_chiA_bar_bar_4(const double & sigma, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return (6.0 * m_v * ((-4.0 * m_B * sigmabar - m_v) * chi_bar_bar_4 - m_B * sigmabar * (-2.0 * m_B * sigmabar - m_v) * chi_bar_4)) / (power_of<4>(sigmabar));
            }

            double
            I3_fp_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double m_v      = this->m_v();
                const double sigmabar = 1.0 - sigma;
            ...
            double
            I3d1A_fp_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double m_v      = this->m_v();
            ...
            double
            I3d1B_fp_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3d1C_fp_3pt_chiB_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
            ...
            double
            I4_fp_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double m_B2     = power_of<2>(m_B);
                const double m_v      = this->m_v();
            ...
            double
            I4d1A_fp_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B), m_B5 = power_of<5>(m_B);
                const double m_v    = this->m_v();
            ...
            double
            I4d1B_fp_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d1C_fp_3pt_chiB_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
            ...
            double
            I4d2A_fp_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B), m_B5 = power_of<5>(m_B);
                const double m_v    = this->m_v();
            ...
            double
            I4d2B_fp_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d2C_fp_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I4d2D_fp_3pt_chiB_bar_bar_4(const double & sigma, const double & q2) const
            {
                // three-particle contribution to f_+ proportional to chi_bar_bar_4
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return -(6.0 * pow(sigmabar, -4.0)
                         * ((q2 - m_B * sigmabar * (m_B + 4.0 * m_v - m_B * sigma + 2.0 * m_B * sigmabar)) * chi_bar_bar_4
                            + (m_B2 * sigmabar2 - q2) * (2.0 * m_v + m_B * sigmabar) * chi_bar_4));
            }

            double
            I3_fp_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +0.0 - I3_fp_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I3d1A_fp_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +0.0 - I3d1A_fp_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I3d1B_fp_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return +0.0 - I3d1B_fp_3pt_chiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I3d1C_fp_3pt_chi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return +0.0 - I3d1C_fp_3pt_chiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4_fp_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +I4_fp_3pt_chiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4_fp_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d1A_fp_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +I4d1A_fp_3pt_chiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4d1A_fp_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d1B_fp_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return +I4d1B_fp_3pt_chiA_bar_bar_4(sigma, omega_1, q2) - I4d1B_fp_3pt_chiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I4d1C_fp_3pt_chi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return +I4d1C_fp_3pt_chiA_bar_bar_4(sigma, omega_2, q2) - I4d1C_fp_3pt_chiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4d2A_fp_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +I4d2A_fp_3pt_chiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4d2A_fp_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d2B_fp_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return +I4d2B_fp_3pt_chiA_bar_bar_4(sigma, omega_1, q2) - I4d2B_fp_3pt_chiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I4d2C_fp_3pt_chi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return +I4d2C_fp_3pt_chiA_bar_bar_4(sigma, omega_2, q2) - I4d2C_fp_3pt_chiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4d2D_fp_3pt_chi_bar_bar_4(const double & sigma, const double & q2) const
            {
            ...
            // {{{
            double
            integrand_fp_2pt_disp(const double & sigma, const double & q2) const
            {
            ...
            double
            integrand_fp_2pt_borel(const double & sigma, const double & q2) const
            {
                const double m_P2 = power_of<2>(m_P());
            ...
            double
            surface_fp_2pt(const double & sigma, const double & q2) const
            {
                const double m_B2 = power_of<2>(m_B()), m_B4 = power_of<4>(m_B()), m_B6 = power_of<6>(m_B());
                const double m_P2 = power_of<2>(m_P());
                const double m_v2 = power_of<2>(m_v());
             ...
             */
            double
            integrand_fp_3pt(const std::array<double, 3> & args, const double & q2) const
            {
                ...
                const double     I2 = I2_fp_3pt_phi_3(sigma, omega_1, omega_2, q2) + I2_fp_3pt_phi_bar_3(sigma, omega_1, omega_2, q2) + I2_fp_3pt_phi_4(sigma, omega_1, omega_2, q2)
                                  + I2_fp_3pt_phi_bar_4(sigma, omega_1, omega_2, q2) + I2_fp_3pt_psi_bar_4(sigma, omega_1, omega_2, q2)
                                  + I2_fp_3pt_chi_bar_4(sigma, omega_1, omega_2, q2);
                const double I3 = I3_fp_3pt_phi_bar_3(sigma, omega_1, omega_2, q2) + I3_fp_3pt_phi_bar_4(sigma, omega_1, omega_2, q2)
                                  + I3_fp_3pt_phi_bar_bar_4(sigma, omega_1, omega_2, q2) + I3_fp_3pt_psi_bar_4(sigma, omega_1, omega_2, q2)
                                  + I3_fp_3pt_chi_bar_4(sigma, omega_1, omega_2, q2) + I3_fp_3pt_psi_bar_bar_4(sigma, omega_1, omega_2, q2)
                                  + I3_fp_3pt_chi_bar_bar_4(sigma, omega_1, omega_2, q2);
            ...
            double
            surface_fp_3pt_A(const std::array<double, 2> & args, const double & sigma, const double & q2) const
            {
                ...
                const double I3 = I3_fp_3pt_phi_bar_3(sigma, omega_1, omega_2, q2) + I3_fp_3pt_phi_bar_4(sigma, omega_1, omega_2, q2)
                                  ...
                                  + I3_fp_3pt_chi_bar_4(sigma, omega_1, omega_2, q2) + I3_fp_3pt_psi_bar_bar_4(sigma, omega_1, omega_2, q2)
                                  + I3_fp_3pt_chi_bar_bar_4(sigma, omega_1, omega_2, q2);
                const double I3d1 = I3d1A_fp_3pt_phi_bar_3(sigma, omega_1, omega_2, q2) + I3d1A_fp_3pt_phi_bar_4(sigma, omega_1, omega_2, q2)
                                    + I3d1A_fp_3pt_phi_bar_bar_4(sigma, omega_1, omega_2, q2) + I3d1A_fp_3pt_psi_bar_4(sigma, omega_1, omega_2, q2)
                                    + I3d1A_fp_3pt_chi_bar_4(sigma, omega_1, omega_2, q2) + I3d1A_fp_3pt_psi_bar_bar_4(sigma, omega_1, omega_2, q2)
                                    + I3d1A_fp_3pt_chi_bar_bar_4(sigma, omega_1, omega_2, q2);
                const double I4 = I4_fp_3pt_phi_bar_bar_3(sigma, omega_1, omega_2, q2) + I4_fp_3pt_phi_bar_bar_4(sigma, omega_1, omega_2, q2)
                                  + I4_fp_3pt_psi_bar_bar_4(sigma, omega_1, omega_2, q2) + I4_fp_3pt_chi_bar_bar_4(sigma, omega_1, omega_2, q2);
            ...
            double
            surface_fp_3pt_B(const double & x_1, const double & sigma, const double & q2) const
            {
                ...
                const double     I3d1 = I3d1B_fp_3pt_phi_bar_3(sigma, omega_1, q2) + I3d1B_fp_3pt_phi_bar_4(sigma, omega_1, q2) + I3d1B_fp_3pt_phi_bar_bar_4(sigma, omega_1, q2)
                                    + I3d1B_fp_3pt_psi_bar_4(sigma, omega_1, q2) + I3d1B_fp_3pt_chi_bar_4(sigma, omega_1, q2) + I3d1B_fp_3pt_psi_bar_bar_4(sigma, omega_1, q2)
                                    + I3d1B_fp_3pt_chi_bar_bar_4(sigma, omega_1, q2);
                constexpr double I4 = 0.0;
                const double I4d1 = I4d1B_fp_3pt_phi_bar_bar_3(sigma, omega_1, q2) + I4d1B_fp_3pt_phi_bar_bar_4(sigma, omega_1, q2) + I4d1B_fp_3pt_psi_bar_bar_4(sigma, omega_1, q2)
                                    + I4d1B_fp_3pt_chi_bar_bar_4(sigma, omega_1, q2);
                const double I4d2 = I4d2B_fp_3pt_phi_bar_bar_3(sigma, omega_1, q2) + I4d2B_fp_3pt_phi_bar_bar_4(sigma, omega_1, q2) + I4d2B_fp_3pt_psi_bar_bar_4(sigma, omega_1, q2)
                                    + I4d2B_fp_3pt_chi_bar_bar_4(sigma, omega_1, q2);
            ...
            double
            surface_fp_3pt_C(const double & x_2, const double & sigma, const double & q2) const
            {
                const double xbar_2 = 1.0 - x_2;
                ...
                constexpr double I2   = 0.0;
                constexpr double I3   = 0.0;
                const double     I3d1 = I3d1C_fp_3pt_phi_bar_3(sigma, omega_2, q2) + I3d1C_fp_3pt_phi_bar_4(sigma, omega_2, q2) + I3d1C_fp_3pt_phi_bar_bar_4(sigma, omega_2, q2)
                                    + I3d1C_fp_3pt_psi_bar_4(sigma, omega_2, q2) + I3d1C_fp_3pt_chi_bar_4(sigma, omega_2, q2) + I3d1C_fp_3pt_psi_bar_bar_4(sigma, omega_2, q2)
                                    + I3d1C_fp_3pt_chi_bar_bar_4(sigma, omega_2, q2);
                constexpr double I4 = 0.0;
                const double I4d1 = I4d1C_fp_3pt_phi_bar_bar_3(sigma, omega_2, q2) + I4d1C_fp_3pt_phi_bar_bar_4(sigma, omega_2, q2) + I4d1C_fp_3pt_psi_bar_bar_4(sigma, omega_2, q2)
                                    + I4d1C_fp_3pt_chi_bar_bar_4(sigma, omega_2, q2);
                const double I4d2 = I4d2C_fp_3pt_phi_bar_bar_3(sigma, omega_2, q2) + I4d2C_fp_3pt_phi_bar_bar_4(sigma, omega_2, q2) + I4d2C_fp_3pt_psi_bar_bar_4(sigma, omega_2, q2)
                                    + I4d2C_fp_3pt_chi_bar_bar_4(sigma, omega_2, q2);
            ...
            double
            surface_fp_3pt_D(const double & sigma, const double & q2) const
            {
                ...
                const double     I4d2 = I4d2D_fp_3pt_phi_bar_bar_3(sigma, q2) + I4d2D_fp_3pt_phi_bar_bar_4(sigma, q2) + I4d2D_fp_3pt_psi_bar_bar_4(sigma, q2)
                                    + I4d2D_fp_3pt_chi_bar_bar_4(sigma, q2);
            ...
            double
            integrand_fp_2pt_borel_m1(const double & sigma, const double & q2) const
            {
                const double m_P2 = power_of<2>(m_P());
                const double M4 = power_of<2>(M2), M6 = power_of<3>(M2);
                const double exp = std::exp((-s(sigma, q2) + m_P2) / M2());
            ...
            double
            surface_fp_2pt_m1(const double & sigma, const double & q2) const
            {
                const double m_B2 = power_of<2>(m_B()), m_B4 = power_of<4>(m_B()), m_B6 = power_of<6>(m_B());
                const double m_v2 = power_of<2>(m_v());
                const double M4   = power_of<2>(M2);
            ...
            double
            integrand_fp_3pt_m1(const std::array<double, 3> & args, const double & q2) const
            {
                const double sigma  = args[0];
                const double x_1    = args[1];
                const double x_2    = args[2];
            ...
            double
            surface_fp_3pt_A_m1(const std::array<double, 2> & args, const double & sigma, const double & q2) const
            {
                const double x_1    = args[0];
                const double x_2    = args[1];
                const double xbar_1 = 1.0 - x_1;
            ...
            double
            surface_fp_3pt_B_m1(const double & x_1, const double & sigma, const double & q2) const
            {
                // this ONLY includes the Jacobian from the transformation (omega_1 -> x_1).
                const double prefactor = sigma * m_B();
            ...
            double
            surface_fp_3pt_C_m1(const double & x_2, const double & sigma, const double & q2) const
            {
                const double xbar_2 = 1.0 - x_2;
            ...
            double
            surface_fp_3pt_D_m1(const double & sigma, const double & q2) const
            {
                // this does NOT includes the original factor of 1 / omega_2
                const double prefactor = 1.0;
            ...
            f_p(const double & q2) const
            {
                ...
                if (switch_3pt != 0.0)
                {
                    const cubature::integrand<1> surface_3pt_B = std::bind(&Implementation::surface_fp_3pt_B, this, std::placeholders::_1, sigma_0, q2);
                    const cubature::integrand<1> surface_3pt_C = std::bind(&Implementation::surface_fp_3pt_C, this, std::placeholders::_1, sigma_0, q2);
                    const cubature::integrand<3> integrand_3pt = std::bind(&Implementation::integrand_fp_3pt, this, std::placeholders::_1, q2);
                    const cubature::integrand<2> surface_3pt_A = std::bind(&Implementation::surface_fp_3pt_A, this, std::placeholders::_1, sigma_0, q2);

                    integral_3pt = integrate<3>(integrand_3pt, { 0.0, 0.0, 0.0 }, { sigma_0, 1.0, 1.0 }, cubature::Config());
                    surface_3pt  = 0.0 - integrate<2>(surface_3pt_A, { 0.0, 0.0 }, { 1.0, 1.0 }, cubature::Config()) // integrate over x_1 and x_2
            ...
            double
            normalized_moment_1_f_p(const double & q2) const
            {
                const double sigma_0 = this->sigma_0(q2, s0_0_p(), s0_1_p());
                ...
                if (switch_3pt != 0.0)
                {
                    const cubature::integrand<1> surface_3pt_B_m1 = std::bind(&Implementation::surface_fp_3pt_B_m1, this, std::placeholders::_1, sigma_0, q2);
                    const cubature::integrand<1> surface_3pt_C_m1 = std::bind(&Implementation::surface_fp_3pt_C_m1, this, std::placeholders::_1, sigma_0, q2);
                    const cubature::integrand<3> integrand_3pt_m1 = std::bind(&Implementation::integrand_fp_3pt_m1, this, std::placeholders::_1, q2);
                    const cubature::integrand<2> surface_3pt_A_m1 = std::bind(&Implementation::surface_fp_3pt_A_m1, this, std::placeholders::_1, sigma_0, q2);

                    integral_3pt_m1 = integrate<3>(integrand_3pt_m1, { 0.0, 0.0, 0.0 }, { sigma_0, 1.0, 1.0 }, cubature::Config());
                    surface_3pt_m1  = 0.0 - integrate<2>(surface_3pt_A_m1, { 0.0, 0.0 }, { 1.0, 1.0 }, cubature::Config()) // integrate over x_1 and x_2
            ...
            inline double
            I1_fpm_2pt_phi_p(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_± proportional to phi_+
            ...
            inline double
            I2_fpm_2pt_phi_bar(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_± proportional to phibar
                const double sigmabar = 1.0 - sigma;
                const double m_v      = this->m_v();
            ...
            inline double
            I2d1_fpm_2pt_phi_bar(const double & sigma, const double & /*q2*/) const
            {
                // first derivative of two-particle contribution to f_± proportional to phibar
                const double sigmabar = 1.0 - sigma;
                const double m_v      = this->m_v();
            ...
            inline double
            I2_fpm_2pt_g_p(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_± proportional to g_+
                const double sigmabar = 1.0 - sigma;
            ...
            inline double
            I2d1_fpm_2pt_g_p(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_± proportional to g_+
                const double sigmabar = 1.0 - sigma;
            ...
            inline double
            I3_fpm_2pt_g_p(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_± proportional to g_+
                const double sigmabar = 1.0 - sigma;
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            inline double
            I3d1_fpm_2pt_g_p(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_± proportional to g_+
                const double sigmabar = 1.0 - sigma;
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            inline double
            I3d2_fpm_2pt_g_p(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_± proportional to g_+
                const double sigmabar = 1.0 - sigma;
                const double m_B2     = power_of<2>(m_B);
            ...
            inline double
            I3_fpm_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
            ...
            inline double
            I3d1_fpm_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_± proportional to gbar
                const double sigmabar = 1.0 - sigma;
            ...
            inline double
            I3d2_fpm_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_± proportional to gbar
                const double sigmabar = 1.0 - sigma;
                const double m_B2     = power_of<2>(m_B);
            ...
            inline double
            I4_fpm_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_± proportional to gbar
                const double sigmabar = 1.0 - sigma;
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            inline double
            I4d1_fpm_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_± proportional to gbar
                const double sigmabar = 1.0 - sigma;
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            inline double
            I4d2_fpm_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_± proportional to gbar
                const double sigmabar = 1.0 - sigma;
                const double m_B2     = power_of<2>(m_B);
            ...
            inline double
            I4d3_fpm_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_± proportional to gbar
                const double sigmabar = 1.0 - sigma;
                const double m_B2     = power_of<2>(m_B);
            ...
            // {{{
            double
            I2_fpm_3pt_phi_3(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_3
                const double m_v      = this->m_v();
                const double sigmabar = 1.0 - sigma;
            ...
            double
            I2_fpm_3pt_phi_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_3
                const double sigmabar = 1.0 - sigma;
                const double u        = (sigma * m_B() - omega_1) / omega_2;
            ...
            double
            I3_fpm_3pt_phi_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to phi_bar_3
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
                ...
                const double C_3 = -2.0
                                   * (m_B2 * sigmabar2 * (2.0 * sigmabar - 3.0) * u + 4.0 * m_B * m_v * sigmabar * (2.0 * sigmabar - 1.0) + m_v2 * (2.0 * sigmabar * u + u)
                                      + q2 * (2.0 * sigmabar - 1.0) * u)
            ...
            double
            I3d1A_fpm_3pt_phi_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to phi_bar_3
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I3d1B_fpm_3pt_phi_bar_3(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_± proportional to phi_bar_3
                const double omega_2 = m_B * sigma - omega_1;
                ...
                const double C_3 =
                        -2.0
                        * (sigmabar * (m_B2 * (-2.0 * sigma2 + sigma + 1.0) + 4.0 * m_B * m_v * (2.0 * sigma - 1.0) - 3.0 * m_v2 - q2 * sigmabar) + sigma * (q2 * sigma - m_v2))
                        / ((-omega_1 + m_B * sigma) * power_of<4>(sigmabar));
            ...
            double
            I3d1C_fpm_3pt_phi_bar_3(const double & sigma, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_3
                const double omega_1 = m_B * sigma;
            ...
            double
            I4_fpm_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_3
                const double m_v      = this->m_v();
                const double sigmabar = 1.0 - sigma;
                ...
                const double C_4 = -6.0 * m_v * u * (m_v * (2.0 * sigmabar + 1.0) * (2.0 * u - 1.0) - 4.0 * m_B * sigma * sigmabar) / (power_of<4>(sigmabar));

                return C_4 * phi_bar_bar_3;
            }

            double
            I4d1A_fpm_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_3
            ...
            double
            I4d1B_fpm_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_3
                const double omega_2 = m_B * sigma - omega_1;
                ...
                const double C_4 = 6.0 * m_v * m_B * (-4.0 * m_B * sigma * sigmabar - 2.0 * m_v * sigma + 3.0 * m_v) / (power_of<4>(sigmabar) * omega_2);

                return C_4 * phi_bar_bar_3;
            }

            double
            I4d1C_fpm_3pt_phi_bar_bar_3(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_3
            ...
            double
            I4d2A_fpm_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_3
            ...
            double
            I4d2B_fpm_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_3
                const double omega_2  = m_B * sigma - omega_1;
                const double sigma2   = power_of<2>(sigma);
                ...
                return 6.0 * m_B * m_v * pow(omega_1 - m_B * sigma, -2.0) * pow(sigmabar, -5.0)
                       * (2.0
                                  * (m_B * (3.0 * m_v + 8.0 * m_B * sigma2 - 4.0 * (m_B + m_v) * sigma) * sigmabar
                                     + 4.0 * m_B * sigma * (3.0 * m_v - 2.0 * m_v * sigma - 4.0 * m_B * sigma * sigmabar)
                                     + 2.0 * omega_1 * (-(8.0 * m_B * sigma2) + 2.0 * m_B * sigmabar + m_v * (-6.0 + sigmabar) + 4.0 * sigma * (2.0 * m_B + m_v - m_B * sigmabar)))
                                  * phi_bar_bar_3
                          + m_B * (-omega_1 + m_B * sigma) * sigmabar * (3.0 * m_v - 2.0 * m_v * sigma - 4.0 * m_B * sigma * sigmabar) * phi_bar_3);
            }

            double
            I4d2C_fpm_3pt_phi_bar_bar_3(const double & sigma, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_3
                const double omega_1 = m_B * sigma;
            ...
            double
            I4d2D_fpm_3pt_phi_bar_bar_3(const double & sigma, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_3
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return (6.0 * m_v * pow(sigmabar, -4.0)
                        * (-(2.0 * (m_v + m_B * (2.0 - 4.0 * sigma)) * phi_bar_bar_3) + m_B * (3.0 * m_v - 2.0 * m_v * sigma - 4.0 * m_B * sigma * sigmabar) * phi_bar_3));
            }

            double
            I2_fpm_3pt_phi_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_4
                const double sigmabar = 1.0 - sigma;
                const double u        = (sigma * m_B() - omega_1) / omega_2;
            ...
            double
            I2_fpm_3pt_phi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_4
                const double sigmabar = 1.0 - sigma;
                const double u        = (sigma * m_B() - omega_1) / omega_2;
            ...
            double
            I3_fpm_3pt_phi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to phi_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
                ...
                const double C_3 = -2.0
                                   * (m_B2 * sigmabar2 * (-2.0 * sigmabar * u + u + 1.0) + m_B * m_v * (1.0 - 4.0 * sigmabar) * sigmabar + m_v2 * (2.0 * sigmabar + 1.0) * (u - 1.0)
                                      + q2 * (2.0 * sigmabar - 1.0) * (u - 1.0))
                                   / (m_B * power_of<4>(sigmabar));
            ...
            double
            I3d1A_fpm_3pt_phi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to phi_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I3d1B_fpm_3pt_phi_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_4
                const double omega_2 = m_B * sigma - omega_1;
                ...
                const double C_3 = 2.0 * m_B * (2.0 * sigma * (-m_B * sigma + m_B + 2.0 * m_v) - 3.0 * m_v) / ((-omega_1 + m_B * sigma) * power_of<3>(sigmabar));

                return C_3 * phi_bar_4;
            }

            double
            I3d1C_fpm_3pt_phi_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to phi_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I3_fpm_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_4
                const double m_v      = this->m_v();
                const double sigmabar = 1.0 - sigma;
                ...
                const double C_3 = 2.0 * u * (2.0 * m_B * (sigmabar - 2.0) * sigmabar * (2.0 * u - 1.0) + m_v * (4.0 * sigmabar - 3.0)) / (m_B * power_of<4>(sigmabar));

                return C_3 * phi_bar_bar_4;
            }

            double
            I3d1A_fpm_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double m_v    = this->m_v();
            ...
            double
            I3d1B_fpm_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
                ...
                const double C_3 = -2.0 * (2.0 * m_B * (sigma2 - 1.0) - 4.0 * m_v * sigma + m_v) / ((-omega_1 + m_B * sigma) * power_of<4>(sigmabar));

                return C_3 * phi_bar_bar_4;
            }

            double
            I3d1C_fpm_3pt_phi_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_4
            ...
            double
            I4_fpm_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_4
                const double m_B2 = power_of<2>(m_B);
                ...
                const double C_4 = 6.0 * u
                                   * (m_v * (4.0 * sigmabar - 1.0) * (m_B2 * sigmabar2 - q2) - 2.0 * m_B * sigma * sigmabar * (2.0 * u - 1.0) * (m_B2 * sigmabar2 - q2)
            ...
            double
            I4d1A_fpm_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B), m_B5 = power_of<5>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v3 = power_of<3>(m_v);
            ...
            double
            I4d1B_fpm_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
                ...
                const double C_4 = 2.0
                                   * (6.0 * m_B3 * sigmabar3 * sigma + (m_v + 2.0 * m_B * (-1 + sigma2) - 4.0 * m_v * sigma) * (-m_v2 + q2 * sigma)
                                      - sigmabar
                                                * (-(4.0 * m_v3) - 2.0 * m_B * q2 * sigma * (-2.0 + sigma) + m_B * m_v2 * (5.0 + 2.0 * sigma) + m_v * q2 * (-9.0 + 4.0 * sigma)
            ...
            double
            I4d1C_fpm_3pt_phi_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_4
            ...
            double
            I4d2A_fpm_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B), m_B5 = power_of<5>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v3 = power_of<3>(m_v);
            ...
            double
            I4d2B_fpm_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d2C_fpm_3pt_phi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_4
                const double omega_1 = m_B * sigma;
                ...
                const double C_4 = 2.0 * m_B
                                   * (6.0 * m_B3 * sigmabar3 * sigma + (-m_v2 + q2 * sigma) * (2.0 * m_B * (-1 + sigma2) + m_v * (-1 + 4.0 * sigma))
                                      + sigmabar
                                                * (-(4.0 * m_v3) + 2.0 * m_B * q2 * sigma * (-2.0 + sigma) - m_B * m_v2 * (5.0 + 2.0 * sigma) + m_v * q2 * (-9.0 + 4.0 * sigma)
                                                   - 3.0 * m_B2 * m_v * (-3.0 + 4.0 * sigma) * sigmabar))
                                   / (power_of<2>(omega_2) * power_of<5>(sigmabar));
            ...
            double
            I4d2D_fpm_3pt_phi_bar_bar_4(const double & sigma, const double & q2) const
            {
                // three-particle contribution to f_± proportional to phi_bar_bar_4
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I2_fpm_3pt_psi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to psi_bar_4
                const double sigmabar = 1.0 - sigma;
                const double u        = (sigma * m_B() - omega_1) / omega_2;
            ...
            double
            I3_fpm_3pt_psi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to psi_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
                ...
                const double C_3 =
                        -2.0
                        * ((2.0 * sigmabar - 1.0) * (2.0 * u - 1.0) * (m_B2 * sigmabar2 - q2) + 2.0 * m_B * m_v * sigmabar + m_v2 * (2.0 * sigmabar + 1.0) * (-(2.0 * u - 1.0)))
                        / (m_B * power_of<4>(sigmabar));
            ...
            double
            I3d1A_fpm_3pt_psi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to psi_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I3d1B_fpm_3pt_psi_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_± proportional to psi_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3d1C_fpm_3pt_psi_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to psi_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I4_fpm_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double m_v      = this->m_v();
                const double sigmabar = 1.0 - sigma;
            ...
            double
            I4d1A_fpm_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double m_v = this->m_v(), m_B2 = m_B * m_B;
                const double sigma2 = power_of<2>(sigma), sigma3 = power_of<3>(sigma);
            ...
            double
            I4d1B_fpm_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d1C_fpm_3pt_psiA_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
            ...
            double
            I4d2A_fpm_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double m_v = this->m_v(), m_B2 = power_of<2>(m_B);
                const double sigma2 = power_of<2>(sigma), sigma3 = power_of<3>(sigma);
            ...
            double
            I4d2B_fpm_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double omega_2  = m_B * sigma - omega_1;
                const double sigma2   = power_of<2>(sigma);
            ...
            double
            I4d2C_fpm_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I4d2D_fpm_3pt_psiA_bar_bar_4(const double & sigma, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return (6.0 * m_v * pow(sigmabar, -4.0)
                        * (-(2.0 * (m_v + m_B * (2.0 - 4.0 * sigma)) * psi_bar_bar_4) + m_B * (3.0 * m_v - 2.0 * m_v * sigma - 4.0 * m_B * sigma * sigmabar) * psi_bar_4));
            }

            double
            I3_fpm_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double m_v      = this->m_v();
                const double sigmabar = 1.0 - sigma;
            ...
            double
            I3d1A_fpm_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double m_v    = this->m_v();
            ...
            double
            I3d1B_fpm_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3d1C_fpm_3pt_psiB_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
            ...
            double
            I4_fpm_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v3 = power_of<3>(m_v);
            ...
            double
            I4d1A_fpm_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B), m_B5 = power_of<5>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v3 = power_of<3>(m_v);
            ...
            double
            I4d1B_fpm_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d1C_fpm_3pt_psiB_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
            ...
            double
            I4d2A_fpm_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B), m_B5 = power_of<5>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v3 = power_of<3>(m_v);
            ...
            double
            I4d2B_fpm_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d2C_fpm_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I4d2D_fpm_3pt_psiB_bar_bar_4(const double & sigma, const double & q2) const
            {
                // three-particle contribution to f_± proportional to psi_bar_bar_4
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3_fpm_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -0.0 - I3_fpm_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I3d1A_fpm_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -0.0 - I3d1A_fpm_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I3d1B_fpm_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return -0.0 - I3d1B_fpm_3pt_psiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I3d1C_fpm_3pt_psi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return -0.0 - I3d1C_fpm_3pt_psiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4_fpm_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -I4_fpm_3pt_psiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4_fpm_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d1A_fpm_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -I4d1A_fpm_3pt_psiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4d1A_fpm_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d1B_fpm_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return -I4d1B_fpm_3pt_psiA_bar_bar_4(sigma, omega_1, q2) - I4d1B_fpm_3pt_psiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I4d1C_fpm_3pt_psi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return -I4d1C_fpm_3pt_psiA_bar_bar_4(sigma, omega_2, q2) - I4d1C_fpm_3pt_psiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4d2A_fpm_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -I4d2A_fpm_3pt_psiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4d2A_fpm_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d2B_fpm_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return -I4d2B_fpm_3pt_psiA_bar_bar_4(sigma, omega_1, q2) - I4d2B_fpm_3pt_psiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I4d2C_fpm_3pt_psi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return -I4d2C_fpm_3pt_psiA_bar_bar_4(sigma, omega_2, q2) - I4d2C_fpm_3pt_psiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4d2D_fpm_3pt_psi_bar_bar_4(const double & sigma, const double & q2) const
            {
                return -I4d2D_fpm_3pt_psiA_bar_bar_4(sigma, q2) - I4d2D_fpm_3pt_psiB_bar_bar_4(sigma, q2);
            }

            double
            I2_fpm_3pt_chi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to chi_bar_4
                const double sigmabar = 1.0 - sigma;
            ...
            double
            I3_fpm_3pt_chi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to chi_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
                ...
                const double C_3 = -2.0
                                   * (m_B2 * sigmabar2 * (-2.0 * sigmabar - 4.0 * sigma * u + 1.0) + 4.0 * m_B * m_v * sigmabar * (2.0 * sigmabar - 1.0)
            ...
            double
            I3d1A_fpm_3pt_chi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to chi_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I3d1B_fpm_3pt_chi_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_± proportional to chi_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3d1C_fpm_3pt_chi_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to chi_bar_4
                const double omega_1 = m_B * sigma;
                ...
                const double C_3 =
                        2.0
                        * (sigmabar * (m_B2 * (-(2.0 * sigma - 1.0)) * sigmabar + 4.0 * m_B * m_v * (2.0 * sigma - 1.0) - 3.0 * m_v2 - q2 * sigmabar) + sigma * (q2 * sigma - m_v2))
                        / (omega_2 * power_of<4>(sigmabar));
            ...
            double
            I4_fpm_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double m_v      = this->m_v();
                const double sigmabar = 1.0 - sigma;
            ...
            double
            I4d1A_fpm_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double m_v = this->m_v(), m_B2 = m_B * m_B;
                const double sigma2 = power_of<2>(sigma), sigma3 = power_of<3>(sigma);
            ...
            double
            I4d1B_fpm_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d1C_fpm_3pt_chiA_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
            ...
            double
            I4d2A_fpm_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double m_v = this->m_v(), m_B2 = power_of<2>(m_B);
                const double sigma2 = power_of<2>(sigma), sigma3 = power_of<3>(sigma);
            ...
            double
            I4d2B_fpm_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double omega_2  = m_B * sigma - omega_1;
                const double sigma2   = power_of<2>(sigma);
            ...
            double
            I4d2C_fpm_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I4d2D_fpm_3pt_chiA_bar_bar_4(const double & sigma, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return (6.0 * m_v * pow(sigmabar, -4.0)
                        * (-(2.0 * (m_v + m_B * (2.0 - 4.0 * sigma)) * chi_bar_bar_4) + m_B * (3.0 * m_v - 2.0 * m_v * sigma - 4.0 * m_B * sigma * sigmabar) * chi_bar_4));
            }

            double
            I3_fpm_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double m_v      = this->m_v();
                const double sigmabar = 1.0 - sigma;
            ...
            double
            I3d1A_fpm_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double m_v    = this->m_v();
            ...
            double
            I3d1B_fpm_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3d1C_fpm_3pt_chiB_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
            ...
            double
            I4_fpm_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v3 = power_of<3>(m_v);
            ...
            double
            I4d1A_fpm_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B), m_B5 = power_of<5>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v3 = power_of<3>(m_v);
            ...
            double
            I4d1B_fpm_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d1C_fpm_3pt_chiB_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
            ...
            double
            I4d2A_fpm_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B), m_B5 = power_of<5>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v3 = power_of<3>(m_v);
            ...
            double
            I4d2B_fpm_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d2C_fpm_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I4d2D_fpm_3pt_chiB_bar_bar_4(const double & sigma, const double & q2) const
            {
                // three-particle contribution to f_± proportional to chi_bar_bar_4
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3_fpm_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +0.0 - I3_fpm_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I3d1A_fpm_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +0.0 - I3d1A_fpm_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I3d1B_fpm_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return +0.0 - I3d1B_fpm_3pt_chiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I3d1C_fpm_3pt_chi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return +0.0 - I3d1C_fpm_3pt_chiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4_fpm_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +I4_fpm_3pt_chiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4_fpm_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d1A_fpm_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +I4d1A_fpm_3pt_chiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4d1A_fpm_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d1B_fpm_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return +I4d1B_fpm_3pt_chiA_bar_bar_4(sigma, omega_1, q2) - I4d1B_fpm_3pt_chiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I4d1C_fpm_3pt_chi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return +I4d1C_fpm_3pt_chiA_bar_bar_4(sigma, omega_2, q2) - I4d1C_fpm_3pt_chiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4d2A_fpm_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +I4d2A_fpm_3pt_chiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4d2A_fpm_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d2B_fpm_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return +I4d2B_fpm_3pt_chiA_bar_bar_4(sigma, omega_1, q2) - I4d2B_fpm_3pt_chiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I4d2C_fpm_3pt_chi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return +I4d2C_fpm_3pt_chiA_bar_bar_4(sigma, omega_2, q2) - I4d2C_fpm_3pt_chiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4d2D_fpm_3pt_chi_bar_bar_4(const double & sigma, const double & q2) const
            {
            ...
            // {{{
            double
            integrand_fpm_2pt_disp(const double & sigma, const double & q2) const
            {
                const double m_B2 = power_of<2>(m_B()), m_B4 = power_of<4>(m_B()), m_B6 = power_of<6>(m_B());
                const double m_P2 = power_of<2>(m_P());
                const double m_v2 = power_of<2>(m_v());
            ...
            double
            integrand_fpm_2pt_borel(const double & sigma, const double & q2) const
            {
                const double m_P2 = power_of<2>(m_P());
                const double M4 = power_of<2>(M2), M6 = power_of<3>(M2);
                const double exp = std::exp((-s(sigma, q2) + m_P2) / M2());
            ...
            double
            surface_fpm_2pt(const double & sigma, const double & q2) const
            {
                const double m_B2 = power_of<2>(m_B()), m_B4 = power_of<4>(m_B()), m_B6 = power_of<6>(m_B());
                const double m_P2 = power_of<2>(m_P());
                const double m_v2 = power_of<2>(m_v());
             ...
             */
            double
            integrand_fpm_3pt(const std::array<double, 3> & args, const double & q2) const
            {
                const double sigma  = args[0];
                const double x_1    = args[1];
                const double x_2    = args[2];
                ...
                constexpr double I1 = 0.0;
                const double I2 = I2_fpm_3pt_phi_3(sigma, omega_1, omega_2, q2) + I2_fpm_3pt_phi_bar_3(sigma, omega_1, omega_2, q2) + I2_fpm_3pt_phi_4(sigma, omega_1, omega_2, q2)
                                  + I2_fpm_3pt_phi_bar_4(sigma, omega_1, omega_2, q2) + I2_fpm_3pt_psi_bar_4(sigma, omega_1, omega_2, q2)
                                  + I2_fpm_3pt_chi_bar_4(sigma, omega_1, omega_2, q2);
                const double I3 = I3_fpm_3pt_phi_bar_3(sigma, omega_1, omega_2, q2) + I3_fpm_3pt_phi_bar_4(sigma, omega_1, omega_2, q2)
                                  + I3_fpm_3pt_phi_bar_bar_4(sigma, omega_1, omega_2, q2) + I3_fpm_3pt_psi_bar_4(sigma, omega_1, omega_2, q2)
                                  + I3_fpm_3pt_chi_bar_4(sigma, omega_1, omega_2, q2) + I3_fpm_3pt_psi_bar_bar_4(sigma, omega_1, omega_2, q2)
                                  + I3_fpm_3pt_chi_bar_bar_4(sigma, omega_1, omega_2, q2);
            ...
            double
            surface_fpm_3pt_A(const std::array<double, 2> & args, const double & sigma, const double & q2) const
            {
                const double x_1    = args[0];
                const double x_2    = args[1];
                const double xbar_1 = 1.0 - x_1;
                ...
                const double I3 = I3_fpm_3pt_phi_bar_3(sigma, omega_1, omega_2, q2) + I3_fpm_3pt_phi_bar_4(sigma, omega_1, omega_2, q2)
                                  ...
                                  + I3_fpm_3pt_chi_bar_4(sigma, omega_1, omega_2, q2) + I3_fpm_3pt_psi_bar_bar_4(sigma, omega_1, omega_2, q2)
                                  + I3_fpm_3pt_chi_bar_bar_4(sigma, omega_1, omega_2, q2);
                const double I3d1 = I3d1A_fpm_3pt_phi_bar_3(sigma, omega_1, omega_2, q2) + I3d1A_fpm_3pt_phi_bar_4(sigma, omega_1, omega_2, q2)
                                    + I3d1A_fpm_3pt_phi_bar_bar_4(sigma, omega_1, omega_2, q2) + I3d1A_fpm_3pt_psi_bar_4(sigma, omega_1, omega_2, q2)
                                    + I3d1A_fpm_3pt_chi_bar_4(sigma, omega_1, omega_2, q2) + I3d1A_fpm_3pt_psi_bar_bar_4(sigma, omega_1, omega_2, q2)
                                    + I3d1A_fpm_3pt_chi_bar_bar_4(sigma, omega_1, omega_2, q2);
                const double I4 = I4_fpm_3pt_phi_bar_bar_3(sigma, omega_1, omega_2, q2) + I4_fpm_3pt_phi_bar_bar_4(sigma, omega_1, omega_2, q2)
                                  + I4_fpm_3pt_psi_bar_bar_4(sigma, omega_1, omega_2, q2) + I4_fpm_3pt_chi_bar_bar_4(sigma, omega_1, omega_2, q2);
            ...
            double
            surface_fpm_3pt_B(const double & x_1, const double & sigma, const double & q2) const
            {
                // this ONLY includes the Jacobian from the transformation (omega_1 -> x_1).
                const double prefactor = sigma * m_B();
                ...
                constexpr double I2   = 0.0;
                constexpr double I3   = 0.0;
                const double     I3d1 = I3d1B_fpm_3pt_phi_bar_3(sigma, omega_1, q2) + I3d1B_fpm_3pt_phi_bar_4(sigma, omega_1, q2) + I3d1B_fpm_3pt_phi_bar_bar_4(sigma, omega_1, q2)
                                    + I3d1B_fpm_3pt_psi_bar_4(sigma, omega_1, q2) + I3d1B_fpm_3pt_chi_bar_4(sigma, omega_1, q2) + I3d1B_fpm_3pt_psi_bar_bar_4(sigma, omega_1, q2)
                                    + I3d1B_fpm_3pt_chi_bar_bar_4(sigma, omega_1, q2);
                constexpr double I4   = 0.0;
            ...
            double
            surface_fpm_3pt_C(const double & x_2, const double & sigma, const double & q2) const
            {
                const double xbar_2 = 1.0 - x_2;
                ...
                constexpr double I2   = 0.0;
                constexpr double I3   = 0.0;
                const double     I3d1 = I3d1C_fpm_3pt_phi_bar_3(sigma, omega_2, q2) + I3d1C_fpm_3pt_phi_bar_4(sigma, omega_2, q2) + I3d1C_fpm_3pt_phi_bar_bar_4(sigma, omega_2, q2)
                                    + I3d1C_fpm_3pt_psi_bar_4(sigma, omega_2, q2) + I3d1C_fpm_3pt_chi_bar_4(sigma, omega_2, q2) + I3d1C_fpm_3pt_psi_bar_bar_4(sigma, omega_2, q2)
                                    + I3d1C_fpm_3pt_chi_bar_bar_4(sigma, omega_2, q2);
                constexpr double I4   = 0.0;
            ...
            double
            surface_fpm_3pt_D(const double & sigma, const double & q2) const
            {
                // this does NOT includes the original factor of 1 / omega_2
                const double prefactor = 1.0;
                ...
                constexpr double I4   = 0.0;
                constexpr double I4d1 = 0.0;
                const double     I4d2 = I4d2D_fpm_3pt_phi_bar_bar_3(sigma, q2) + I4d2D_fpm_3pt_phi_bar_bar_4(sigma, q2) + I4d2D_fpm_3pt_psi_bar_bar_4(sigma, q2)
                                    + I4d2D_fpm_3pt_chi_bar_bar_4(sigma, q2);
            ...
            double
            integrand_fpm_2pt_borel_m1(const double & sigma, const double & q2) const
            {
                const double m_P2 = power_of<2>(m_P());
                const double M4 = power_of<2>(M2), M6 = power_of<3>(M2);
                const double exp = std::exp((-s(sigma, q2) + m_P2) / M2());
            ...
            double
            surface_fpm_2pt_m1(const double & sigma, const double & q2) const
            {
                const double m_B2 = power_of<2>(m_B()), m_B4 = power_of<4>(m_B()), m_B6 = power_of<6>(m_B());
                const double m_v2 = power_of<2>(m_v());
                const double M4   = power_of<2>(M2);
            ...
            double
            integrand_fpm_3pt_m1(const std::array<double, 3> & args, const double & q2) const
            {
                const double sigma  = args[0];
                const double x_1    = args[1];
                const double x_2    = args[2];
            ...
            double
            surface_fpm_3pt_A_m1(const std::array<double, 2> & args, const double & sigma, const double & q2) const
            {
                const double x_1    = args[0];
                const double x_2    = args[1];
                const double xbar_1 = 1.0 - x_1;
            ...
            double
            surface_fpm_3pt_B_m1(const double & x_1, const double & sigma, const double & q2) const
            {
                // this ONLY includes the Jacobian from the transformation (omega_1 -> x_1).
                const double prefactor = sigma * m_B();
            ...
            double
            surface_fpm_3pt_C_m1(const double & x_2, const double & sigma, const double & q2) const
            {
                const double xbar_2 = 1.0 - x_2;
            ...
            double
            surface_fpm_3pt_D_m1(const double & sigma, const double & q2) const
            {
                // this does NOT includes the original factor of 1 / omega_2
                const double prefactor = 1.0;
            ...
            f_pm(const double & q2) const
            {
                ...
                if (switch_3pt != 0.0)
                {
                    const cubature::integrand<1> surface_3pt_B = std::bind(&Implementation::surface_fpm_3pt_B, this, std::placeholders::_1, sigma_0, q2);
                    const cubature::integrand<1> surface_3pt_C = std::bind(&Implementation::surface_fpm_3pt_C, this, std::placeholders::_1, sigma_0, q2);
                    const cubature::integrand<3> integrand_3pt = std::bind(&Implementation::integrand_fpm_3pt, this, std::placeholders::_1, q2);
                    const cubature::integrand<2> surface_3pt_A = std::bind(&Implementation::surface_fpm_3pt_A, this, std::placeholders::_1, sigma_0, q2);
            ...
            double
            normalized_moment_1_f_pm(const double & q2) const
            {
                const double sigma_0 = this->sigma_0(q2, s0_0_pm(), s0_1_pm());
                ...
                if (switch_3pt != 0.0)
                {
                    const cubature::integrand<1> surface_3pt_B_m1 = std::bind(&Implementation::surface_fpm_3pt_B_m1, this, std::placeholders::_1, sigma_0, q2);
                    const cubature::integrand<1> surface_3pt_C_m1 = std::bind(&Implementation::surface_fpm_3pt_C_m1, this, std::placeholders::_1, sigma_0, q2);
                    const cubature::integrand<3> integrand_3pt_m1 = std::bind(&Implementation::integrand_fpm_3pt_m1, this, std::placeholders::_1, q2);
                    const cubature::integrand<2> surface_3pt_A_m1 = std::bind(&Implementation::surface_fpm_3pt_A_m1, this, std::placeholders::_1, sigma_0, q2);
            ...
            inline double
            I1_fT_2pt_phi_bar(const double & sigma, const double & /*q2*/) const
            {
            ...
            inline double
            I2_fT_2pt_phi_bar(const double & sigma, const double & q2) const
            {
                // two-particle contribution to f_T proportional to phibar
                const double sigmabar = 1.0 - sigma, sigmabar2 = power_of<2>(sigmabar);
                const double m_B2 = power_of<2>(m_B);
            ...
            inline double
            I2d1_fT_2pt_phi_bar(const double & sigma, const double & q2) const
            {
            ...
            inline double
            I2_fT_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
            ...
            inline double
            I2d1_fT_2pt_g_bar(const double & sigma, const double & /*q2*/) const
            {
                // two-particle contribution to f_T proportional to gbar
                const double sigmabar = 1.0 - sigma;
            ...
            inline double
            I3_fT_2pt_g_bar(const double & sigma, const double & q2) const
            {
                // two-particle contribution to f_T proportional to gbar
                const double sigmabar = 1.0 - sigma, sigmabar2 = power_of<2>(sigmabar), sigmabar3 = power_of<3>(sigmabar);
                const double m_B2 = power_of<2>(m_B);
            ...
            inline double
            I3d1_fT_2pt_g_bar(const double & sigma, const double & q2) const
            {
                // two-particle contribution to f_T proportional to gbar
                const double sigmabar = 1.0 - sigma, sigmabar2 = power_of<2>(sigmabar), sigmabar3 = power_of<3>(sigmabar);
                const double m_B2 = power_of<2>(m_B);
            ...
            inline double
            I3d2_fT_2pt_g_bar(const double & sigma, const double & q2) const
            {
                // two-particle contribution to f_T proportional to gbar
                const double sigmabar = 1.0 - sigma, sigmabar2 = power_of<2>(sigmabar), sigmabar3 = power_of<3>(sigmabar);
                const double m_B2 = power_of<2>(m_B);
            ...
            inline double
            I4_fT_2pt_g_bar(const double & sigma, const double & q2) const
            {
                // two-particle contribution to f_T proportional to gbar
            ...
            inline double
            I4d1_fT_2pt_g_bar(const double & sigma, const double & q2) const
            {
                // two-particle contribution to f_T proportional to gbar
            ...
            inline double
            I4d2_fT_2pt_g_bar(const double & sigma, const double & q2) const
            {
                // two-particle contribution to f_T proportional to gbar
                const double sigmabar = 1.0 - sigma, sigmabar2 = power_of<2>(sigmabar), sigmabar4 = power_of<4>(sigmabar), sigmabar5 = power_of<5>(sigmabar);
            ...
            inline double
            I4d3_fT_2pt_g_bar(const double & sigma, const double & q2) const
            {
                // two-particle contribution to f_T proportional to gbar
                const double sigmabar = 1.0 - sigma, sigmabar2 = power_of<2>(sigmabar), sigmabar4 = power_of<4>(sigmabar), sigmabar5 = power_of<5>(sigmabar);
                const double sigmabar6 = power_of<6>(sigmabar);
            ...
            // {{{
            double
            I1_fT_3pt_phi_3(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I2_fT_3pt_phi_3(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_3
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I2_fT_3pt_phi_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I3_fT_3pt_phi_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_3
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I3d1A_fT_3pt_phi_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_3
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v3 = power_of<3>(m_v);
                ...
                const double C_3 = 4.0
                                   * (4.0 * m_v3 * omega_2 + m_B * m_v2 * sigmabar * (-(3.0 * omega_1) + 3.0 * m_B * sigma + m_B * sigmabar)
                                      + m_v * omega_2 * (2.0 * q2 * sigmabar + m_B2 * sigmabar * (-3.0 + sigmabar) + sigma * (-(4.0 * q2) + 3.0 * m_B2 * sigmabar))
                                      + m_B * sigmabar
                                                * (-(3.0 * m_B * sigma2 * q2) - 2.0 * m_B3 * sigmabar2 * sigma + m_B * sigmabar2 * (q2 + m_B2 * (-1 + 2.0 * sigma))
            ...
            double
            I3d1B_fT_3pt_phi_bar_3(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_3
                const double omega_2 = m_B * sigma - omega_1;
                ...
                const double C_3 =
                        -4.0 * (m_v + m_B * sigmabar) * (m_v2 - sigma * q2 + sigmabar * (q2 - m_B2 * sigmabar)) / (m_B * (-omega_1 + m_B * sigma) * power_of<4>(sigmabar));

                return C_3 * phi_bar_3;
            }

            double
            I3d1C_fT_3pt_phi_bar_3(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_3
                const double omega_1 = m_B * sigma;
            ...
            double
            I3_fT_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I3d1A_fT_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_3
                const double m_v      = this->m_v();
                const double sigmabar = 1.0 - sigma;
                ...
                const double C_3 = 12.0 * m_v * (3.0 * sigma * m_B + m_B * sigmabar - 3.0 * omega_1) / (m_B * omega_2 * power_of<4>(sigmabar));

                return C_3 * phi_bar_bar_3;
            }

            double
            I3d1B_fT_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_3
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3d1C_fT_3pt_phi_bar_bar_3(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_3
            ...
            double
            I4_fT_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_3
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
                ...
                const double C_4 = -12.0 * m_v * u * (-m_v2 + q2 - 2.0 * q2 * sigmabar + m_B2 * sigmabar2) / (m_B * power_of<4>(sigmabar));

                return C_4 * phi_bar_bar_3;
            }

            double
            I4d1A_fT_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_3
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
                ...
                const double C_4 =
                        12.0 * m_v
                        * (-(omega_1 * (4.0 * m_v2 + 2.0 * q2 * sigmabar + m_B2 * sigmabar * (-3.0 + sigmabar) + sigma * (-(4.0 * q2) + 3.0 * m_B2 * sigmabar)))
                           + m_B * (4.0 * sigma * (m_v2 - q2 * sigma) + sigmabar2 * (q2 + m_B2 * (-1 + 2.0 * sigma)) + sigmabar * (m_v2 + sigma * (q2 - 3.0 * m_B2 * sigmabar))))
                        / (m_B * omega_2 * power_of<5>(sigmabar));
            ...
            double
            I4d1B_fT_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_3
                const double omega_2 = m_B * sigma - omega_1;
                ...
                const double C_4 = -12.0 * m_v * (m_v2 - sigma * q2 + sigmabar * (q2 - m_B2 * sigmabar)) / (power_of<4>(sigmabar) * omega_2);

                return C_4 * phi_bar_bar_3;
            }

            double
            I4d1C_fT_3pt_phi_bar_bar_3(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_3
            ...
            double
            I4d2A_fT_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_3
                ...
                const double C_4 =
                        24.0 * m_v
                        * (2.0 * sigma2 * (-(5.0 * m_B * q2) + 3.0 * m_B3 * sigmabar) - omega_1 * (10.0 * m_v2 + 2.0 * q2 * sigmabar + 3.0 * m_B2 * sigmabar * (-2.0 + sigmabar))
                           + m_B * sigmabar * (4.0 * m_v2 + 2.0 * q2 * sigmabar + m_B2 * sigmabar * (-3.0 + sigmabar))
                           + 2.0 * sigma * (5.0 * omega_1 * q2 - 3.0 * m_B2 * omega_1 * sigmabar + 3.0 * m_B3 * (-1 + sigmabar) * sigmabar + m_B * (5.0 * m_v2 - q2 * sigmabar)))
            ...
            double
            I4d2B_fT_3pt_phi_bar_bar_3(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_3
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return pow(-omega_1 + m_B * sigma, -1) * pow(sigmabar, -5.0)
                       * (-24.0 * m_v * (4.0 * m_v2 + 2.0 * q2 * sigmabar + m_B2 * sigmabar * (-3.0 + sigmabar) + sigma * (-(4.0 * q2) + 3.0 * m_B2 * sigmabar)) * phi_bar_bar_3
                          - 12.0 * m_B * m_v * sigmabar * (m_v2 - q2 * sigma + sigmabar * (q2 - m_B2 * sigmabar)) * phi_bar_3);
            }

            double
            I4d2C_fT_3pt_phi_bar_bar_3(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_3
                const double omega_1 = m_B * sigma;
            ...
            double
            I4d2D_fT_3pt_phi_bar_bar_3(const double & sigma, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_3
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return 12.0 * m_v * pow(m_B, -1) * pow(sigmabar, -4.0)
                       * ((2.0 * q2 - 2.0 * m_B2 * sigmabar) * phi_bar_bar_3 - m_B * (m_v2 - q2 * sigma + sigmabar * (q2 - m_B2 * sigmabar)) * phi_bar_3);
            }

            double
            I2_fT_3pt_phi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I3_fT_3pt_phi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
                ...
                const double C_3 = 2.0 * (-m_v2 + q2 - 2.0 * q2 * sigmabar + m_B2 * sigmabar2) / (m_B * power_of<3>(sigmabar));

                return C_3 * phi_bar_4;
            }

            double
            I3d1A_fT_3pt_phi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
                ...
                const double C_3 = -2.0 * (3.0 * m_v2 + (q2 + m_B2 * (-2.0 + sigmabar)) * sigmabar + sigma * (-3.0 * q2 + 2.0 * m_B2 * sigmabar)) / (m_B * power_of<4>(sigmabar));

                return C_3 * phi_bar_4;
            }

            double
            I3d1B_fT_3pt_phi_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_4
                const double omega_2 = m_B * sigma - omega_1;
                ...
                const double C_3 = 2.0 * (m_v2 - sigma * q2 + sigmabar * (q2 - m_B2 * sigmabar)) / ((-omega_1 + m_B * sigma) * power_of<3>(sigmabar));

                return C_3 * phi_bar_4;
            }

            double
            I3d1C_fT_3pt_phi_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_4
                const double omega_1 = m_B * sigma;
                ...
                const double C_3 = -2.0 * (m_v2 - sigma * q2 + sigmabar * (q2 - m_B2 * sigmabar)) / (omega_2 * power_of<3>(sigmabar));

                return C_3 * phi_bar_4;
            }

            double
            I2_fT_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I3_fT_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
                ...
                const double C_3 = 2.0 * u * (-1.0 + 2.0 * u) * (m_v2 + q2 * (5.0 - 4.0 * sigmabar) - m_B2 * sigmabar2) / (m_B2 * power_of<4>(sigmabar));

                return C_3 * phi_bar_bar_4;
            }

            double
            I3d1A_fT_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I3d1B_fT_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3d1C_fT_3pt_phi_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_4
            ...
            double
            I4_fT_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_4
                ...
                const double C_4 = 6.0 * u * (-1.0 + 2.0 * u)
                                   * (m_v4 - 2.0 * m_B2 * q2 * sigmabar3 + m_B4 * sigmabar4 + q2 * q2 * (-1.0 + 2.0 * sigmabar) + 2.0 * m_v2 * sigmabar * (q2 - m_B2 * sigmabar))
            ...
            double
            I4d1A_fT_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B4 = power_of<4>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v4 = power_of<4>(m_v);
            ...
            double
            I4d1B_fT_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
                ...
                const double C_4 = 2.0 * (3.0 * m_B2 * sigmabar3 - 2.0 * q2 * sigma * sigmabar + q2 * (-3.0 + 2.0 * sigma) * sigmabar + m_v2 * (2.0 - 2.0 * sigma - 5.0 * sigmabar))
                                   * (m_v2 - q2 * sigma + sigmabar * (q2 - m_B2 * sigmabar)) / (m_B * power_of<6>(sigmabar) * omega_2);

                return C_4 * phi_bar_bar_4;
            }

            double
            I4d1C_fT_3pt_phi_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_4
            ...
            double
            I4d2A_fT_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_4
            ...
            double
            I4d2B_fT_3pt_phi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d2C_fT_3pt_phi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_4
                const double omega_1 = m_B * sigma;
                ...
                const double C_4 = -(2.0 * (-(2.0 * (m_v2 - q2 * sigma) * sigmabar) + (5.0 * m_v2 - 3.0 * m_B2 * sigmabar2 + q2 * (3.0 - 2.0 * sigma)) * sigmabar)
            ...
            double
            I4d2D_fT_3pt_phi_bar_bar_4(const double & sigma, const double & q2) const
            {
                // three-particle contribution to f_T proportional to phi_bar_bar_4
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return 2.0 * pow(m_B, -2.0) * pow(sigmabar, -7.0)
                       * (phi_bar_bar_4
                                  * ((m_v2 - q2 * sigma) * (-(7.0 * m_v2) + m_B2 * sigmabar2 - 5.0 * q2 + 6.0 * q2 * sigma) * sigmabar
                                     ...
                                     + sigmabar3 * (9.0 * m_B4 * sigmabar2 + m_B2 * (-(5.0 * m_v2) - 11.0 * q2 + 10.0 * q2 * sigma) + 2.0 * power_of<2>(q2))
                                     + 4.0 * sigmabar * power_of<2>(m_v2 - q2 * sigma))
                          + m_B * sigmabar
                                    * (3.0 * m_B2 * sigmabar3 - 2.0 * q2 * sigma * sigmabar + q2 * (-3.0 + 2.0 * sigma) * sigmabar + m_v2 * (2.0 - 2.0 * sigma - 5.0 * sigmabar))
                                    * (m_v2 - q2 * sigma + sigmabar * (q2 - m_B2 * sigmabar)) * phi_bar_4);
            }

            double
            I2_fT_3pt_psi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I3_fT_3pt_psi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
                ...
                const double C_3 = 4.0 * m_v * (-m_v2 + q2 - 2.0 * q2 * sigmabar + m_B2 * sigmabar2) / (m_B2 * power_of<4>(sigmabar));

                return C_3 * psi_bar_4;
            }

            double
            I3d1A_fT_3pt_psi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I3d1B_fT_3pt_psi_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_4
                const double omega_2 = m_B * sigma - omega_1;
                ...
                const double C_3 = 4.0 * m_v * (m_v2 - sigma * q2 + sigmabar * (q2 - m_B2 * sigmabar)) / (m_B * (-omega_1 + m_B * sigma) * power_of<4>(sigmabar));

                return C_3 * psi_bar_4;
            }

            double
            I3d1C_fT_3pt_psi_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I3_fT_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I3d1A_fT_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double m_v      = this->m_v();
                const double sigmabar = 1.0 - sigma;
            ...
            double
            I3d1B_fT_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3d1C_fT_3pt_psiA_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
            ...
            double
            I4_fT_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I4d1A_fT_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I4d1B_fT_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d1C_fT_3pt_psiA_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
            ...
            double
            I4d2A_fT_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double sigma2   = power_of<2>(sigma);
            ...
            double
            I4d2B_fT_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_B2 = power_of<2>(m_B);
                ...
                return pow(-omega_1 + m_B * sigma, -1) * pow(sigmabar, -5.0)
                       * (-24.0 * m_v * (4.0 * m_v2 + 2.0 * q2 * sigmabar + m_B2 * sigmabar * (-3.0 + sigmabar) + sigma * (-(4.0 * q2) + 3.0 * m_B2 * sigmabar)) * psi_bar_bar_4
                          - 12.0 * m_B * m_v * sigmabar * (m_v2 - q2 * sigma + sigmabar * (q2 - m_B2 * sigmabar)) * psi_bar_4);
            }

            double
            I4d2C_fT_3pt_psiA_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I4d2D_fT_3pt_psiA_bar_bar_4(const double & sigma, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return 12.0 * m_v * pow(m_B, -1) * pow(sigmabar, -4.0)
                       * ((2.0 * q2 - 2.0 * m_B2 * sigmabar) * psi_bar_bar_4 - m_B * (m_v2 - q2 * sigma + sigmabar * (q2 - m_B2 * sigmabar)) * psi_bar_4);
            }

            double
            I2_fT_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double m_B2     = power_of<2>(m_B);
                const double sigmabar = 1.0 - sigma;
            ...
            double
            I3_fT_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I3d1A_fT_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I3d1B_fT_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3d1C_fT_3pt_psiB_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
            ...
            double
            I4_fT_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B4 = power_of<4>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v4 = power_of<4>(m_v);
            ...
            double
            I4d1A_fT_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B4 = power_of<4>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v4 = power_of<4>(m_v);
            ...
            double
            I4d1B_fT_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d1C_fT_3pt_psiB_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
            ...
            double
            I4d2A_fT_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B), m_B5 = power_of<5>(m_B), m_B6 = power_of<6>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v4 = power_of<4>(m_v);
            ...
            double
            I4d2B_fT_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d2C_fT_3pt_psiB_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I4d2D_fT_3pt_psiB_bar_bar_4(const double & sigma, const double & q2) const
            {
                // three-particle contribution to f_T proportional to psi_bar_bar_4
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return 2.0 * pow(m_B, -2.0) * pow(sigmabar, -7.0)
                       * (psi_bar_bar_4
                          ...
                          + m_B * sigmabar
                                    * (3.0 * m_B2 * sigmabar3 - 2.0 * q2 * sigma * sigmabar + q2 * (-3.0 + 2.0 * sigma) * sigmabar + m_v2 * (2.0 - 2.0 * sigma - 5.0 * sigmabar))
                                    * (m_v2 - q2 * sigma + sigmabar * (q2 - m_B2 * sigmabar)) * psi_bar_4);
            }

            double
            I2_fT_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -0.0 - I2_fT_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I3_fT_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -I3_fT_3pt_psiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I3_fT_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I3d1A_fT_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -I3d1A_fT_3pt_psiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I3d1A_fT_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I3d1B_fT_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return -I3d1B_fT_3pt_psiA_bar_bar_4(sigma, omega_1, q2) - I3d1B_fT_3pt_psiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I3d1C_fT_3pt_psi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return -I3d1C_fT_3pt_psiA_bar_bar_4(sigma, omega_2, q2) - I3d1C_fT_3pt_psiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4_fT_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -I4_fT_3pt_psiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4_fT_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d1A_fT_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -I4d1A_fT_3pt_psiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4d1A_fT_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d1B_fT_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return -I4d1B_fT_3pt_psiA_bar_bar_4(sigma, omega_1, q2) - I4d1B_fT_3pt_psiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I4d1C_fT_3pt_psi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return -I4d1C_fT_3pt_psiA_bar_bar_4(sigma, omega_2, q2) - I4d1C_fT_3pt_psiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4d2A_fT_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return -I4d2A_fT_3pt_psiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4d2A_fT_3pt_psiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d2B_fT_3pt_psi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return -I4d2B_fT_3pt_psiA_bar_bar_4(sigma, omega_1, q2) - I4d2B_fT_3pt_psiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I4d2C_fT_3pt_psi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return -I4d2C_fT_3pt_psiA_bar_bar_4(sigma, omega_2, q2) - I4d2C_fT_3pt_psiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4d2D_fT_3pt_psi_bar_bar_4(const double & sigma, const double & q2) const
            {
                return -I4d2D_fT_3pt_psiA_bar_bar_4(sigma, q2) - I4d2D_fT_3pt_psiB_bar_bar_4(sigma, q2);
            }

            double
            I2_fT_3pt_chi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I3_fT_3pt_chi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I3d1A_fT_3pt_chi_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v3 = power_of<3>(m_v);
            ...
            double
            I3d1B_fT_3pt_chi_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3d1C_fT_3pt_chi_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I3_fT_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
            ...
            double
            I3d1A_fT_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double m_v      = this->m_v();
                const double sigmabar = 1.0 - sigma;
            ...
            double
            I3d1B_fT_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3d1C_fT_3pt_chiA_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
            ...
            double
            I4_fT_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I4d1A_fT_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I4d1B_fT_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d1C_fT_3pt_chiA_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
            ...
            double
            I4d2A_fT_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B);
                const double sigma2   = power_of<2>(sigma);
            ...
            double
            I4d2B_fT_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_B2 = power_of<2>(m_B);
                ...
                return pow(-omega_1 + m_B * sigma, -1) * pow(sigmabar, -5.0)
                       * (-24.0 * m_v * (4.0 * m_v2 + 2.0 * q2 * sigmabar + m_B2 * sigmabar * (-3.0 + sigmabar) + sigma * (-(4.0 * q2) + 3.0 * m_B2 * sigmabar)) * chi_bar_bar_4
                          - 12.0 * m_B * m_v * sigmabar * (m_v2 - q2 * sigma + sigmabar * (q2 - m_B2 * sigmabar)) * chi_bar_4);
            }

            double
            I4d2C_fT_3pt_chiA_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I4d2D_fT_3pt_chiA_bar_bar_4(const double & sigma, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return 12.0 * m_v * pow(m_B, -1) * pow(sigmabar, -4.0)
                       * ((2.0 * q2 - 2.0 * m_B2 * sigmabar) * chi_bar_bar_4 - m_B * (m_v2 - q2 * sigma + sigmabar * (q2 - m_B2 * sigmabar)) * chi_bar_4);
            }

            double
            I2_fT_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double m_B2     = power_of<2>(m_B);
                const double sigmabar = 1.0 - sigma;
            ...
            double
            I3_fT_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double m_B2 = power_of<2>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I3d1A_fT_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v);
            ...
            double
            I3d1B_fT_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I3d1C_fT_3pt_chiB_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
            ...
            double
            I4_fT_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B4 = power_of<4>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v4 = power_of<4>(m_v);
            ...
            double
            I4d1A_fT_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B4 = power_of<4>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v4 = power_of<4>(m_v);
            ...
            double
            I4d1B_fT_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d1C_fT_3pt_chiB_bar_bar_4(const double & /*sigma*/, const double & /*omega_2*/, const double & /*q2*/) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
            ...
            double
            I4d2A_fT_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double m_B2 = power_of<2>(m_B), m_B3 = power_of<3>(m_B), m_B4 = power_of<4>(m_B), m_B5 = power_of<5>(m_B), m_B6 = power_of<6>(m_B);
                const double m_v = this->m_v(), m_v2 = power_of<2>(m_v), m_v4 = power_of<4>(m_v);
            ...
            double
            I4d2B_fT_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double omega_2 = m_B * sigma - omega_1;
            ...
            double
            I4d2C_fT_3pt_chiB_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double omega_1 = m_B * sigma;
            ...
            double
            I4d2D_fT_3pt_chiB_bar_bar_4(const double & sigma, const double & q2) const
            {
                // three-particle contribution to f_T proportional to chi_bar_bar_4
                const double omega_1 = m_B * sigma;
                const double omega_2 = m_B * sigma - omega_1;
                ...
                return 2.0 * pow(m_B, -2.0) * pow(sigmabar, -7.0)
                       * (chi_bar_bar_4
                          ...
                          + m_B * sigmabar
                                    * (3.0 * m_B2 * sigmabar3 - 2.0 * q2 * sigma * sigmabar + q2 * (-3.0 + 2.0 * sigma) * sigmabar + m_v2 * (2.0 - 2.0 * sigma - 5.0 * sigmabar))
                                    * (m_v2 - q2 * sigma + sigmabar * (q2 - m_B2 * sigmabar)) * chi_bar_4);
            }

            double
            I2_fT_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +0.0 - I2_fT_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I3_fT_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +I3_fT_3pt_chiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I3_fT_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I3d1A_fT_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +I3d1A_fT_3pt_chiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I3d1A_fT_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I3d1B_fT_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return +I3d1B_fT_3pt_chiA_bar_bar_4(sigma, omega_1, q2) - I3d1B_fT_3pt_chiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I3d1C_fT_3pt_chi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return +I3d1C_fT_3pt_chiA_bar_bar_4(sigma, omega_2, q2) - I3d1C_fT_3pt_chiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4_fT_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +I4_fT_3pt_chiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4_fT_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d1A_fT_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +I4d1A_fT_3pt_chiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4d1A_fT_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d1B_fT_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return +I4d1B_fT_3pt_chiA_bar_bar_4(sigma, omega_1, q2) - I4d1B_fT_3pt_chiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I4d1C_fT_3pt_chi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return +I4d1C_fT_3pt_chiA_bar_bar_4(sigma, omega_2, q2) - I4d1C_fT_3pt_chiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4d2A_fT_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & omega_2, const double & q2) const
            {
                return +I4d2A_fT_3pt_chiA_bar_bar_4(sigma, omega_1, omega_2, q2) - I4d2A_fT_3pt_chiB_bar_bar_4(sigma, omega_1, omega_2, q2);
            }

            double
            I4d2B_fT_3pt_chi_bar_bar_4(const double & sigma, const double & omega_1, const double & q2) const
            {
                return +I4d2B_fT_3pt_chiA_bar_bar_4(sigma, omega_1, q2) - I4d2B_fT_3pt_chiB_bar_bar_4(sigma, omega_1, q2);
            }

            double
            I4d2C_fT_3pt_chi_bar_bar_4(const double & sigma, const double & omega_2, const double & q2) const
            {
                return +I4d2C_fT_3pt_chiA_bar_bar_4(sigma, omega_2, q2) - I4d2C_fT_3pt_chiB_bar_bar_4(sigma, omega_2, q2);
            }

            double
            I4d2D_fT_3pt_chi_bar_bar_4(const double & sigma, const double & q2) const
            {
            ...
            // {{{
            double
            integrand_fT_2pt_disp(const double & sigma, const double & q2) const
            {
                const double m_B2 = power_of<2>(m_B()), m_B4 = power_of<4>(m_B()), m_B6 = power_of<6>(m_B());
                const double m_P2 = power_of<2>(m_P());
                const double m_v2 = power_of<2>(m_v());
            ...
            double
            integrand_fT_2pt_borel(const double & sigma, const double & q2) const
            {
                const double m_P2 = power_of<2>(m_P());
                const double M4 = power_of<2>(M2), M6 = power_of<3>(M2);
                const double exp = std::exp((-s(sigma, q2) + m_P2) / M2());
            ...
            double
            surface_fT_2pt(const double & sigma, const double & q2) const
            {
                const double m_B2 = power_of<2>(m_B()), m_B4 = power_of<4>(m_B()), m_B6 = power_of<6>(m_B());
                const double m_P2 = power_of<2>(m_P());
                const double m_v2 = power_of<2>(m_v());
             ...
             */
            double
            integrand_fT_3pt(const std::array<double, 3> & args, const double & q2) const
            {
                const double sigma  = args[0];
                const double x_1    = args[1];
                const double x_2    = args[2];
                ...
                const double I2 = I2_fT_3pt_phi_3(sigma, omega_1, omega_2, q2) + I2_fT_3pt_phi_bar_3(sigma, omega_1, omega_2, q2) + I2_fT_3pt_phi_bar_4(sigma, omega_1, omega_2, q2)
                                  + I2_fT_3pt_phi_bar_bar_4(sigma, omega_1, omega_2, q2) + I2_fT_3pt_psi_bar_4(sigma, omega_1, omega_2, q2)
                                  + I2_fT_3pt_chi_bar_4(sigma, omega_1, omega_2, q2) + I2_fT_3pt_psi_bar_bar_4(sigma, omega_1, omega_2, q2)
                                  + I2_fT_3pt_chi_bar_bar_4(sigma, omega_1, omega_2, q2);
            ...
            double
            surface_fT_3pt_A(const std::array<double, 2> & args, const double & sigma, const double & q2) const
            {
                const double x_1    = args[0];
                const double x_2    = args[1];
                const double xbar_1 = 1.0 - x_1;
            ...
            double
            surface_fT_3pt_B(const double & x_1, const double & sigma, const double & q2) const
            {
                // this ONLY includes the Jacobian from the transformation (omega_1 -> x_1).
                const double prefactor = sigma * m_B();
                ...
                constexpr double I2   = 0.0;
                constexpr double I3   = 0.0;
                const double     I3d1 = I3d1B_fT_3pt_phi_bar_3(sigma, omega_1, q2) + I3d1B_fT_3pt_phi_bar_bar_3(sigma, omega_1, q2) + I3d1B_fT_3pt_phi_bar_4(sigma, omega_1, q2)
                                    + I3d1B_fT_3pt_phi_bar_bar_4(sigma, omega_1, q2) + I3d1B_fT_3pt_psi_bar_4(sigma, omega_1, q2) + I3d1B_fT_3pt_chi_bar_4(sigma, omega_1, q2)
                                    + I3d1B_fT_3pt_psi_bar_bar_4(sigma, omega_1, q2) + I3d1B_fT_3pt_chi_bar_bar_4(sigma, omega_1, q2);
                constexpr double I4 = 0.0;
                const double I4d1 = I4d1B_fT_3pt_phi_bar_bar_3(sigma, omega_1, q2) + I4d1B_fT_3pt_phi_bar_bar_4(sigma, omega_1, q2) + I4d1B_fT_3pt_psi_bar_bar_4(sigma, omega_1, q2)
                                    + I4d1B_fT_3pt_chi_bar_bar_4(sigma, omega_1, q2);
                const double I4d2 = I4d2B_fT_3pt_phi_bar_bar_3(sigma, omega_1, q2) + I4d2B_fT_3pt_phi_bar_bar_4(sigma, omega_1, q2) + I4d2B_fT_3pt_psi_bar_bar_4(sigma, omega_1, q2)
                                    + I4d2B_fT_3pt_chi_bar_bar_4(sigma, omega_1, q2);
            ...
            double
            surface_fT_3pt_C(const double & x_2, const double & sigma, const double & q2) const
            {
                const double xbar_2 = 1.0 - x_2;
                ...
                constexpr double I2   = 0.0;
                constexpr double I3   = 0.0;
                const double     I3d1 = I3d1C_fT_3pt_phi_bar_3(sigma, omega_2, q2) + I3d1C_fT_3pt_phi_bar_bar_3(sigma, omega_2, q2) + I3d1C_fT_3pt_phi_bar_4(sigma, omega_2, q2)
                                    + I3d1C_fT_3pt_phi_bar_bar_4(sigma, omega_2, q2) + I3d1C_fT_3pt_psi_bar_4(sigma, omega_2, q2) + I3d1C_fT_3pt_chi_bar_4(sigma, omega_2, q2)
                                    + I3d1C_fT_3pt_psi_bar_bar_4(sigma, omega_2, q2) + I3d1C_fT_3pt_chi_bar_bar_4(sigma, omega_2, q2);
                constexpr double I4 = 0.0;
                const double I4d1 = I4d1C_fT_3pt_phi_bar_bar_3(sigma, omega_2, q2) + I4d1C_fT_3pt_phi_bar_bar_4(sigma, omega_2, q2) + I4d1C_fT_3pt_psi_bar_bar_4(sigma, omega_2, q2)
                                    + I4d1C_fT_3pt_chi_bar_bar_4(sigma, omega_2, q2);
                const double I4d2 = I4d2C_fT_3pt_phi_bar_bar_3(sigma, omega_2, q2) + I4d2C_fT_3pt_phi_bar_bar_4(sigma, omega_2, q2) + I4d2C_fT_3pt_psi_bar_bar_4(sigma, omega_2, q2)
                                    + I4d2C_fT_3pt_chi_bar_bar_4(sigma, omega_2, q2);
            ...
            double
            surface_fT_3pt_D(const double & sigma, const double & q2) const
            {
                // this does NOT includes the original factor of 1 / omega_2
                const double prefactor = 1.0;
                ...
                constexpr double I4   = 0.0;
                constexpr double I4d1 = 0.0;
                const double     I4d2 = I4d2D_fT_3pt_phi_bar_bar_3(sigma, q2) + I4d2D_fT_3pt_phi_bar_bar_4(sigma, q2) + I4d2D_fT_3pt_psi_bar_bar_4(sigma, q2)
                                    + I4d2D_fT_3pt_chi_bar_bar_4(sigma, q2);
            ...
            double
            integrand_fT_2pt_borel_m1(const double & sigma, const double & q2) const
            {
                const double m_P2 = power_of<2>(m_P());
                const double M4 = power_of<2>(M2), M6 = power_of<3>(M2);
                const double exp = std::exp((-s(sigma, q2) + m_P2) / M2());
            ...
            double
            surface_fT_2pt_m1(const double & sigma, const double & q2) const
            {
                const double m_B2 = power_of<2>(m_B()), m_B4 = power_of<4>(m_B()), m_B6 = power_of<6>(m_B());
                const double m_v2 = power_of<2>(m_v());
                const double M4   = power_of<2>(M2);
            ...
            double
            integrand_fT_3pt_m1(const std::array<double, 3> & args, const double & q2) const
            {
                const double sigma  = args[0];
                const double x_1    = args[1];
                const double x_2    = args[2];
            ...
            double
            surface_fT_3pt_A_m1(const std::array<double, 2> & args, const double & sigma, const double & q2) const
            {
                const double x_1    = args[0];
                const double x_2    = args[1];
                const double xbar_1 = 1.0 - x_1;
            ...
            double
            surface_fT_3pt_B_m1(const double & x_1, const double & sigma, const double & q2) const
            {
                // this ONLY includes the Jacobian from the transformation (omega_1 -> x_1).
                const double prefactor = sigma * m_B();
            ...
            double
            surface_fT_3pt_C_m1(const double & x_2, const double & sigma, const double & q2) const
            {
                const double xbar_2 = 1.0 - x_2;
            ...
            double
            surface_fT_3pt_D_m1(const double & sigma, const double & q2) const
            {
                // this does NOT includes the original factor of 1 / omega_2
                const double prefactor = 1.0;
            ...
            f_t(const double & q2) const
            {
                ...
                if (switch_3pt != 0.0)
                {
                    const cubature::integrand<1> surface_3pt_B = std::bind(&Implementation::surface_fT_3pt_B, this, std::placeholders::_1, sigma_0, q2);
                    const cubature::integrand<1> surface_3pt_C = std::bind(&Implementation::surface_fT_3pt_C, this, std::placeholders::_1, sigma_0, q2);
                    const cubature::integrand<3> integrand_3pt = std::bind(&Implementation::integrand_fT_3pt, this, std::placeholders::_1, q2);
                    const cubature::integrand<2> surface_3pt_A = std::bind(&Implementation::surface_fT_3pt_A, this, std::placeholders::_1, sigma_0, q2);
                ...
                return f_B() * power_of<2>(m_B()) * (m_B() + m_P()) / (f_P() * (power_of<2>(m_B()) - power_of<2>(m_P()) - q2))
                       * (integral_2pt + surface_2pt + integral_3pt + surface_3pt) / (Traits::chi2);
            }

            double
            normalized_moment_1_f_t(const double & q2) const
            {
                const double sigma_0 = this->sigma_0(q2, s0_0_t(), s0_1_t());
                ...
                if (switch_3pt != 0.0)
                {
                    const cubature::integrand<1> surface_3pt_B_m1 = std::bind(&Implementation::surface_fT_3pt_B_m1, this, std::placeholders::_1, sigma_0, q2);
                    const cubature::integrand<1> surface_3pt_C_m1 = std::bind(&Implementation::surface_fT_3pt_C_m1, this, std::placeholders::_1, sigma_0, q2);
                    const cubature::integrand<3> integrand_3pt_m1 = std::bind(&Implementation::integrand_fT_3pt_m1, this, std::placeholders::_1, q2);
                    const cubature::integrand<2> surface_3pt_A_m1 = std::bind(&Implementation::surface_fT_3pt_A_m1, this, std::placeholders::_1, sigma_0, q2);
            ...
            diagnostics() const
            {
                ...
                /* I_3d1A phi_bar_3 */
                results.add(
                        { this->I3d1A_fp_3pt_phi_bar_3(this->sigma(s0_0_p(), 5.0), 1.0, 0.1, 5.0), "f_+: I_3d1A^{3pt,phi_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fp_3pt_phi_bar_3(this->sigma(s0_0_p(), 5.0), 1.0, 0.5, 5.0), "f_+: I_3d1A^{3pt,phi_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fp_3pt_phi_bar_3(this->sigma(s0_0_p(), 5.0), 3.0, 0.1, 5.0), "f_+: I_3d1A^{3pt,phi_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fp_3pt_phi_bar_3(this->sigma(s0_0_p(), 5.0), 3.0, 0.5, 5.0), "f_+: I_3d1A^{3pt,phi_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_4 phi_bar_bar_3 */
                results.add({ this->I4_fp_3pt_phi_bar_bar_3(this->sigma(s0_0_p(), 5.0), 1.0, 0.1, 5.0),
                              "f_+: I_4^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4_fp_3pt_phi_bar_bar_3(this->sigma(s0_0_p(), 5.0), 1.0, 0.5, 5.0),
                              "f_+: I_4^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4_fp_3pt_phi_bar_bar_3(this->sigma(s0_0_p(), 5.0), 3.0, 0.1, 5.0),
                              "f_+: I_4^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4_fp_3pt_phi_bar_bar_3(this->sigma(s0_0_p(), 5.0), 3.0, 0.5, 5.0),
                              "f_+: I_4^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });

                /* I_4d1A phi_bar_bar_3 */
                results.add({ this->I4d1A_fp_3pt_phi_bar_bar_3(this->sigma(s0_0_p(), 5.0), 1.0, 0.1, 5.0),
                              "f_+: I_4d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fp_3pt_phi_bar_bar_3(this->sigma(s0_0_p(), 5.0), 1.0, 0.5, 5.0),
                              "f_+: I_4d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fp_3pt_phi_bar_bar_3(this->sigma(s0_0_p(), 5.0), 3.0, 0.1, 5.0),
                              "f_+: I_4d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fp_3pt_phi_bar_bar_3(this->sigma(s0_0_p(), 5.0), 3.0, 0.5, 5.0),
                              "f_+: I_4d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                results.add({ this->I4d2A_fp_3pt_phi_bar_bar_3(this->sigma(s0_0_p(), 5.0), 1.0, 0.1, 5.0),
                              "f_+: I_4d2A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fp_3pt_phi_bar_bar_3(this->sigma(s0_0_p(), 5.0), 1.0, 0.5, 5.0),
                              "f_+: I_4d2A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fp_3pt_phi_bar_bar_3(this->sigma(s0_0_p(), 5.0), 3.0, 0.1, 5.0),
                              "f_+: I_4d2A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fp_3pt_phi_bar_bar_3(this->sigma(s0_0_p(), 5.0), 3.0, 0.5, 5.0),
                              "f_+: I_4d2A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_3d1A phi_bar_4 */
                results.add(
                        { this->I3d1A_fp_3pt_phi_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.1, 5.0), "f_+: I_3d1A^{3pt,phi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fp_3pt_phi_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.5, 5.0), "f_+: I_3d1A^{3pt,phi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fp_3pt_phi_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.1, 5.0), "f_+: I_3d1A^{3pt,phi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fp_3pt_phi_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.5, 5.0), "f_+: I_3d1A^{3pt,phi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_3 phi_bar_bar_4 */
                results.add({ this->I3_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.1, 5.0),
                              "f_+: I_3^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.5, 5.0),
                              "f_+: I_3^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I3_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.1, 5.0),
                              "f_+: I_3^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.5, 5.0),
                              "f_+: I_3^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });

                /* I_3d1A phi_bar_bar_4 */
                results.add({ this->I3d1A_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.1, 5.0),
                              "f_+: I_3d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.5, 5.0),
                              "f_+: I_3d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.1, 5.0),
                              "f_+: I_3d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.5, 5.0),
                              "f_+: I_3d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_4 phi_bar_bar_4 */
                results.add({ this->I4_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.1, 5.0),
                              "f_+: I_4^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.5, 5.0),
                              "f_+: I_4^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.1, 5.0),
                              "f_+: I_4^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.5, 5.0),
                              "f_+: I_4^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });

                /* I_4d1A phi_bar_bar_4 */
                results.add({ this->I4d1A_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.1, 5.0),
                              "f_+: I_4d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.5, 5.0),
                              "f_+: I_4d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.1, 5.0),
                              "f_+: I_4d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.5, 5.0),
                              "f_+: I_4d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                results.add({ this->I4d2A_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.1, 5.0),
                              "f_+: I_4d2A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.5, 5.0),
                              "f_+: I_4d2A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.1, 5.0),
                              "f_+: I_4d2A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fp_3pt_phi_bar_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.5, 5.0),
                              "f_+: I_4d2A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_3d1A psi_bar_4 */
                results.add(
                        { this->I3d1A_fp_3pt_psi_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.1, 5.0), "f_+: I_3d1A^{3pt,psi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fp_3pt_psi_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.5, 5.0), "f_+: I_3d1A^{3pt,psi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fp_3pt_psi_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.1, 5.0), "f_+: I_3d1A^{3pt,psi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fp_3pt_psi_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.5, 5.0), "f_+: I_3d1A^{3pt,psi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_3d1A chi_bar_4 */
                results.add(
                        { this->I3d1A_fp_3pt_chi_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.1, 5.0), "f_+: I_3d1A^{3pt,chi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fp_3pt_chi_bar_4(this->sigma(s0_0_p(), 5.0), 1.0, 0.5, 5.0), "f_+: I_3d1A^{3pt,chi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fp_3pt_chi_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.1, 5.0), "f_+: I_3d1A^{3pt,chi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fp_3pt_chi_bar_4(this->sigma(s0_0_p(), 5.0), 3.0, 0.5, 5.0), "f_+: I_3d1A^{3pt,chi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_3d1A phi_bar_3 */
                results.add({ this->I3d1A_fpm_3pt_phi_bar_3(this->sigma(s0_0_pm(), 5.0), 1.0, 0.1, 5.0),
                              "f_±: I_3d1A^{3pt,phi_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fpm_3pt_phi_bar_3(this->sigma(s0_0_pm(), 5.0), 1.0, 0.5, 5.0),
                              "f_±: I_3d1A^{3pt,phi_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fpm_3pt_phi_bar_3(this->sigma(s0_0_pm(), 5.0), 3.0, 0.1, 5.0),
                              "f_±: I_3d1A^{3pt,phi_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fpm_3pt_phi_bar_3(this->sigma(s0_0_pm(), 5.0), 3.0, 0.5, 5.0),
                              "f_±: I_3d1A^{3pt,phi_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_4 phi_bar_bar_3 */
                results.add({ this->I4_fpm_3pt_phi_bar_bar_3(this->sigma(s0_0_pm(), 5.0), 1.0, 0.1, 5.0),
                              "f_±: I_4^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4_fpm_3pt_phi_bar_bar_3(this->sigma(s0_0_pm(), 5.0), 1.0, 0.5, 5.0),
                              "f_±: I_4^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4_fpm_3pt_phi_bar_bar_3(this->sigma(s0_0_pm(), 5.0), 3.0, 0.1, 5.0),
                              "f_±: I_4^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4_fpm_3pt_phi_bar_bar_3(this->sigma(s0_0_pm(), 5.0), 3.0, 0.5, 5.0),
                              "f_±: I_4^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });

                /* I_4d1A phi_bar_bar_3 */
                results.add({ this->I4d1A_fpm_3pt_phi_bar_bar_3(this->sigma(s0_0_pm(), 5.0), 1.0, 0.1, 5.0),
                              "f_±: I_4d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fpm_3pt_phi_bar_bar_3(this->sigma(s0_0_pm(), 5.0), 1.0, 0.5, 5.0),
                              "f_±: I_4d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fpm_3pt_phi_bar_bar_3(this->sigma(s0_0_pm(), 5.0), 3.0, 0.1, 5.0),
                              "f_±: I_4d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fpm_3pt_phi_bar_bar_3(this->sigma(s0_0_pm(), 5.0), 3.0, 0.5, 5.0),
                              "f_±: I_4d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_4d2A phi_bar_bar_3 */
                results.add({ this->I4d2A_fpm_3pt_phi_bar_bar_3(this->sigma(s0_0_pm(), 5.0), 1.0, 0.1, 5.0),
                              "f_±: I_4d2A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fpm_3pt_phi_bar_bar_3(this->sigma(s0_0_pm(), 5.0), 1.0, 0.5, 5.0),
                              "f_±: I_4d2A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fpm_3pt_phi_bar_bar_3(this->sigma(s0_0_pm(), 5.0), 3.0, 0.1, 5.0),
                              "f_±: I_4d2A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fpm_3pt_phi_bar_bar_3(this->sigma(s0_0_pm(), 5.0), 3.0, 0.5, 5.0),
                              "f_±: I_4d2A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_3d1A phi_bar_4 */
                results.add({ this->I3d1A_fpm_3pt_phi_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.1, 5.0),
                              "f_±: I_3d1A^{3pt,phi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fpm_3pt_phi_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.5, 5.0),
                              "f_±: I_3d1A^{3pt,phi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fpm_3pt_phi_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.1, 5.0),
                              "f_±: I_3d1A^{3pt,phi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fpm_3pt_phi_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.5, 5.0),
                              "f_±: I_3d1A^{3pt,phi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_3 phi_bar_bar_4 */
                results.add({ this->I3_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.1, 5.0),
                              "f_±: I_3^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.5, 5.0),
                              "f_±: I_3^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I3_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.1, 5.0),
                              "f_±: I_3^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.5, 5.0),
                              "f_±: I_3^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });

                /* I_3d1A phi_bar_bar_4 */
                results.add({ this->I3d1A_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.1, 5.0),
                              "f_±: I_3d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.5, 5.0),
                              "f_±: I_3d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.1, 5.0),
                              "f_±: I_3d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.5, 5.0),
                              "f_±: I_3d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_4 phi_bar_bar_4 */
                results.add({ this->I4_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.1, 5.0),
                              "f_±: I_4^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.5, 5.0),
                              "f_±: I_4^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.1, 5.0),
                              "f_±: I_4^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.5, 5.0),
                              "f_±: I_4^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });

                /* I_4d1A phi_bar_bar_4 */
                results.add({ this->I4d1A_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.1, 5.0),
                              "f_±: I_4d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.5, 5.0),
                              "f_±: I_4d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.1, 5.0),
                              "f_±: I_4d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.5, 5.0),
                              "f_±: I_4d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_4d2A phi_bar_bar_4 */
                results.add({ this->I4d2A_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.1, 5.0),
                              "f_±: I_4d2A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.5, 5.0),
                              "f_±: I_4d2A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.1, 5.0),
                              "f_±: I_4d2A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fpm_3pt_phi_bar_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.5, 5.0),
                              "f_±: I_4d2A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_3d1A psi_bar_4 */
                results.add({ this->I3d1A_fpm_3pt_psi_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.1, 5.0),
                              "f_±: I_3d1A^{3pt,psi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fpm_3pt_psi_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.5, 5.0),
                              "f_±: I_3d1A^{3pt,psi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fpm_3pt_psi_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.1, 5.0),
                              "f_±: I_3d1A^{3pt,psi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fpm_3pt_psi_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.5, 5.0),
                              "f_±: I_3d1A^{3pt,psi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_3d1A chi_bar_4 */
                results.add({ this->I3d1A_fpm_3pt_chi_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.1, 5.0),
                              "f_±: I_3d1A^{3pt,chi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fpm_3pt_chi_bar_4(this->sigma(s0_0_pm(), 5.0), 1.0, 0.5, 5.0),
                              "f_±: I_3d1A^{3pt,chi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fpm_3pt_chi_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.1, 5.0),
                              "f_±: I_3d1A^{3pt,chi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fpm_3pt_chi_bar_4(this->sigma(s0_0_pm(), 5.0), 3.0, 0.5, 5.0),
                              "f_±: I_3d1A^{3pt,chi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_3d1A phi_bar_3 */
                results.add(
                        { this->I3d1A_fT_3pt_phi_bar_3(this->sigma(s0_0_t(), 5.0), 1.0, 0.1, 5.0), "f_T: I_3d1A^{3pt,phi_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fT_3pt_phi_bar_3(this->sigma(s0_0_t(), 5.0), 1.0, 0.5, 5.0), "f_T: I_3d1A^{3pt,phi_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fT_3pt_phi_bar_3(this->sigma(s0_0_t(), 5.0), 3.0, 0.1, 5.0), "f_T: I_3d1A^{3pt,phi_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fT_3pt_phi_bar_3(this->sigma(s0_0_t(), 5.0), 3.0, 0.5, 5.0), "f_T: I_3d1A^{3pt,phi_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_3 phi_bar_bar_3 */
                results.add({ this->I3_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 1.0, 0.1, 5.0),
                              "f_T: I_3^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 1.0, 0.5, 5.0),
                              "f_T: I_3^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I3_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 3.0, 0.1, 5.0),
                              "f_T: I_3^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 3.0, 0.5, 5.0),
                              "f_T: I_3^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });

                /* I_3d1A phi_bar_bar_3 */
                results.add({ this->I3d1A_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 1.0, 0.1, 5.0),
                              "f_T: I_3d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 1.0, 0.5, 5.0),
                              "f_T: I_3d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 3.0, 0.1, 5.0),
                              "f_T: I_3d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 3.0, 0.5, 5.0),
                              "f_T: I_3d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_4 phi_bar_bar_3 */
                results.add({ this->I4_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 1.0, 0.1, 5.0),
                              "f_T: I_4^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 1.0, 0.5, 5.0),
                              "f_T: I_4^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 3.0, 0.1, 5.0),
                              "f_T: I_4^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 3.0, 0.5, 5.0),
                              "f_T: I_4^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });

                /* I_4d1A phi_bar_bar_3 */
                results.add({ this->I4d1A_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 1.0, 0.1, 5.0),
                              "f_T: I_4d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 1.0, 0.5, 5.0),
                              "f_T: I_4d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 3.0, 0.1, 5.0),
                              "f_T: I_4d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 3.0, 0.5, 5.0),
                              "f_T: I_4d1A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_4d2A phi_bar_bar_3 */
                results.add({ this->I4d2A_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 1.0, 0.1, 5.0),
                              "f_T: I_4d2A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 1.0, 0.5, 5.0),
                              "f_T: I_4d2A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 3.0, 0.1, 5.0),
                              "f_T: I_4d2A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fT_3pt_phi_bar_bar_3(this->sigma(s0_0_t(), 5.0), 3.0, 0.5, 5.0),
                              "f_T: I_4d2A^{3pt,phi_bar_bar_3}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_3d1A phi_bar_4 */
                results.add(
                        { this->I3d1A_fT_3pt_phi_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.1, 5.0), "f_T: I_3d1A^{3pt,phi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fT_3pt_phi_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.5, 5.0), "f_T: I_3d1A^{3pt,phi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fT_3pt_phi_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.1, 5.0), "f_T: I_3d1A^{3pt,phi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fT_3pt_phi_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.5, 5.0), "f_T: I_3d1A^{3pt,phi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_2 phi_bar_bar_4 */
                results.add({ this->I2_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.1, 5.0),
                              "f_T: I_2^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I2_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.5, 5.0),
                              "f_T: I_2^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I2_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.1, 5.0),
                              "f_T: I_2^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I2_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.5, 5.0),
                              "f_T: I_2^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });

                /* I_3 phi_bar_bar_4 */
                results.add({ this->I3_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.1, 5.0),
                              "f_T: I_3^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.5, 5.0),
                              "f_T: I_3^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I3_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.1, 5.0),
                              "f_T: I_3^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.5, 5.0),
                              "f_T: I_3^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });

                /* I_3d1A phi_bar_bar_4 */
                results.add({ this->I3d1A_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.1, 5.0),
                              "f_T: I_3d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.5, 5.0),
                              "f_T: I_3d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.1, 5.0),
                              "f_T: I_3d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I3d1A_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.5, 5.0),
                              "f_T: I_3d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_4 phi_bar_bar_4 */
                results.add({ this->I4_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.1, 5.0),
                              "f_T: I_4^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.5, 5.0),
                              "f_T: I_4^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.1, 5.0),
                              "f_T: I_4^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.5, 5.0),
                              "f_T: I_4^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });

                /* I_4d1A phi_bar_bar_4 */
                results.add({ this->I4d1A_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.1, 5.0),
                              "f_T: I_4d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.5, 5.0),
                              "f_T: I_4d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.1, 5.0),
                              "f_T: I_4d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d1A_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.5, 5.0),
                              "f_T: I_4d1A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_4d2A phi_bar_bar_4 */
                results.add({ this->I4d2A_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.1, 5.0),
                              "f_T: I_4d2A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.5, 5.0),
                              "f_T: I_4d2A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.1, 5.0),
                              "f_T: I_4d2A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add({ this->I4d2A_fT_3pt_phi_bar_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.5, 5.0),
                              "f_T: I_4d2A^{3pt,phi_bar_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_3d1A psi_bar_4 */
                results.add(
                        { this->I3d1A_fT_3pt_psi_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.1, 5.0), "f_T: I_3d1A^{3pt,psi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fT_3pt_psi_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.5, 5.0), "f_T: I_3d1A^{3pt,psi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fT_3pt_psi_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.1, 5.0), "f_T: I_3d1A^{3pt,psi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fT_3pt_psi_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.5, 5.0), "f_T: I_3d1A^{3pt,psi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
                ...
                /* I_3d1A chi_bar_4 */
                results.add(
                        { this->I3d1A_fT_3pt_chi_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.1, 5.0), "f_T: I_3d1A^{3pt,chi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fT_3pt_chi_bar_4(this->sigma(s0_0_t(), 5.0), 1.0, 0.5, 5.0), "f_T: I_3d1A^{3pt,chi_bar_4}(sigma=sigma_0, w_1=1.0, w_2=0.5, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fT_3pt_chi_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.1, 5.0), "f_T: I_3d1A^{3pt,chi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.1, q2=5.0 GeV^2)" });
                results.add(
                        { this->I3d1A_fT_3pt_chi_bar_4(this->sigma(s0_0_t(), 5.0), 3.0, 0.5, 5.0), "f_T: I_3d1A^{3pt,chi_bar_4}(sigma=sigma_0, w_1=3.0, w_2=0.5, q2=5.0 GeV^2)" });
    ...
    const std::vector<OptionSpecification> Implementation<AnalyticFormFactorBToPLCSR<Transition_>>::options{
    ...
    template <typename Transition_> AnalyticFormFactorBToPLCSR<Transition_>::~AnalyticFormFactorBToPLCSR() {}
    ...
    template <typename Transition_>
    const std::set<ReferenceName> AnalyticFormFactorBToPLCSR<Transition_>::references{ "KMO:2005A"_rn, "KMO:2006A"_rn, "FKKM:2008A"_rn, "GKvD:2018A"_rn };
