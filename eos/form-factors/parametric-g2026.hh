...
namespace eos
{
    ...
    // P -> V
    template <typename Process_> class G2026FormFactorTraits<Process_, PToV> : public virtual ParameterUser
    {
        public:
            ...
            std::array<double, 6>
            monomials_v(const double & z) const
            {
                return { 1.0, z, power_of<2>(z), power_of<3>(z), power_of<4>(z), power_of<5>(z) };
            }

            std::array<double, 6>
            monomials_a(const double & z) const
            {
                return { 1.0, z, power_of<2>(z), power_of<3>(z), power_of<4>(z), power_of<5>(z) };
            }

            double
            blaschke_product(const double & q2, const double & sG, const std::vector<double> & masses) const
            {
                double product = 1.0;
        ...
        private:
            ...
            _resonance_masses_or_empty(ParameterUser & user, const Parameters & p, const std::map<std::tuple<QuarkFlavor, QuarkFlavor>, std::vector<std::string>> & names,
    ...
    template <typename Process_> class G2026FormFactors<Process_, PToV> : public FormFactors<PToV>
    {
        private:
            ...
            double _phi(const double & s, const double & sG, const double & s0, const std::vector<double> & Mres, const double & tchi, const unsigned Kn, const int Ksp,
    ...
    // P -> P
    template <typename Process_> class G2026FormFactorTraits<Process_, PToP> : public virtual ParameterUser
    {
        public:
            // The following parameters are part of the parameterization and should match the
            // the ones used for the extraction of the coefficients of the z-expansion
            ...
            std::array<double, 6>
            monomials(const double & z) const
            {
                return { 1.0, z, power_of<2>(z), power_of<3>(z), power_of<4>(z), power_of<5>(z) };
            }

            std::array<complex<double>, 6>
            monomials(const complex<double> & z) const
            {
                return { 1.0, z, power_of<2>(z), power_of<3>(z), power_of<4>(z), power_of<5>(z) };
            }

            std::array<complex<double>, 6>
            monomials_derivatives(const complex<double> & z) const
            {
                return { complex<double>(0.0, 0.0), 1.0, 2.0 * z, 3.0 * power_of<2>(z), 4.0 * power_of<3>(z), 5.0 * power_of<4>(z) };
            }
    ...
    template <typename Process_> class G2026FormFactors<Process_, PToP> : public FormFactors<PToP>
    {
        private:
            ...
            double _phi(const double & s, const double & sG, const std::vector<double> & Mres, const double & tchi, const unsigned Kn, const int Ksp, const int Ksm, const int Kspm,
