    ...
    public:
        ...
        virtual void run() const
        {
...

            {
                ...
                TEST_CHECK_NEARLY_EQUAL( ff.f_0( -1.0), 0.097657,   eps);
                TEST_CHECK_NEARLY_EQUAL( ff.f_0(  1.0), 0.0939334,  eps);
                TEST_CHECK_NEARLY_EQUAL( ff.f_0(  4.0), 0.0879849,  eps);
                TEST_CHECK_NEARLY_EQUAL( ff.f_0( 25.0), 0.00773576, eps);
                TEST_CHECK_NEARLY_EQUAL( ff.f_p( -1.0), 0.0915962,  eps);
                TEST_CHECK_NEARLY_EQUAL( ff.f_p(  1.0), 0.100355,   eps);
                TEST_CHECK_NEARLY_EQUAL( ff.f_p(  4.0), 0.116264,   eps);
                TEST_CHECK_NEARLY_EQUAL( ff.f_p( 25.0), 0.936571,   eps);
                TEST_CHECK_NEARLY_EQUAL( ff.f_t( -1.0), 0.137521,   eps);
                TEST_CHECK_NEARLY_EQUAL( ff.f_t(  1.0), 0.150076,   eps);
                TEST_CHECK_NEARLY_EQUAL( ff.f_t(  4.0), 0.173141,   eps);
                TEST_CHECK_NEARLY_EQUAL( ff.f_t( 25.0), 1.50539,    eps);
            }
        }
    ...
    public:
        ...
        virtual void run() const
        {
...

            {
                ...
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_1m_v(),       0.0005,       eps);
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_1p_a(),       0.0020624,    eps);
