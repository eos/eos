...
namespace eos
{
    template <> struct AnalyticFormFactorBToPLCSRProcessTraits<BToD>
    {
            ...
            static const constexpr char *                               name_P              = "mass::D^+";
            static const constexpr char *                               f_P                 = "decay-constant::D_d";
    ...
    template class AnalyticFormFactorBToPLCSR<BToD>;
} // namespace eos
