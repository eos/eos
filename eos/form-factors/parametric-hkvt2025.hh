...
namespace eos
{
        ...
        public virtual ParameterUser
    {
        public:
            ...
            UsedParameter q2p_a, q2p_v, q20, k2in0, k2in1, k20;
            ...
            HKVT2025FormFactorTraits(const Parameters & p) :
                ...
                k2in0(UsedParameter(p[std::string(Process_::label) + "::sin0@HKvT2025"], *this)),
                k2in1(UsedParameter(p[std::string(Process_::label) + "::sin1@HKvT2025"], *this)),
            ...
            {
                return power_of<2>(m_P1 - std::sqrt(k2));
            }

            double lamB(const double & k2, const double & q2) const
            {
                return (q2 - power_of<2>(m_P1 + std::sqrt(k2))) * (q2 - power_of<2>(m_P1 - std::sqrt(k2)));
            }

            double kappa(const double & k2, const double & q2) const
            {
                const double lamq3 = lamB(k2, q2);
                const double lams12 = (k2 - power_of<2>(m_P2 + m_P3)) * (k2 - power_of<2>(m_P2 - m_P3));
            ...
            {
                const double measure = 2 * std::arg(calc_z(complex<double>(power_of<2>(m_P1 + std::sqrt(k2))), complex<double>(q2p_v), complex<double>(q20)));
            ...
            {
                const double measure = 2 * std::arg(calc_z(complex<double>(power_of<2>(m_P1 + std::sqrt(k2))), complex<double>(q2p_a), complex<double>(q20)));
                const SzegoPolynomial<2> polynomials_set(SzegoPolynomial<2>::FlatMeasure(measure));
        ...
        public FormFactors<PToPP>
    {
        private:
            ...
            std::array<bool, 4> _PartialWave_switch;
            std::array<bool, 2> _Isospin_switch;
            ...
            const std::array<std::array< std::array<UsedParameter, 3>, 3>, 3> _a_g_1, _a_g_2, _a_f_1, _a_f_2, _a_F1_1, _a_F1_2, _a_F2_1, _a_F2_2;
            ...
            const unsigned _int_points;
            std::shared_ptr<ScatteringAmplitudes<PPToPP>> scattering_amplitudes;

            const unsigned _charge;

            QualifiedName _exp_par_name(const std::string & ff_name, unsigned wave, unsigned z_order, unsigned y_order) const;
            ...
            double _unitarity_integrand_0m(const double & s, const unsigned & l, const bool & iso) const;
            double _unitarity_integrand_1p(const double & s, const unsigned & l, const bool & iso) const;
            double _unitarity_integrand_1m(const double & s, const unsigned & l, const bool & iso) const;
        ...
        public:
            ...
            complex<double> v_perp(const double & q2, const double & k2, const unsigned & l, const bool & iso) const;
            complex<double> a_t(const double & q2, const double & k2, const unsigned & l, const bool & iso) const;
            complex<double> a_0(const double & q2, const double & k2, const unsigned & l, const bool & iso) const;
            complex<double> a_par(const double & q2, const double & k2, const unsigned & l, const bool & iso) const;

            complex<double> g_tilde(const double & q2, const double & k2, const unsigned & l, const bool & iso) const;
            complex<double> F2_tilde(const double & q2, const double & k2, const unsigned & l, const bool & iso) const;
            complex<double> F1_tilde(const double & q2, const double & k2, const unsigned & l, const bool & iso) const;
            complex<double> f_tilde(const double & q2, const double & k2, const unsigned & l, const bool & iso) const;
