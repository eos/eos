...
namespace eos
{
    template <> struct Implementation<PionLCDAs>
    {
    ...
    PionLCDAs::phi3s_d1(const double & u, const double & mu) const
    {
        ...
        return -6.0 * x * (1.0 + 0.5 * eta3 * (10.0 - omega3) * c2) + 180.0 * u * (1.0 - u) * 0.5 * eta3 * (10.0 - omega3) * x;
    }
    ...
    PionLCDAs::phi4_d1(const double & u, const double & mu) const
    {
        ...
        return _imp->delta4(mu)
               * (400.0 / 3.0 * u * (1.0 - 3.0 * u + 2.0 * u2)
                  + 21.0 * _imp->omega4(mu)
                            * (2.0 + 22.0 * u - 78.0 * u2 + 52.0 * u3 + 2.0 * u2 * (6.0 * u2 - 15.0 * u + 10.0 + 30.0 * ubar2 * lnu)
    ...
    PionLCDAs::phi4_d2(const double & u, const double & mu) const
    {
        ...
        return 20.0 / 3.0 * _imp->delta4(mu)
               * (20.0 * (1.0 - 6.0 * u + 6.0 * u2) - 63.0 * (-1.0 + 3.0 * u - 3.0 * u2 + 6.0 * u * (1.0 - 3.0 * u + 2.0 * u2) * (lnubar - lnu)) * _imp->omega4(mu));
    }
