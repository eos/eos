...
namespace eos
{
    template <> struct AnalyticFormFactorBToVLCSRTraits<BsToPhi>
    {
            ...
            static const constexpr char *                               f_V                 = "decay-constant::phi";
    ...
    template class AnalyticFormFactorBToVLCSR<BsToPhi>;
} // namespace eos
