...
namespace eos
{
    ...
    SEFormFactorTraits<Process_, PToV>::resonance_0m_names
    {
    ...
    template <typename Process_>
    const std::map<std::tuple<QuarkFlavor, QuarkFlavor>, std::string>
    SEFormFactorTraits<Process_, PToV>::resonance_1m_names
    {
        { std::make_tuple(QuarkFlavor::bottom, QuarkFlavor::up), "mass::B_u^*@BSZ2015" },
        { std::make_tuple(QuarkFlavor::bottom, QuarkFlavor::down), "mass::B_d^*@BSZ2015" },
        { std::make_tuple(QuarkFlavor::bottom, QuarkFlavor::strange), "mass::B_s^*@BSZ2015" },
    ...
    template <typename Process_>
    const std::map<std::tuple<QuarkFlavor, QuarkFlavor>, std::string>
    SEFormFactorTraits<Process_, PToV>::resonance_1p_names
    {
    ...
    template<typename Process_>
    SEFormFactors<Process_, PToV>::~SEFormFactors() = default;
    ...
    template<typename Process_>
    double
    SEFormFactors<Process_, PToV>::_phi(const double & t, const double & threshold_tp, const double & chi,
    ...
    template<typename Process_>
    const std::set<ReferenceName> SEFormFactors<Process_, PToV>::references
    {
        "BFW:2010A"_rn
    };

    template<typename Process_>
    const std::vector<OptionSpecification> SEFormFactors<Process_, PToV>::options
    {
    };
