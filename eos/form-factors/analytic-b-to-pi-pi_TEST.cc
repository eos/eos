...
class AnalyticFormFactorBToPiPiBFvD2016Test : public TestCase
{
    public:
        ...
        run() const
        {
            ...
            {
                AnalyticFormFactorBToPiPiBFvD2016 ff(p,
                                                     Options{
                                                         { "scale"_ok, "variable"_ov }
                });
...
class AnalyticFormFactorBToPiPiFvDV2018Test : public TestCase
{
    public:
