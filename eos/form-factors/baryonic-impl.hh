        ...
        public FormFactors<OneHalfPlusToOneHalfMinus>
    {
        ...
        public:
            BBGIOvD2017FormFactors(const Parameters & p) :
                _b_to_c(p, Options{ }),
                _zeta_max(p["Lambda_b->Lambda_c^*::zeta(q^2_max)@BBGIOvD2017"], *this),
                _rho(p["Lambda_b->Lambda_c^*::rho@BBGIOvD2017"], *this),
                _delta_3b(p["Lambda_b->Lambda_c^*::delta_3b@BBGIOvD2017"], *this),
                _rho_3b(p["Lambda_b->Lambda_c^*::rho_3b@BBGIOvD2017"], *this)
            {
                uses(_b_to_c);
            }
