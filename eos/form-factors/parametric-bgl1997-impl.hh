...
namespace eos
{
    ...
    std::string
    BGL1997FormFactors<Process_, PToV>::_par_name(const std::string & ff_name)
    {
    ...
    BGL1997FormFactors<Process_, PToV>::BGL1997FormFactors(const Parameters & p, const Options & o) :
        _a_g{
            { UsedParameter(p[_par_name("g_0")], *this),
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::_phi(const double & s, const double & s_0, const double & K, const unsigned & a, const unsigned & b, const unsigned & c,
                                             const double & chi) const
    {
        ...
        return std::sqrt(1.0 / (K * M_PI * chi)) * (sq_tp_t + sq_tp_t0) * std::pow(sq_tp_t / sq_tp_t0, 1.0 / 2.0) * std::pow(_traits.tp() - s, a / 4.0)
               * std::pow(sq_tp_t + sq_tp_tm, b / 2.0) * 1.0 / std::pow(sq_tp_t + sq_tp, c + 3.0);
    }

    // Functions
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::g(const double & s) const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::f(const double & s) const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::a_F1_0() const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::F1(const double & s) const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::a_F2_0() const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::F2(const double & s) const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::v(const double & s) const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::a_0(const double & s) const
    {
        return F2(s) / 2.0;
    }
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::a_1(const double & s) const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::a_2(const double & s) const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::a_12(const double & s) const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::a_T2_0() const
    {
        const double          z    = _traits._z(0.0, _traits.t_0, _traits.tp());
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::t_3(const double & s) const
    {
        return ((power_of<2>(_mB) - power_of<2>(_mV)) * (power_of<2>(_mB) + 3.0 * power_of<2>(_mV) - s) * this->t_2(s) - 8.0 * _mB * power_of<2>(_mV) * (_mB - _mV) * this->t_23(s))
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::f_perp(const double & /*s*/) const
    {
        return 0.0; //  TODO
    }
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::f_para(const double & /*s*/) const
    {
        return 0.0; //  TODO
    }
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::f_long(const double & /*s*/) const
    {
        return 0.0; //  TODO
    }
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::f_perp_T(const double & /*s*/) const
    {
        return 0.0; //  TODO
    }
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::f_para_T(const double & /*s*/) const
    {
        return 0.0; //  TODO
    }
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::f_long_T(const double & /*s*/) const
    {
        return 0.0; //  TODO
    }
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::saturation_0p_v() const
    {
        return 0.0;
    }
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::saturation_0m_a() const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::saturation_1m_v() const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::saturation_1p_a() const
    {
        std::array<double, 4> coefficients_F1;
        coefficients_F1[0] = a_F1_0();
        std::copy(_a_F1.begin(), _a_F1.end(), coefficients_F1.begin() + 1);

        return std::inner_product(coefficients_F1.begin(), coefficients_F1.end(), coefficients_F1.begin(), 0.0) + std::inner_product(_a_f.begin(), _a_f.end(), _a_f.begin(), 0.0);
    }

    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::saturation_1m_t() const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToV>::saturation_1p_t5() const
    {
    ...
    template <typename Process_> const std::set<ReferenceName> BGL1997FormFactors<Process_, PToV>::references{ "BGL:1997A"_rn };
    ...
    template <typename Process_>
    std::string
    BGL1997FormFactors<Process_, PToP>::_par_name(const std::string & ff_name)
    {
        return std::string(Process_::label) + std::string("::a^") + ff_name + std::string("@BGL1997");
    }
    ...
    BGL1997FormFactors<Process_, PToP>::BGL1997FormFactors(const Parameters & p, const Options & o) :
        _a_f_p{
            { UsedParameter(p[_par_name("f+_0")], *this),
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToP>::_phi(const double & s, const double & s_0, const double & K, const unsigned & a, const unsigned & b, const unsigned & c,
                                             const double & chi) const
    {
        const double sq_tp    = std::sqrt(_traits.tp());
        const double sq_tp_t  = std::sqrt(_traits.tp() - s);
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToP>::f_p(const double & s) const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToP>::a_0_0() const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToP>::f_0(const double & s) const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToP>::f_plus_T(const double & /*s*/) const
    {
        return 0.0; //  TODO
    }
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToP>::saturation_0p_v() const
    {
        std::array<double, 4> coefficients;
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToP>::saturation_0m_a() const
    {
        return 0.0;
    }
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToP>::saturation_1m_v() const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToP>::saturation_1p_a() const
    {
        return 0.0;
    }
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToP>::saturation_1m_t() const
    {
    ...
    template <typename Process_>
    double
    BGL1997FormFactors<Process_, PToP>::saturation_1p_t5() const
    {
        return 0.0;
    }

    template <typename Process_> const std::set<ReferenceName> BGL1997FormFactors<Process_, PToP>::references{ "BGL:1997A"_rn };
