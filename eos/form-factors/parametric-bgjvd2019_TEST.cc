...
class BstarToDDstarTensorRelationsTest :
    public TestCase
{
    public:
        ...
        virtual void run() const
        {
            ...
            {
                return m_1 * m_1 + m_2 * m_2 - 2.0 * m_1 * m_2 * w;
            };
            ...
            // and the form factors must not depend on which side it lands on
            {
                ...
                TEST_CHECK_NEARLY_EQUAL(ff_bstar_d.h_tbar_1(q2(m_Bst, m_D, 1.0 - delta)),
                                        ff_bstar_d.h_tbar_1(q2(m_Bst, m_D, 1.0)),     1.0e-8);
                TEST_CHECK_NEARLY_EQUAL(ff_bstar_dstar.h_t5(q2(m_Bst, m_Dst, 1.0 - delta)),
                                        ff_bstar_dstar.h_t5(q2(m_Bst, m_Dst, 1.0)),   1.0e-8);
            }
        }
