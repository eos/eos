    ...
    public:
        ...
        virtual void run() const
        {
            ...
            /* lambda-b-source is public to every user of the exponential LCDA model */
            {
                ...
                Exponential legacy(p, Options{ { "q"_ok, "u"_ov }, { "lambda-b-source"_ok, "legacy"_ov } });
                Exponential flvd2022(p, Options{ { "q"_ok, "u"_ov }, { "lambda-b-source"_ok, "FLvD2022"_ov } });
            ...
            /* test cases in the limit lambda_E2 = lambda_H2 as used in [KMPW:2010A] */
            {
                ...
                /* Two-particle LCDAs */
                {
                    Exponential B(p, Options{ { "q"_ok, "u"_ov } });
            ...
            /* m_s = s */
            {
                ...
                /* Two-particle LCDAs */
                {
                    Exponential B(p, Options{ { "q"_ok, "s"_ov } });
