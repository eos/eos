...
namespace eos
{
    template <> struct AnalyticFormFactorBToPLCSRProcessTraits<BsToK>
    {
            ...
            static const constexpr char *                               f_P                 = "decay-constant::K";
    ...
    template class AnalyticFormFactorBToPLCSR<BsToK>;
} // namespace eos
