...
class BToPiBSZ2015FormFactorsTest : public TestCase
{
    public:
...
class BToDstarBSZ2015FormFactorsTest : public TestCase
{
    public:
        ...
        run() const
        {
            ...
            /*
             * for the B->D^* case no SSE parameters are available yet, so for the moment we set them to zero and once the GKvD2018 calculation is fitted we can then update the
             * test case later on.
             */
...
class BToKstarBSZ2015FormFactorsTest : public TestCase
{
    public:
...
class BToRhoBSZ2015FormFactorsTest : public TestCase
{
    public:
