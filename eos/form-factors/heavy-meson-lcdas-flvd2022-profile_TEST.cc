...
class HeavyMesonLCDAsFLvD2022ProfileTest :
    public TestCase
{
    public:
        ...
        static void set_generic_coefficients(Parameters & p)
        {
        ...
        virtual void run() const
        {
             ...
             */
            {
                ...
                heavy_meson_lcdas::Exponential exponential(p, Options{ { "lambda-b-source"_ok, "FLvD2022"_ov } });
             ...
             */
            {
                ...
                for (const auto & [omega, phi_plus, phi_minusWW, Xi_1, Xi_2] :
                        std::array<std::tuple<double, double, double, double, double>, 3>{ {
