...
namespace eos
{
    template <> struct AnalyticFormFactorBToVLCSRTraits<BToRho>
    {
            ...
            static const constexpr char *                               name_V              = "mass::rho^+";
            static const constexpr char *                               f_V                 = "decay-constant::rho";
    ...
    template class AnalyticFormFactorBToVLCSR<BToRho>;
} // namespace eos
