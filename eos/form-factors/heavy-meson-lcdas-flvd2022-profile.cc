...
namespace eos
{
    namespace heavy_meson_lcdas
    {
        ...
        FLvD2022Profile::profile_function(const double & omega) const
        {
            ...
            return { exp_x / power_of<2>(omega_0()) * std::inner_product(a_begin, a_end, c_f.begin(), 0.0),
        ...
        FLvD2022Profile::eom_moment() const
        {
            ...
            const Weights c = { 1.0, -6.0 / 2.0, 19.0 / 3.0, -44.0 / 4.0, 85.0 / 5.0, -146.0 / 6.0, 231.0 / 7.0, -344.0 / 8.0, 489.0 / 9.0 };
        ...
        FLvD2022Profile::varkappa() const
        {
            ...
            if (moment <= 0.0)
            {
                ...
                throw InternalError("The profile-function ansatz for the higher-twist B-meson LCDAs"
                                    ...
                                    " evaluates to "
                                    + stringify(moment, 8) + " GeV^2 for the coefficients a_k = (" + coefficients + ") at mu_0 = " + stringify(mu_0(), 4)
                                    + " GeV and omega_0 = " + stringify(omega_0(), 4) + " GeV");
            }
        ...
        FLvD2022Profile::xi_1(const double & omega) const
        {
            ...
            return 2.0 / 3.0 * kappa * (lambda_E2 + 2.0 * lambda_H2) * bracket - 2.0 * omega * phi_minus_ww + 3.0 * omega * omega * f + power_of<3>(omega) * f_prime;
        }
        ...
        const std::set<ReferenceName> FLvD2022Profile::references{ "BBJW:2018A"_rn, "FLvD:2022A"_rn };

        const std::vector<OptionSpecification> FLvD2022Profile::options{
            {       "Q"_ok,                   { "b"_ov },        "b"_ov },
