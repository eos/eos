...
class BToKG2026FormFactorsTest : public TestCase
{
    public:
        ...
        run() const
        {
...

            {
                ...
                const auto has_used_parameter = [&](const std::string & name) { return std::find(ff.begin(), ff.end(), p[name].id()) != ff.end(); };
...
class BToPiG2026FormFactorsTest : public TestCase
{
    public:
...
class BsToKG2026FormFactorsTest : public TestCase
{
    public:
...
class BToDG2026FormFactorsTest : public TestCase
{
    public:
...
class BsToDsG2026FormFactorsTest : public TestCase
{
    public:
...
class BsToKstarG2026FormFactorsTest : public TestCase
{
    public:
...
class BToKstarG2026FormFactorsTest : public TestCase
{
    public:
...
class BsToPhiG2026FormFactorsTest : public TestCase
{
    public:
...
class BToDstarG2026FormFactorsTest : public TestCase
{
    public:
...
class BsToDsstarG2026FormFactorsTest : public TestCase
{
    public:
