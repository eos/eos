...
\begin{enumerate}
    ...
    \item Only if you have \emph{manually} installed \package{minuit2}, you must specify its installation
    ...
    support, issue \texttt{--enable-pmc}. If you \emph{manually} installed \package{libpmc}, you
...
After successful configuration, you can build EOS using:
%
\begin{commandline}
make all
\end{commandline}
