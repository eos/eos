...
To run multiple Markov chains in parallel, one may use a compute cluster and submit
...
single HDF5 file. This is where \client{eos-merge-mcmc} comes into play. It
...
filtered out.
\client{eos-merge-mcmc} accepts the following command-line arguments:
\begin{itemize}
