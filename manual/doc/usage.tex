...
The call then reads: \commandlineexample{examples/sample-pmc-btopi-ff}
...
then reads:
\commandlineexample{examples/find-mode-btopi-ff}
...
\commandlineexample{examples/propagate-uncertainty-btotaunu}
...
Our intention translates to the following call to \client{eos-propagate-uncertainty}:
\commandlineexample{examples/propagate-uncertainty-btopilnu}
