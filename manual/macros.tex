...
\newcommand{\package}[1]{\textcolor{black!50!green}{\textsf{\textbf{#1}}}}
% EOS
\newcommand{\EOS}{\mbox{\textcolor{black!75!white}{\textbf{EOS}}}\xspace}
\newcommand{\observable}[1]{\mbox{\texttt{\lstinline{#1}}}}
\newcommand{\option}[1]{\mbox{\texttt{\lstinline{#1}}}}
\newcommand{\parameter}[1]{\mbox{\texttt{\lstinline{#1}}}}
