      ...
      {                                                                                                                                                         \
          ...
          if (std::abs((a_val - b_val)) <= eps)                                                                                                                 \
              ...
              throw TestCaseFailedException(__LINE__,                                                                                                           \
                                            __FILE__,                                                                                                           \
                                            "'" #a "' = " + stringify(a_val, 16u) + " is not nearly-equal to '" #b "' = " + stringify(b_val, 16u) + " within '" \
                                                    + stringify(eps, 16u) + "'" + ", difference is '" + stringify(a_val - b_val, 16u) + "'");                   \
      }                                                                                                                                                         \
      while (false)
...
#  define TEST_CHECK_RELATIVE_ERROR(a, b, eps)                                                                                                                                 \
      ...
      {                                                                                                                                                                        \
          ...
          if (((std::abs((a_val - b_val) / a_val)) <= eps) && ((std::abs((a_val - b_val) / b_val)) <= eps))                                                                    \
              ...
              throw TestCaseFailedException(__LINE__,                                                                                                                          \
                                            __FILE__,                                                                                                                          \
                                            "One relative error of '" #a "' = '" + stringify(a_val, 16u) + "' and '" #b "' = '" + stringify(b_val, 16u) + "' is greater than " \
                                                    + stringify(eps, 16u) + ". The results are " + stringify(std::abs((a_val - b_val) / a_val)) + " and "                      \
                                                    + stringify(std::abs((a_val - b_val) / b_val), 16u));                                                                      \
      }                                                                                                                                                                        \
      while (false)
...
#  define TEST_CHECK_RELATIVE_ERROR_C(a, b, eps)                                                                                                                                  \
      ...
      {                                                                                                                                                                           \
          ...
          if (std::sqrt(std::fabs(a_val_r)) < std::numeric_limits<double>::epsilon())                                                                                             \
              throw TestCaseFailedException(__LINE__, __FILE__, "Re('" #a "') has been evaluated to the zero within computational accuracy, result = " + stringify(a_val));       \
                                                                                                                                                                                  \
          if (std::sqrt(std::fabs(b_val_r)) < std::numeric_limits<double>::epsilon())                                                                                             \
              throw TestCaseFailedException(__LINE__, __FILE__, "Re('" #b "') has been evaluated to the zero within computational accuracy, result = " + stringify(a_val));       \
                                                                                                                                                                                  \
          if (std::sqrt(std::fabs(std::imag(a_val))) < std::numeric_limits<double>::epsilon())                                                                                    \
              throw TestCaseFailedException(__LINE__, __FILE__, "Im('" #a "') has been evaluated to the zero within computational accuracy, result = " + stringify(a_val));       \
                                                                                                                                                                                  \
          if (std::sqrt(std::fabs(std::imag(b_val))) < std::numeric_limits<double>::epsilon())                                                                                    \
              throw TestCaseFailedException(__LINE__, __FILE__, "Im('" #b "') has been evaluated to the zero within computational accuracy, result = " + stringify(a_val));       \
                                                                                                                                                                                  \
          if (not (((std::abs((a_val_r - b_val_r) / a_val_r)) <= eps) && ((std::abs((a_val_r - b_val_r) / b_val_r)) <= eps)))                                                     \
              throw TestCaseFailedException(__LINE__,                                                                                                                             \
                                            __FILE__,                                                                                                                             \
                                            "One relative error of the real part of '" #a "' = '" + stringify(a_val_r, 16u) + "' and '" #b "' = '" + stringify(b_val_r, 16u)      \
                                                    + "' is greater than " + stringify(eps, 16u) + ". The results are " + stringify(std::abs((a_val_r - b_val_r) / a_val_r))      \
                                                    + " and " + stringify(std::abs((a_val_r - b_val_r) / b_val_r), 16u));                                                         \
                                                                                                                                                                                  \
          if (not (((std::abs((a_val_i - b_val_i) / a_val_i)) <= eps) && ((std::abs((a_val_i - b_val_i) / b_val_i)) <= eps)))                                                     \
              throw TestCaseFailedException(__LINE__,                                                                                                                             \
                                            __FILE__,                                                                                                                             \
                                            "One relative error of the imaginary part of '" #a "' = '" + stringify(a_val_i, 16u) + "' and '" #b "' = '" + stringify(b_val_i, 16u) \
                                                    + "' is greater than " + stringify(eps, 16u) + ". The results are " + stringify(std::abs((a_val_i - b_val_i) / a_val_i))      \
                                                    + " and " + stringify(std::abs((a_val_i - b_val_i) / b_val_i), 16u));                                                         \
      }                                                                                                                                                                           \
      while (false)
...
#define TEST_SECTION(name, body)                         \
    ...
    {                                                    \
        ...
        body std::cout << name << "> ends" << std::endl; \
    }                                                    \
    while (false)
...
#define TEST_CHECK_NO_THROW(expression)                                                                                                           \
    ...
    {                                                                                                                                             \
        ...
        {                                                                                                                                         \
            throw TestCaseFailedException(__LINE__, __FILE__, "Caught unexpected exception in '" #expression "'");                                \
        }                                                                                                                                         \
    }                                                                                                                                             \
    while (false)
    ...
    {                                                                                                                                                                 \
        ...
        {                                                                                                                                                             \
            ...
            if (std::abs(j->first - i->value) > j->second)                                                                                                            \
                throw TestCaseFailedException(__LINE__,                                                                                                               \
                                              __FILE__,                                                                                                               \
                                              "Diagnostic error: " + i->description + "\n\tevaluates to " + stringify(i->value, 7u) + "\n\tdelta to reference value " \
                                                      + stringify(j->first, 7u) + " is " + stringify(j->first - i->value, 7u));                                       \
        }                                                                                                                                                             \
    }                                                                                                                                                                 \
    while (false)
